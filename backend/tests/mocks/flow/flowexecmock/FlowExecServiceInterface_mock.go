...
func (_mock *FlowExecServiceInterfaceMock) Execute(ctx context.Context, appID string, executionID string, flowType string, verbose bool, action string, inputs map[string]string, challengeToken string, appSecret string) (*flowexec.FlowStep, *serviceerror.ServiceError) {
	...
	if returnFunc, ok := ret.Get(0).(func(context.Context, string, string, string, bool, string, map[string]string, string, string) (*flowexec.FlowStep, *serviceerror.ServiceError)); ok {
		return returnFunc(ctx, appID, executionID, flowType, verbose, action, inputs, challengeToken, appSecret)
	}
	if returnFunc, ok := ret.Get(0).(func(context.Context, string, string, string, bool, string, map[string]string, string, string) *flowexec.FlowStep); ok {
...
func (_c *FlowExecServiceInterfaceMock_Execute_Call) RunAndReturn(run func(ctx context.Context, appID string, executionID string, flowType string, verbose bool, action string, inputs map[string]string, challengeToken string, appSecret string) (*flowexec.FlowStep, *serviceerror.ServiceError)) *FlowExecServiceInterfaceMock_Execute_Call {
	_c.Call.Return(run)
	return _c
}

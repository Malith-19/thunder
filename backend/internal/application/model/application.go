...
type ApplicationDTO struct {
	...
	AppSecret   string `json:"appSecret,omitempty" jsonschema:"App Secret. Returned once on creation for non-public clients. Used to authenticate when initiating a flow directly via the Flow Execution API."`

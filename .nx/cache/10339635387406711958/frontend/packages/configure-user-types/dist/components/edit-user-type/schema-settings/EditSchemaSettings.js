...
function EditSchemaSettings({ properties, onPropertiesChange, userTypeName, disabled = false }) {
	...
	return /* @__PURE__ */ jsxs(Box, { children: [
		properties.map((property) => /* @__PURE__ */ jsxs(Paper, {
			...
			children: [properties.length > 1 && !disabled && /* @__PURE__ */ jsx(Tooltip, {
				...
				children: [
					/* @__PURE__ */ jsxs(Box, {
						...
						children: [/* @__PURE__ */ jsxs(FormControl, {
							fullWidth: true,
							children: [/* @__PURE__ */ jsx(FormLabel, { children: t("userTypes:propertyName") }), /* @__PURE__ */ jsx(TextField, {
								value: property.name,
							...
							fullWidth: true,
							children: [/* @__PURE__ */ jsx(FormLabel, { children: t("userTypes:propertyType", "Type") }), /* @__PURE__ */ jsxs(Select, {
								value: property.type,
							...
							(property.type === "string" || property.type === "number" || property.type === "enum") && /* @__PURE__ */ jsx(Tooltip, {
								...
								children: /* @__PURE__ */ jsx(FormControlLabel, {
									...
									label: /* @__PURE__ */ jsxs(Stack, {
										...
										alignItems: "center",
										spacing: .5,
										children: [/* @__PURE__ */ jsx("span", { children: t("userTypes:unique", "Unique") }), /* @__PURE__ */ jsx(Info, {
											size: 14,
											color: "inherit"
										})]
									})
							...
							(property.type === "string" || property.type === "number") && /* @__PURE__ */ jsx(Tooltip, {
								...
								children: /* @__PURE__ */ jsx(FormControlLabel, {
									...
									label: /* @__PURE__ */ jsxs(Stack, {
										...
										alignItems: "center",
										spacing: .5,
										children: [/* @__PURE__ */ jsx("span", { children: t("userTypes:credential", "Credential") }), /* @__PURE__ */ jsx(Info, {
											size: 14,
											color: "inherit"
										})]
									})
					...
					property.type === "string" && /* @__PURE__ */ jsxs(FormControl, {
						fullWidth: true,
						children: [/* @__PURE__ */ jsx(FormLabel, { children: t("userTypes:regexPattern", "Regular Expression Pattern (Optional)") }), /* @__PURE__ */ jsx(TextField, {
					...
					property.type === "enum" && /* @__PURE__ */ jsxs(FormControl, {
						fullWidth: true,
						children: [
							/* @__PURE__ */ jsx(FormLabel, { children: t("userTypes:enumValues", "Allowed Values (Enum)") }),
							/* @__PURE__ */ jsxs(Box, {
								sx: {
									display: "flex",
									gap: 1,
		...
		/* @__PURE__ */ jsxs(Dialog, {
			...
			children: [
				/* @__PURE__ */ jsx(DialogTitle, { children: t("userTypes:removeCredentialDialog.title", "Remove Credential Flag") }),
				/* @__PURE__ */ jsx(DialogContent, { children: /* @__PURE__ */ jsx(DialogContentText, { children: t("userTypes:removeCredentialDialog.description", "Removing the credential flag will cause this field to no longer be hashed or protected. Existing hashed values may become inaccessible. Are you sure you want to proceed?") }) }),

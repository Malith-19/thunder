...
import { Callback, ThunderIDRuntimeError, useThunderID } from "@thunderid/react";
...
const ProtectedRoute = ({ children, fallback, redirectTo, loader = null }) => {
	...
	if (redirectTo) return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Navigate, { to: redirectTo });
	throw new ThunderIDRuntimeError("\"fallback\" or \"redirectTo\" prop is required.", "ProtectedRoute-ValidationError-001", "tanstack-router", "Either \"fallback\" or \"redirectTo\" prop must be provided to handle unauthenticated users.");
};
...
const CallbackRoute = ({ onError, onNavigate }) => {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Callback, {

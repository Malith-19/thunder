 ...
 * ```
 */
export default function useGetOrganizationUnitGroups(organizationUnitId: string | undefined, params?: OrganizationUnitListParams): UseQueryResult<GroupListResponse>;

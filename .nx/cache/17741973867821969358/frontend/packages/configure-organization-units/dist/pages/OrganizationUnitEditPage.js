...
import { Alert, Box, Button, IconButton, PageContent, PageTitle, Snackbar, Stack, Tab, Tabs, TextField, Typography } from "@wso2/oxygen-ui";
...
function OrganizationUnitEditPage() {
	...
	return /* @__PURE__ */ jsxs(PageContent, { children: [
		organizationUnit.isReadOnly && /* @__PURE__ */ jsx(Alert, {
			severity: "info",
			sx: { mb: 2 },
		...
		/* @__PURE__ */ jsxs(PageTitle, { children: [
			...
			/* @__PURE__ */ jsx(PageTitle.Header, { children: /* @__PURE__ */ jsx(Stack, {
				...
				}), !organizationUnit.isReadOnly && /* @__PURE__ */ jsx(IconButton, {
					size: "small",
					onClick: () => {
						setTempName(editedOU.name ?? organizationUnit.name);
		...
		/* @__PURE__ */ jsxs(Fragment, { children: [
			/* @__PURE__ */ jsx(TabPanel, {
				...
				children: /* @__PURE__ */ jsx(EditGeneralSettings, {
					organizationUnit,
					onDeleteClick: organizationUnit.isReadOnly ? void 0 : () => setDeleteDialogOpen(true)
				})
			}),
			/* @__PURE__ */ jsx(TabPanel, {
				value: activeTab,

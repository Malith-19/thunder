 ...
 */
declare const OrganizationUnitQueryKeys: {
    /**
     * Base key for all organization unit list queries
     */
    readonly ORGANIZATION_UNITS: "organization-units";
    /**
     * Key for a single organization unit query
     */
    readonly ORGANIZATION_UNIT: "organization-unit";
    /**
     * Key for child organization units of a specific OU
     */
    readonly CHILD_ORGANIZATION_UNITS: "child-organization-units";
    /**
     * Key for users belonging to a specific OU
     */
    readonly ORGANIZATION_UNIT_USERS: "organization-unit-users";
    /**
     * Key for groups belonging to a specific OU
     */
    readonly ORGANIZATION_UNIT_GROUPS: "organization-unit-groups";
};

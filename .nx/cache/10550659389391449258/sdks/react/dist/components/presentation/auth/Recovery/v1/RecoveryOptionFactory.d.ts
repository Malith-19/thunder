 ...
 */
export declare const createRecoveryComponent: ({ component, onSubmit, ...rest }: AdapterProps) => ReactElement;
/**
 * Convenience function that creates the appropriate recovery component from flow component data.
 */
export declare const createRecoveryOptionFromComponent: (component: EmbeddedFlowComponent, formValues: Record<string, string>, touchedFields: Record<string, boolean>, formErrors: Record<string, string>, isLoading: boolean, isFormValid: boolean, onInputChange: (name: string, value: string) => void, options?: {
...
//# sourceMappingURL=RecoveryOptionFactory.d.ts.map
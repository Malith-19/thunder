 ...
 * under the License.
 */
import { FlowMetadataResponse, HttpRequestConfig, HttpResponse, IdToken, OIDCDiscoveryApiResponse, Organization, Platform, SignInOptions, TokenExchangeRequestConfig, TokenResponse } from '@thunderid/browser';
...
export type ThunderIDContextProps = {
    ...
    user: any;
    platform?: Platform;
} & Pick<ThunderIDReactConfig, 'storage'> & Pick<ThunderIDReactClient, 'clearSession' | 'switchOrganization'>;
/**

...
*/
const useStyles = (theme, colorScheme, disabled, hasError) => (0, react.useMemo)(() => {
...
var Select_styles_default = useStyles;

//#endregion
exports.default = Select_styles_default;
//# sourceMappingURL=Select.styles.cjs.map
...
*/
const renderSignUpComponents = (components, formValues, touchedFields, formErrors, isLoading, isFormValid, onInputChange, options) => components.map((component, index) => createSignUpOptionFromComponent(component, formValues, touchedFields, formErrors, isLoading, isFormValid, onInputChange, {
	...options,
	key: component.id || index
})).filter(Boolean);

//#endregion
exports.createSignUpComponent = createSignUpComponent;
exports.renderSignUpComponents = renderSignUpComponents;
//# sourceMappingURL=SignUpOptionFactory.cjs.map
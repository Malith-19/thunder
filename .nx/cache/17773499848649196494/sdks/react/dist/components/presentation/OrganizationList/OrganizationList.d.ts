 ...
 */
export interface OrganizationListProps extends Omit<BaseOrganizationListProps, 'myOrganizations' | 'allOrganizations' | 'error' | 'fetchMore' | 'hasMore' | 'isLoading' | 'isLoadingMore'>, OrganizationListConfig {
    /**

...
function detectEnvironment() {
	...
	try {
		if (typeof import.meta !== "undefined" && import.meta.env !== void 0) {
...
function LoggerProvider({ logger, children }) {
	const loggerInstanceRef = useRef(null);
	...
	return /* @__PURE__ */ jsx(LoggerContext_default.Provider, {
...
function useLogger(componentName) {
	const logger = useContext(LoggerContext_default);
...
//#endregion
export { LOG_LEVEL_PRIORITY as _, Logger as a, maskString as c, serializeError as d, formatTimestamp as f, BaseTransport as g, hasProcess as h, HttpTransport as i, StdoutTransport as l, hasConsole as m, LoggerProvider as n, createLogger as o, detectEnvironment as p, LoggerContext_default as r, maskSensitiveData as s, useLogger as t, ConsoleTransport as u, log_level_default as v };
...
const BrandingContext = (0, react.createContext)(null);
...
const BrandingProvider = ({ children, brandingPreference: externalBrandingPreference, forceTheme, enabled = true, isLoading: externalIsLoading = false, error: externalError = null, refetch: externalRefetch }) => {
	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(BrandingContext_default.Provider, {
		value,
		children
	});
};
...
const ComponentRendererContext = (0, react.createContext)({});
...
const ComponentRendererProvider = ({ renderers, children }) => /* @__PURE__ */ (0, react_jsx_runtime.jsx)(ComponentRendererContext_default.Provider, {
	value: renderers,
	children
});
...
const FlowProvider = ({ children, initialStep = null, initialTitle = "", initialSubtitle, onFlowChange }) => {
	...
	*/
	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(FlowContext_default.Provider, {
		value: contextValue,
		children
	});
};
...
const FlowMetaContext = (0, react.createContext)(null);
...
*/
const useI18n = () => {
	const context = (0, react.useContext)(I18nContext_default);
...
const useThunderID = () => {
	const context = (0, react.useContext)(ThunderIDContext_default);
	if (!context) throw new Error("useThunderID must be used within an ThunderIDProvider");
	const flowMetaContext = (0, react.useContext)(FlowMetaContext_default);
	const i18nContext = (0, react.useContext)(I18nContext_default);
...
const FlowMetaProvider = ({ children, enabled = true }) => {
	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(FlowMetaContext_default.Provider, {
		value,
		children
	});
};
...
const logger$11 = (0, __thunderid_browser.createPackageComponentLogger)("@thunderid/react", "I18nProvider");
		...
		case "localStorage": return {
			...
			write: (language) => {
				...
				try {
					...
					logger$11.warn("Failed to persist language preference to localStorage.");
				}
			}
		};
		case "none":
...
const I18nProvider = ({ children, preferences }) => {
	...
	*/
	...
	const setLanguage = (0, react.useCallback)((language) => {
		...
		else logger$11.warn(`Language '${language}' is not available. Available languages: ${Object.keys(mergedBundles).join(", ")}`);
	}, [mergedBundles]);
	const contextValue = (0, react.useMemo)(() => ({
	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(I18nContext_default.Provider, {
		value: contextValue,
		children
	});
};
...
*/
const OrganizationContext$1 = (0, react.createContext)({
...
const OrganizationProvider = ({ children, currentOrganization, onError, myOrganizations, onOrganizationSwitch, revalidateMyOrganizations, getAllOrganizations: getAllOrganizations$1, createOrganization: createOrganization$1 }) => {
	...
	*/
	...
	const contextValue = (0, react.useMemo)(() => ({
		...
		currentOrganization,
		error,
		getAllOrganizations: getAllOrganizations$1,
		isLoading,
		myOrganizations,
	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(OrganizationContext_default$1.Provider, {
		value: contextValue,
		children
	});
};
...
const useBrandingContext = () => {
	const context = (0, react.useContext)(BrandingContext_default);
...
const logger$10 = (0, __thunderid_browser.createPackageComponentLogger)("@thunderid/react", "ThemeProvider");
/**
...
* ```
*/
const ThemeProvider$2 = ({ children, theme: themeConfigProp, mode = __thunderid_browser.DEFAULT_THEME, detection = {}, inheritFromBranding = true }) => {
	...
	try {
		...
		if (inheritFromBranding) logger$10.warn("ThemeProvider: inheritFromBranding is enabled but BrandingProvider is not available. Make sure to wrap your app with BrandingProvider or ThunderIDProvider with branding preferences.");
	}
	(0, react.useEffect)(() => {
	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(ThemeContext_default.Provider, {
		value,
		children
	});
};
...
const ThemeProvider = ({ children, theme, detection, inheritFromBranding, mode }) => {
	...
	if (platform === __thunderid_browser.Platform.ThunderID) return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(ThemeProvider_default$2, {
		theme,
		children
	});
	return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(ThemeProvider_default$1, {
		detection,
		inheritFromBranding,
		mode,
		theme,
...
const UserProvider = ({ children, profile, revalidateProfile, onUpdateProfile, updateProfile }) => {
	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(UserContext_default.Provider, {
		value: contextValue,
		children
	});
};
...
const logger$9 = (0, __thunderid_browser.createPackageComponentLogger)("@thunderid/react", "ThunderIDProvider");
const ThunderIDProvider = ({ afterSignInUrl, afterSignOutUrl, baseUrl: initialBaseUrl, clientId, children, extensions, scopes, preferences, signInUrl, signUpUrl, organizationHandle, applicationId, signInOptions, syncSession, instanceId = 0, organizationChain,...rest }) => {
	...
	const client = (0, react.useMemo)(() => new ThunderIDReactClient_default(instanceId), [instanceId]);
		...
		(async () => {
			...
			const scheduleAutoRefresh = async () => {
				try {
					...
					logger$9.warn("Failed to schedule automatic token refresh.", error);
				}
			};
	...
	*/
	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(ThunderIDContext_default.Provider, {
		value,
		children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(I18nProvider_default, {
			preferences: preferences?.i18n,
			children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(FlowMetaProvider_default, {
				enabled: preferences?.resolveFromMeta !== false,
				children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(BrandingProvider_default, {
					brandingPreference,
					isLoading: isBrandingLoading,
					error: brandingError,
					enabled: preferences?.theme?.inheritFromBranding === true,
					refetch: refetchBranding,
					children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(ThemeProvider_default, {
						...
						mode: (0, __thunderid_browser.getActiveTheme)(preferences?.theme?.mode),
						children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(FlowProvider_default, { children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(UserProvider_default, {
							profile: userProfile,
							onUpdateProfile: handleProfileUpdate,
							children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(OrganizationProvider_default, {
								getAllOrganizations: async () => client.getAllOrganizations(),
								myOrganizations,
								currentOrganization,
								onOrganizationSwitch: switchOrganization,
								revalidateMyOrganizations: async () => client.getMyOrganizations(),
								children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(ComponentRendererProvider_default, {
...
*/
const useUser = () => {
	const context = (0, react.useContext)(UserContext_default);
...
const useOrganization = () => {
	const context = (0, react.useContext)(OrganizationContext_default$1);
...
*/
const useFlow = () => {
	const context = (0, react.useContext)(FlowContext_default);
...
const useTheme = () => {
	const context = (0, react.useContext)(ThemeContext_default);
...
const useTranslation = (componentPreferences) => {
	const context = (0, react.useContext)(I18nContext_default);
	const contextPreferences = (0, react.useContext)(ComponentPreferencesContext_default)?.i18n;
...
const logger$8 = (0, __thunderid_browser.createPackageComponentLogger)("@thunderid/react", "useBranding");
/**
...
const useBranding = () => {
	try {
		...
		logger$8.warn("useBranding: BrandingProvider not available. Make sure to wrap your app with BrandingProvider or ThunderIDProvider with branding preferences.");
		return {
			activeTheme: null,
...
*/
const useStyles$34 = (theme, colorScheme, color, variant, size, fullWidth, disabled, loading, shape = "square") => (0, react.useMemo)(() => {
	const iconSizeMap = {
...
* @returns Object containing CSS class names for component styling
*/
const useStyles$33 = (theme, colorScheme, size, color) => (0, react.useMemo)(() => {
	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("button", {
		...
		children: [
			loading && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
				...
				children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(Spinner_default, {
					size,
					color: "currentColor",
					style: {
						height: spinnerWidth,
...
* ```
*/
const SignInButton = (0, react.forwardRef)(({ children, onClick, preferences, signInOptions: overriddenSignInOptions = {},...rest }, ref) => {
	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(BaseSignInButton_default, {
		ref,
...
const SignOutButton = (0, react.forwardRef)(({ children, onClick, preferences,...rest }, ref) => {
	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(BaseSignOutButton_default, {
		ref,
...
const SignUpButton = (0, react.forwardRef)(({ children, onClick, preferences,...rest }, ref) => {
	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(BaseSignUpButton_default, {
		ref,
...
const OrganizationContext = ({ instanceId, baseUrl, clientId, afterSignInUrl, afterSignOutUrl, targetOrganizationId, sourceInstanceId, scopes, children,...rest }) => {
	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(ThunderIDProvider_default, {
		instanceId,
		...
		...rest,
		children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(OrganizationContextController_default, {
			targetOrganizationId,
			isSourceSignedIn,
			children
		})
...
* @returns Object containing CSS class names for component styling
*/
const useStyles$32 = (theme, colorScheme, hasError, required) => (0, react.useMemo)(() => {
...
* @returns Object containing CSS class names for component styling
*/
const useStyles$31 = (theme, colorScheme, helperTextAlign, helperTextMarginLeft, hasError) => (0, react.useMemo)(() => {
	return {
...
* @returns Object containing CSS class names for component styling
*/
const useStyles$30 = (theme, colorScheme, variant, align, color, noWrap, inline, gutterBottom, fontWeight, fontSize, lineHeight) => (0, react.useMemo)(() => {
	...
	const typography = __emotion_css.css`
      margin: 0;
      font-family: ${theme.vars.typography.fontFamily};
      color: ${colorValue};
      text-align: ${align};
      ...
      ` : ""}
    `;
	const typographyNoWrap = __emotion_css.css`
      overflow: hidden;
      text-overflow: ellipsis;
      white-space: nowrap;
    `;
	const typographyInline = __emotion_css.css`
      display: inline;
    `;
	const typographyGutterBottom = __emotion_css.css`
      margin-bottom: ${theme.spacing.unit}px;
    `;
	const typographyH1 = __emotion_css.css`
      font-size: ${theme.vars.typography.fontSizes["3xl"]};
      font-weight: 600;
      line-height: 1.235;
      letter-spacing: -0.00735em;
    `;
	const typographyH2 = __emotion_css.css`
      font-size: ${theme.vars.typography.fontSizes["2xl"]};
      font-weight: 600;
      line-height: 1.334;
      letter-spacing: 0em;
    `;
	const typographyH3 = __emotion_css.css`
      font-size: ${theme.vars.typography.fontSizes.xl};
      font-weight: 600;
      line-height: 1.6;
      letter-spacing: 0.0075em;
    `;
	const typographyH4 = __emotion_css.css`
      font-size: ${theme.vars.typography.fontSizes.lg};
      font-weight: 600;
      line-height: 1.5;
      letter-spacing: 0.00938em;
    `;
	const typographyH5 = __emotion_css.css`
      font-size: ${theme.vars.typography.fontSizes.md};
      font-weight: 600;
      line-height: 1.334;
      letter-spacing: 0em;
    `;
	const typographyH6 = __emotion_css.css`
      font-size: ${theme.vars.typography.fontSizes.sm};
      font-weight: 500;
      line-height: 1.6;
      letter-spacing: 0.0075em;
    `;
	const typographySubtitle1 = __emotion_css.css`
      font-size: ${theme.vars.typography.fontSizes.md};
      font-weight: 400;
      line-height: 1.75;
      letter-spacing: 0.00938em;
    `;
	const typographySubtitle2 = __emotion_css.css`
      font-size: ${theme.vars.typography.fontSizes.sm};
      font-weight: 500;
      line-height: 1.57;
      letter-spacing: 0.00714em;
    `;
	const typographyBody1 = __emotion_css.css`
      font-size: ${theme.vars.typography.fontSizes.md};
      font-weight: 400;
      line-height: 1.5;
      letter-spacing: 0.00938em;
    `;
	const typographyBody2 = __emotion_css.css`
      font-size: ${theme.vars.typography.fontSizes.sm};
      font-weight: 400;
      line-height: 1.43;
      letter-spacing: 0.01071em;
    `;
	const typographyCaption = __emotion_css.css`
      font-size: ${theme.vars.typography.fontSizes.xs};
      font-weight: 400;
      line-height: 1.66;
      letter-spacing: 0.03333em;
    `;
	const typographyOverline = __emotion_css.css`
      font-size: ${theme.vars.typography.fontSizes.xs};
      font-weight: 400;
      line-height: 2.66;
	...
	return {
		...
		typographyBody1,
		typographyBody2,
		typographyButton: __emotion_css.css`
      font-size: ${theme.vars.typography.fontSizes.sm};
      font-weight: 500;
      line-height: 1.75;
...
const FormControl = ({ children, error, helperText, className, helperTextAlign = "left", helperTextMarginLeft }) => {
	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
		...
		children: [children, (error || helperText) && /* @__PURE__ */ (0, react_jsx_runtime.jsx)(Typography_default, {
			variant: "caption",
...
* @returns Object containing CSS class names for component styling
*/
const useStyles$29 = (theme, colorScheme, variant, error, marginBottom) => (0, react.useMemo)(() => {
...
const Checkbox = ({ label, error, className, required, helperText, style = {},...rest }) => {
	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(FormControl_default, {
		error,
		helperText,
		...
		children: /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
			...
			children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("input", {
				...
				...rest
			}), label && /* @__PURE__ */ (0, react_jsx_runtime.jsx)(InputLabel_default, {
				required,
				error: hasError,
				variant: "inline",
...
* @returns Object containing CSS class names for component styling
*/
const useStyles$28 = (theme, colorScheme, hasError, disabled) => (0, react.useMemo)(() => {
	const inputStyles = __emotion_css.css`
      width: 100%;
    ...
    `;
	const disabledInputStyles = __emotion_css.css`
...
const DatePicker = ({ label, error, className, required, disabled, helperText, dateFormat = "yyyy-MM-dd", style = {},...rest }) => {
	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(FormControl_default, {
		error,
		helperText,
		...
		style,
		children: [label && /* @__PURE__ */ (0, react_jsx_runtime.jsx)(InputLabel_default, {
			required,
			error: hasError,
...
* @returns Object containing CSS class names for component styling
*/
const useStyles$27 = (theme, colorScheme, disabled, hasError, length) => (0, react.useMemo)(() => {
	const inputContainer = __emotion_css.css`
      display: flex;
    ...
    `;
	const inputError = __emotion_css.css`
      border-color: ${theme.vars.colors.error.main};
	...
	return {
		input,
		inputContainer,
		inputDisabled: __emotion_css.css`
      background-color: ${theme.vars.colors.background.disabled};
      cursor: not-allowed;
      opacity: 0.6;
    `,
...
* @returns Object containing CSS class names for component styling
*/
const useStyles$26 = (theme, colorScheme, showPassword, disabled, hasError) => (0, react.useMemo)(() => {
...
*/
const EyeOff = (props) => /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("svg", {
	xmlns: "http://www.w3.org/2000/svg",
	width: "24",
	height: "24",
	viewBox: "0 0 24 24",
	...
	...props,
	children: [
		/* @__PURE__ */ (0, react_jsx_runtime.jsx)("path", { d: "M10.733 5.076a10.744 10.744 0 0 1 11.205 6.575 1 1 0 0 1 0 .696 10.747 10.747 0 0 1-1.444 2.49" }),
		/* @__PURE__ */ (0, react_jsx_runtime.jsx)("path", { d: "M14.084 14.158a3 3 0 0 1-4.242-4.242" }),
		/* @__PURE__ */ (0, react_jsx_runtime.jsx)("path", { d: "M17.479 17.499a10.75 10.75 0 0 1-15.417-5.151 1 1 0 0 1 0-.696 10.75 10.75 0 0 1 4.446-5.143" }),
...
* @returns Object containing CSS class names for component styling
*/
const useStyles$25 = (theme, colorScheme, disabled, hasError, hasStartIcon, hasEndIcon) => (0, react.useMemo)(() => {
    ...
    `;
	const inputDisabled = __emotion_css.css`
      background-color: ${theme.vars.colors.background.disabled};
      opacity: 0.6;
      cursor: not-allowed;
    `;
	const icon = __emotion_css.css`
      position: absolute;
      background: none;
      border: none;
      cursor: ${disabled ? "not-allowed" : "pointer"};
    ...
    `;
	const startIcon = __emotion_css.css`
      ${icon};
      inset-inline-start: ${theme.vars.spacing.unit};
    `;
	return {
		endIcon: __emotion_css.css`
      ${icon};
...
const TextField = ({ label, error, required, className, disabled, helperText, startIcon, endIcon, onStartIconClick, onEndIconClick, type = "text", style = {},...rest }) => {
	const { theme, colorScheme } = useTheme_default();
	const hasError = !!error;
	const styles = TextField_styles_default(theme, colorScheme, disabled, hasError, !!startIcon, !!endIcon);
...
const PasswordField = ({ onChange, className, disabled, error,...textFieldProps }) => {
	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(TextField_default, {
		...textFieldProps,
...
* @returns Object containing CSS class names for component styling
*/
const useStyles$24 = (theme, colorScheme, disabled, hasError) => (0, react.useMemo)(() => {
	...
	const select = __emotion_css.css`
      width: 100%;
      padding: ${theme.vars.spacing.unit} calc(${theme.vars.spacing.unit} * 1.5);
      border: 1px solid ${hasError ? theme.vars.colors.error.main : theme.vars.colors.border};
      border-radius: ${theme.vars.components?.Field?.root?.borderRadius || theme.vars.borderRadius.medium};
    ...
    `;
	const selectError = __emotion_css.css`
      border-color: ${theme.vars.colors.error.main};
    ...
    `;
	const selectDisabled = __emotion_css.css`
      background-color: ${theme.vars.colors.background.disabled};
      opacity: 0.6;
      cursor: not-allowed;
    `;
	return {
		option: __emotion_css.css`
...
const createField = (config) => {
	...
	switch (type) {
		case __thunderid_browser.FieldType.Password: return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(PasswordField_default, {
			...commonProps,
			onChange
		});
		case __thunderid_browser.FieldType.Text: return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(TextField_default, {
			...commonProps,
			type: "text",
			onChange: (e) => onChange(e.target.value),
			autoComplete: "off"
		});
		case __thunderid_browser.FieldType.Email: return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(TextField_default, {
			...commonProps,
			type: "email",
			onChange: (e) => onChange(e.target.value),
			autoComplete: "email"
		});
		case __thunderid_browser.FieldType.Tel: return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(TextField_default, {
			...commonProps,
			type: "tel",
			onChange: (e) => onChange(e.target.value),
			autoComplete: "tel"
		});
		case __thunderid_browser.FieldType.Date: return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(DatePicker_default, {
			...commonProps,
			onChange: (e) => onChange(e.target.value)
		});
		case __thunderid_browser.FieldType.Checkbox: {
			const isChecked = value === "true" || value === true;
			return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(Checkbox_default, {
				...commonProps,
				checked: isChecked,
				onChange: (e) => onChange(e.target.checked.toString())
			});
		}
		case __thunderid_browser.FieldType.Otp: return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(OtpField_default, {
			...commonProps,
			onChange: (e) => onChange(e.target.value)
		});
		case __thunderid_browser.FieldType.Number: return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(TextField_default, {
			...commonProps,
			type: "number",
			onChange: (e) => onChange(e.target.value),
		...
		case __thunderid_browser.FieldType.Select: {
			...
			if (fieldOptions.length > 0) return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(Select_default, {
				...commonProps,
		...
		default: return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(TextField_default, {
			...commonProps,
			type: "text",
			onChange: (e) => onChange(e.target.value),
...
const EmailOtp = ({ authenticator, formValues, touchedFields, isLoading, onInputChange, inputClassName = "", buttonClassName = "", preferences }) => {
	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [formFields.map((param) => {
		return /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", { children: (param.param.toLowerCase().includes("otp") || param.param.toLowerCase().includes("code")) && hasOtpField ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)(OtpField_default, {
			length: 6,
...
const IdentifierFirst = ({ authenticator, formValues, touchedFields, isLoading, onInputChange, inputClassName = "", buttonClassName = "", preferences }) => {
	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [formFields.map((param) => /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", { children: createField({
		className: inputClassName,
		disabled: isLoading,
		label: param.displayName,
		name: param.param,
		...
		type: param.type === __thunderid_browser.EmbeddedSignInFlowAuthenticatorParamType.String && param.confidential ? __thunderid_browser.FieldType.Password : __thunderid_browser.FieldType.Text,
		value: formValues[param.param] || ""
	}) }, param.param)), /* @__PURE__ */ (0, react_jsx_runtime.jsx)(Button_default, {
		fullWidth: true,
		type: "submit",
		color: "primary",
		variant: "solid",
	...
	*/
	const getIcon = () => {
		...
		switch (authenticatorId) {
			case __thunderid_browser.ApplicationNativeAuthenticationConstants.SupportedAuthenticators.SmsOtp: return /* @__PURE__ */ (0, react_jsx_runtime.jsx)("svg", {
				width: "18",
				height: "18",
				viewBox: "0 0 24 24",
				xmlns: "http://www.w3.org/2000/svg",
			...
			case __thunderid_browser.ApplicationNativeAuthenticationConstants.SupportedAuthenticators.EmailOtp: return /* @__PURE__ */ (0, react_jsx_runtime.jsx)("svg", {
				width: "18",
				height: "18",
				viewBox: "0 0 24 24",
				xmlns: "http://www.w3.org/2000/svg",
			...
			case __thunderid_browser.ApplicationNativeAuthenticationConstants.SupportedAuthenticators.Totp: return /* @__PURE__ */ (0, react_jsx_runtime.jsx)("svg", {
				width: "18",
				height: "18",
				viewBox: "0 0 24 24",
				xmlns: "http://www.w3.org/2000/svg",
			...
			case __thunderid_browser.ApplicationNativeAuthenticationConstants.SupportedAuthenticators.PushNotification: return /* @__PURE__ */ (0, react_jsx_runtime.jsx)("svg", {
				width: "18",
				height: "18",
				viewBox: "0 0 24 24",
				xmlns: "http://www.w3.org/2000/svg",
			...
			case __thunderid_browser.ApplicationNativeAuthenticationConstants.SupportedAuthenticators.Passkey: return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("svg", {
				fill: "currentColor",
				width: "18",
				height: "18",
				viewBox: "0 0 32 32",
...
const Totp = ({ authenticator, formValues, touchedFields, isLoading, onInputChange, inputClassName = "", buttonClassName = "", preferences }) => {
	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [formFields.map((param) => {
		return /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", { children: (param.param.toLowerCase().includes("totp") || param.param.toLowerCase().includes("token")) && hasTotpField ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)(OtpField_default, {
			length: 6,
			value: formValues[param.param] || "",
			onChange: (event) => onInputChange(param.param, event.target.value),
			disabled: isLoading,
...
const createSignInOption = ({ authenticator, onSubmit, buttonClassName, preferences,...rest }) => {
	...
	switch (authenticator.authenticatorId) {
		case __thunderid_browser.ApplicationNativeAuthenticationConstants.SupportedAuthenticators.UsernamePassword: return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(UsernamePassword_default, {
			authenticator,
			preferences,
			onSubmit,
			...rest
		});
		case __thunderid_browser.ApplicationNativeAuthenticationConstants.SupportedAuthenticators.IdentifierFirst: return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(IdentifierFirst_default, {
			authenticator,
			preferences,
			onSubmit,
			...rest
		});
		case __thunderid_browser.ApplicationNativeAuthenticationConstants.SupportedAuthenticators.Google: return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(GoogleButton_default, {
			className: buttonClassName,
			onClick: () => onSubmit(authenticator),
			preferences,
			...rest
		});
		case __thunderid_browser.ApplicationNativeAuthenticationConstants.SupportedAuthenticators.GitHub: return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(GitHubButton_default, {
			preferences,
			className: buttonClassName,
			onClick: () => onSubmit(authenticator),
			...rest
		});
		case __thunderid_browser.ApplicationNativeAuthenticationConstants.SupportedAuthenticators.Microsoft: return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(MicrosoftButton_default, {
			preferences,
			className: buttonClassName,
			onClick: () => onSubmit(authenticator),
			...rest
		});
		case __thunderid_browser.ApplicationNativeAuthenticationConstants.SupportedAuthenticators.Facebook: return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(FacebookButton_default, {
			preferences,
			className: buttonClassName,
			onClick: () => onSubmit(authenticator),
			...rest
		});
		case __thunderid_browser.ApplicationNativeAuthenticationConstants.SupportedAuthenticators.LinkedIn: return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(LinkedInButton_default, {
			preferences,
			className: buttonClassName,
			onClick: () => onSubmit(authenticator),
			...rest
		});
		case __thunderid_browser.ApplicationNativeAuthenticationConstants.SupportedAuthenticators.SignInWithEthereum: return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(SignInWithEthereumButton_default, {
			preferences,
			className: buttonClassName,
			onClick: () => onSubmit(authenticator),
			...rest
		});
		case __thunderid_browser.ApplicationNativeAuthenticationConstants.SupportedAuthenticators.EmailOtp: return hasParams ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)(EmailOtp_default, {
			authenticator,
			preferences,
			onSubmit,
			...rest
		}) : /* @__PURE__ */ (0, react_jsx_runtime.jsx)(MultiOptionButton_default, {
			authenticator,
			preferences,
			onSubmit,
			...rest
		});
		case __thunderid_browser.ApplicationNativeAuthenticationConstants.SupportedAuthenticators.Totp: return hasParams ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)(Totp_default, {
			authenticator,
			preferences,
			onSubmit,
			...rest
		...
		case __thunderid_browser.ApplicationNativeAuthenticationConstants.SupportedAuthenticators.SmsOtp: return hasParams ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)(SmsOtp_default, {
			authenticator,
			preferences,
			onSubmit,
			...rest
		...
		default:
			if (authenticator.idp !== __thunderid_browser.EmbeddedSignInFlowAuthenticatorKnownIdPType.Local) return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(SocialButton_default, {
				authenticator,
				preferences,
				className: buttonClassName,
				onClick: () => onSubmit(authenticator),
			...
			if (hasParams) return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(UsernamePassword_default, {
				authenticator,
				preferences,
				onSubmit,
				...rest
			});
			return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(MultiOptionButton_default, {
				authenticator,
				preferences,
				onSubmit,
				...rest
...
* @returns Object containing CSS class names for component styling
*/
const useStyles$23 = (theme, colorScheme, variant) => (0, react.useMemo)(() => {
...
*/
const CircleCheck = (props) => /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("svg", {
	xmlns: "http://www.w3.org/2000/svg",
	width: "24",
	height: "24",
	viewBox: "0 0 24 24",
...
const AlertTitle = ({ children, className, style,...rest }) => {
	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(Typography_default, {
		component: "h3",
		variant: "h6",
		fontWeight: 600,
		style,
...
* @returns Object containing CSS class names for component styling
*/
const useStyles$22 = (theme, colorScheme, variant, clickable) => (0, react.useMemo)(() => {
...
* @returns Object containing CSS class names for component styling
*/
const useStyles$21 = (theme, colorScheme, orientation, variant, color, hasChildren) => (0, react.useMemo)(() => {
...
const Divider = ({ orientation = "horizontal", variant = "solid", children, color, className, style,...rest }) => {
	...
	if (children) return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
		...
		children: [
			...
			/* @__PURE__ */ (0, react_jsx_runtime.jsx)(Typography_default, {
				variant: "body2",
				color: "textSecondary",
...
* @returns Object containing CSS class names for component styling
*/
const useStyles$20 = (theme, colorScheme, size) => (0, react.useMemo)(() => {
...
* @returns Object containing CSS class names for component styling
*/
const useStyles$19 = (theme, colorScheme) => (0, react.useMemo)(() => {
	const signIn = __emotion_css.css`
      min-width: 420px;
      margin: 0 auto;
      font-family: ${theme.vars.typography.fontFamily};
    `;
	...
	const subtitle = __emotion_css.css`
      ...
      color: ${theme.vars.colors.text.secondary};
    `;
	const messagesContainer = __emotion_css.css`
      margin-top: calc(${theme.vars.spacing.unit} * 2);
    `;
...
const logger$7 = (0, __thunderid_browser.createPackageComponentLogger)("@thunderid/react", "BaseSignIn");
/**
...
const BaseSignInContent$1 = ({ afterSignInUrl, onInitialize, isLoading: externalIsLoading, onSubmit, onSuccess, onError, onFlowChange, className = "", inputClassName = "", buttonClassName = "", errorClassName = "", messageClassName = "", size = "medium", variant = "outlined", showTitle = true, showSubtitle = true }) => {
		...
		if (response && "nextStep" in response && response.nextStep && response.nextStep.stepType === __thunderid_browser.EmbeddedSignInFlowStepType.AuthenticatorPrompt && response.nextStep.authenticators?.length === 1) {
			...
			if (responseAuthenticator.metadata?.promptType === __thunderid_browser.EmbeddedSignInFlowAuthenticatorPromptType.RedirectionPrompt && responseAuthenticator.metadata?.additionalData?.redirectUrl) {
				...
				*/
				...
				if (!popup) {
					logger$7.error("Failed to open popup window");
					return false;
				}
				/**
				...
				*/
				...
				popupMonitor = setInterval(async () => {
					try {
						...
						logger$7.error("Error monitoring popup:");
					}
				}, 1e3);
				return true;
			}
	...
	const handleAuthenticatorSelection = async (authenticator, formData) => {
		...
		try {
			if (isPasskeyAuthenticator(authenticator)) try {
				...
				logger$7.error("Passkey authentication error:");
	...
	*/
	...
	if (!isInitialized && isLoading) return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(Card_default, {
		className: (0, __emotion_css.cx)(containerClasses, styles["card"]),
		"data-testid": "thunderid-signin",
		variant,
		children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(Card_default.Content, { children: /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
			className: styles["loadingContainer"],
			children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)(Spinner_default, { size: "medium" }), /* @__PURE__ */ (0, react_jsx_runtime.jsx)(Typography_default, {
				variant: "body1",
	...
	if (hasMultipleOptions() && !currentAuthenticator) {
		...
		return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(Card_default, {
			className: (0, __emotion_css.cx)(containerClasses, styles["card"]),
			"data-testid": "thunderid-signin",
			variant,
			children: [(showTitle || showSubtitle) && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(Card_default.Header, {
				className: styles["header"],
				children: [showTitle && /* @__PURE__ */ (0, react_jsx_runtime.jsx)(Card_default.Title, {
					level: 2,
					className: styles["title"],
					children: flowTitle || t("signin.heading")
				}), showSubtitle && /* @__PURE__ */ (0, react_jsx_runtime.jsx)(Typography_default, {
					variant: "body1",
					className: styles["subtitle"],
					children: flowSubtitle || t("signin.subheading")
				})]
			}), /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(Card_default.Content, { children: [
				flowMessages && flowMessages.length > 0 && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
					className: styles["flowMessagesContainer"],
					children: flowMessages.map((flowMessage, index) => /* @__PURE__ */ (0, react_jsx_runtime.jsx)(Alert_default, {
						variant: flowMessage.type,
						className: (0, __emotion_css.cx)(styles["flowMessageItem"], messageClasses),
						children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(Alert_default.Description, { children: flowMessage.message })
				...
				messages.length > 0 && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
					...
					children: messages.map((message, index) => {
						...
						return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(Alert_default, {
							variant: messageVariant,
							className: (0, __emotion_css.cx)(styles["messageItem"], messageClasses),
							children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(Alert_default.Description, { children: message.message })
						}, index);
					})
				}),
				error && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(Alert_default, {
					variant: "error",
					className: (0, __emotion_css.cx)(styles["errorContainer"], errorClasses),
					children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)(Alert_default.Title, { children: "Error" }), /* @__PURE__ */ (0, react_jsx_runtime.jsx)(Alert_default.Description, { children: error })]
				}),
				/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
					...
					children: [
						userPromptAuthenticators.map((authenticator, index) => /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
							...
							children: [index > 0 && /* @__PURE__ */ (0, react_jsx_runtime.jsx)(Divider_default, {
						...
						userPromptAuthenticators.length > 0 && optionAuthenticators.length > 0 && /* @__PURE__ */ (0, react_jsx_runtime.jsx)(Divider_default, {
							className: styles["divider"],
							children: "OR"
						}),
	...
	if (!currentAuthenticator) return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(Card_default, {
		className: (0, __emotion_css.cx)(containerClasses, styles["noAuthenticatorCard"]),
		"data-testid": "thunderid-signin",
		variant,
		children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(Card_default.Content, { children: error && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(Alert_default, {
			variant: "error",
			className: styles["errorAlert"],
			children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)(Alert_default.Title, { children: t("errors.heading") || "Error" }), /* @__PURE__ */ (0, react_jsx_runtime.jsx)(Alert_default.Description, { children: error })]
		}) })
	});
	if (isPasskeyAuthenticator(currentAuthenticator) && !isLoading) {
		...
		return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(Card_default, {
			className: (0, __emotion_css.cx)(containerClasses, styles["card"]),
			"data-testid": "thunderid-signin",
			variant,
			children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(Card_default.Content, { children: /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				...
				children: [
					/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
						...
						children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(Spinner_default, { size: "large" })
					}),
					/* @__PURE__ */ (0, react_jsx_runtime.jsx)(Typography_default, {
						variant: "body1",
	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(Card_default, {
		...
		"data-testid": "thunderid-signin",
		variant,
		children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)(Card_default.Header, {
			className: styles["header"],
			children: [
				/* @__PURE__ */ (0, react_jsx_runtime.jsx)(Card_default.Title, {
					level: 2,
					className: styles["title"],
					children: flowTitle || t("signin.heading")
				}),
		...
		}), /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(Card_default.Content, { children: [error && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(Alert_default, {
			variant: "error",
			className: (0, __emotion_css.cx)(styles["errorContainer"], errorClasses),
			children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)(Alert_default.Title, { children: t("errors.heading") }), /* @__PURE__ */ (0, react_jsx_runtime.jsx)(Alert_default.Description, { children: error })]
		}), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("form", {
			className: styles["form"],
			onSubmit: (e) => {
				e.preventDefault();
...
const BaseSignIn$2 = ({ showLogo = true,...rest }) => {
	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", { children: [showLogo && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
		...
		children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(Logo_default, { size: "large" })
	}), /* @__PURE__ */ (0, react_jsx_runtime.jsx)(FlowProvider_default, { children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(BaseSignInContent$1, {
		showLogo,
		...rest
	}) })] });
};
...
const useStyles$18 = (theme) => (0, react.useMemo)(() => {
...
const OrganizationUnitPicker = ({ rootOuId, selectedOuId, onSelect, fetchChildren, pageSize = 10, className }) => {
	...
	const loadChildren = (0, react.useCallback)(async (parentId, offset$3 = 0) => {
		setNodeStates((prev) => ({
			...prev,
			[parentId]: {
				...prev[parentId] || {
		...
		try {
			const response = await fetchChildren(parentId, pageSize, offset$3);
			...
			setNodeStates((prev) => {
				...
				const mergedChildren = offset$3 === 0 ? newChildren : [...existing.children, ...newChildren];
				const newOffset = offset$3 + newChildren.length;
				return {
					...prev,
					[parentId]: {
...
const useStyles$17 = (theme, colorScheme) => (0, react.useMemo)(() => ({
...
const useStyles$16 = (theme, colorScheme, hasError, required) => (0, react.useMemo)(() => {
	const containerStyles = __emotion_css.css`
      display: inline-flex;
      align-items: center;
      cursor: pointer;
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", { className: (0, __emotion_css.cx)((0, __thunderid_browser.withVendorCSSClassPrefix)((0, __thunderid_browser.bem)("consent-checkbox-list", "bullet")), styles["bullet"]) }), /* @__PURE__ */ (0, react_jsx_runtime.jsx)(Typography_default, {
							variant: "body2",
					...
					}), /* @__PURE__ */ (0, react_jsx_runtime.jsx)(Toggle_default, {
						id: inputId,
						checked,
						disabled: isEssential,
						onChange: isEssential ? void 0 : (e) => handleChange(attr, e.target.checked)
					})]
				}), /* @__PURE__ */ (0, react_jsx_runtime.jsx)(Divider_default, { className: (0, __emotion_css.cx)((0, __thunderid_browser.withVendorCSSClassPrefix)((0, __thunderid_browser.bem)("consent-checkbox-list", "divider")), styles["divider"]) })]
			}, attr);
		})
	});
};
	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
		...
		children: purposes.map((purpose, purposeIndex) => /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
			...
			children: [purpose.essential && purpose.essential.length > 0 && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)(Typography_default, {
					variant: "subtitle2",
					fontWeight: "bold",
					children: "Essential Attributes"
				}), /* @__PURE__ */ (0, react_jsx_runtime.jsx)(ConsentCheckboxList_default, {
					variant: "ESSENTIAL",
					purpose,
					formValues,
					onInputChange
...
const useStyles$15 = (theme) => (0, react.useMemo)(() => ({
...
const logger$6 = (0, __thunderid_browser.createPackageComponentLogger)("@thunderid/react", "AuthOptionFactory");
/**
...
const createAuthComponentFromFlow = (component, formValues, touchedFields, formErrors, isLoading, isFormValid, onInputChange, authType, options = {}) => {
	...
	switch (component.type) {
		...
		case __thunderid_browser.EmbeddedFlowComponentTypeV2.PhoneInput: {
			...
			return (0, react.cloneElement)(createField({
		...
		case __thunderid_browser.EmbeddedFlowComponentTypeV2.Action: {
			...
			if (matchesSocialProvider(actionId, eventType, buttonText, "google", authType, componentVariant)) return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(GoogleButton_default, {
				onClick: handleClick,
				className: options.buttonClassName
			}, key);
			if (matchesSocialProvider(actionId, eventType, buttonText, "github", authType, componentVariant)) return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(GitHubButton_default, {
				onClick: handleClick,
				className: options.buttonClassName
			}, key);
			if (matchesSocialProvider(actionId, eventType, buttonText, "facebook", authType, componentVariant)) return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(FacebookButton_default, {
				onClick: handleClick,
				className: options.buttonClassName
			}, key);
			if (matchesSocialProvider(actionId, eventType, buttonText, "microsoft", authType, componentVariant)) return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(MicrosoftButton_default, {
				onClick: handleClick,
				className: options.buttonClassName
			}, key);
			if (matchesSocialProvider(actionId, eventType, buttonText, "linkedin", authType, componentVariant)) return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(LinkedInButton_default, {
				onClick: handleClick,
				className: options.buttonClassName
			}, key);
			if (matchesSocialProvider(actionId, eventType, buttonText, "ethereum", authType, componentVariant)) return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(SignInWithEthereumButton_default, {
				onClick: handleClick,
				className: options.buttonClassName
			}, key);
			if (actionId === "prompt_mobile" || eventType === "prompt_mobile") return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(SmsOtpButton_default, {
				onClick: handleClick,
				className: options.buttonClassName
			}, key);
		...
		case __thunderid_browser.EmbeddedFlowComponentTypeV2.Text: return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(Typography_default, {
		...
		case __thunderid_browser.EmbeddedFlowComponentTypeV2.Divider: return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(Divider_default, { children: resolve(component.label) || "" }, key);
		case __thunderid_browser.EmbeddedFlowComponentTypeV2.Select: {
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(Select_default, {
				name: identifier,
				label: resolve(component.label) || "",
				placeholder: resolve(component.placeholder),
		...
		case __thunderid_browser.EmbeddedFlowComponentTypeV2.OuSelect: {
			...
			if (!rootOuId || !options.fetchOrganizationUnitChildren) {
				logger$6.warn("OU_SELECT requires additionalData.rootOuId and fetchOrganizationUnitChildren. Skipping render.");
				return null;
			}
			return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(OrganizationUnitPicker_default, {
				rootOuId,
		...
		case __thunderid_browser.EmbeddedFlowComponentTypeV2.Image: {
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(ImageComponent_default, {
				component: { config: {
		...
		case __thunderid_browser.EmbeddedFlowComponentTypeV2.Icon: {
			...
			if (!IconComponent) {
				logger$6.warn(`Unknown icon name: "${iconName}". Skipping render.`);
				return null;
			}
		...
		case __thunderid_browser.EmbeddedFlowComponentTypeV2.Consent: {
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(Consent_default, {
		...
		case __thunderid_browser.EmbeddedFlowComponentTypeV2.Timer: {
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(FlowTimer_default, {
		...
		case __thunderid_browser.EmbeddedFlowComponentTypeV2.CopyableText: {
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(CopyableText_default, {
				label: resolve(component.label) || void 0,
				value
			}, key);
		}
		default:
			logger$6.warn(`Unsupported component type: ${component.type}. Skipping render.`);
			return null;
	}
};
/**
...
const BaseSignInContent = ({ components = [], onSubmit, onError, error: externalError, className = "", inputClassName = "", buttonClassName = "", messageClassName = "", size = "medium", variant = "outlined", isLoading: externalIsLoading, children, additionalData = {}, isTimeoutDisabled = false }) => {
	...
	const { theme } = useTheme_default();
	const customRenderers = (0, react.useContext)(ComponentRendererContext_default);
	const { t } = useTranslation_default();
	...
	*/
	const renderComponents = (0, react.useCallback)((flowComponents) => renderSignInComponents(flowComponents, formValues, touchedFields, formErrors, isLoading, isFormValid, handleInputChange, {
	...
	if (isLoading) return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(Card_default, {
		className: (0, __emotion_css.cx)(containerClasses, styles.card),
		"data-testid": "thunderid-signin",
		variant,
		children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(Card_default.Content, { children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
			style: {
				display: "flex",
	...
	if (!components || components.length === 0) return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(Card_default, {
		className: (0, __emotion_css.cx)(containerClasses, styles.card),
		"data-testid": "thunderid-signin",
		variant,
		children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(Card_default.Content, { children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(Alert_default, {
			variant: "warning",
			children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(Typography_default, {
				variant: "body1",
	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(Card_default, {
		...
		"data-testid": "thunderid-signin",
		variant,
		children: /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(Card_default.Content, { children: [
			externalError && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
				className: styles.flowMessagesContainer,
				children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(Alert_default, {
					variant: "error",
					className: (0, __emotion_css.cx)(styles.flowMessageItem, messageClasses),
					children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(Alert_default.Description, { children: externalError.message })
				})
			}),
			flowMessages && flowMessages.length > 0 && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
				className: styles.flowMessagesContainer,
				children: flowMessages.map((message, index) => /* @__PURE__ */ (0, react_jsx_runtime.jsx)(Alert_default, {
...
const BaseSignIn$1 = ({ preferences,...rest }) => {
	const content = /* @__PURE__ */ (0, react_jsx_runtime.jsx)(FlowProvider_default, { children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(BaseSignInContent, { ...rest }) });
	if (!preferences) return content;
	return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(ComponentPreferencesContext_default.Provider, {
		value: preferences,
		children: content
	});
};
...
const BaseSignIn = (props) => {
	const { platform } = useThunderID_default();
	if (platform === __thunderid_browser.Platform.ThunderID) return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(BaseSignIn_default$1, { ...props });
	return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(BaseSignIn_default$2, { ...props });
};
...
const SignIn$1 = ({ className, preferences, size = "medium", onSuccess, onError, variant, children }) => {
	...
	const { t } = useTranslation_default(preferences?.i18n);
	const [components, setComponents] = (0, react.useState)([]);
	const [additionalData, setAdditionalData] = (0, react.useState)({});
	const [currentExecutionId, setCurrentExecutionId] = (0, react.useState)(null);
	...
	const [isSubmitting, setIsSubmitting] = (0, react.useState)(false);
	const [isTimeoutDisabled, setIsTimeoutDisabled] = (0, react.useState)(false);
	const [passkeyState, setPasskeyState] = (0, react.useState)({
		actionId: null,
		challenge: null,
	...
	const oauthCodeProcessedRef = (0, react.useRef)(false);
	const passkeyProcessedRef = (0, react.useRef)(false);
	/**
	...
	*/
	const handleOAuthError = (error, errorDescription) => {
		clearFlowState();
		setError(new __thunderid_browser.ThunderIDRuntimeError(errorDescription || `OAuth error: ${error}`, "SIGN_IN_ERROR", "react"));
	...
	*/
	const initializeFlow = async () => {
		...
		if (!urlParams.executionId && !effectiveApplicationId) {
			const error = new __thunderid_browser.ThunderIDRuntimeError("Either executionId or applicationId is required for authentication", "SIGN_IN_ERROR", "react");
			setError(error);
			throw error;
		}
		try {
	...
	*/
	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(BaseSignIn_default$1, {
		additionalData,
		components,
...
const SignIn = ({ className, size = "medium", children, preferences,...rest }) => {
	...
	*/
	...
	if (platform === __thunderid_browser.Platform.ThunderID) return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(SignIn_default$1, {
		className,
		size,
	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(BaseSignIn_default, {
...
const DividerComponent = ({ component }) => {
	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(Divider_default, {
...
const EmailInput = ({ component, formValues, touchedFields, formErrors, onInputChange, inputClassName }) => {
	...
	return createField({
		...
		required: config["required"] || false,
		type: __thunderid_browser.FieldType.Email,
		value
	});
};
...
const NumberInput = ({ component, formValues, touchedFields, formErrors, onInputChange, inputClassName }) => {
	...
	return createField({
		...
		placeholder: config["placeholder"] || "",
		required: config["required"] || false,
		type: __thunderid_browser.FieldType.Number,
		value
	});
};
...
const ButtonComponent = ({ component, isLoading, isFormValid, buttonClassName, onSubmit, size = "medium" }) => {
	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(Button_default, {
		...
		className: buttonClassName,
		style: { width: "100%" },
		children: isLoading ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)(Spinner_default, { size: "small" }) : buttonText
	}, component.id);
};
...
const createSignUpComponent = ({ component, onSubmit,...rest }) => {
	switch (component.type) {
		case __thunderid_browser.EmbeddedFlowComponentType.Typography: return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(Typography_default$1, {
			component,
			onSubmit,
			...rest
		});
		case __thunderid_browser.EmbeddedFlowComponentType.Input: {
			...
			if (inputVariant === "EMAIL" || inputType === "email") return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(EmailInput_default, {
				component,
				onSubmit,
				...rest
			});
			if (inputVariant === "PASSWORD" || inputType === "password") return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(PasswordInput_default, {
				component,
				onSubmit,
				...rest
			});
			if (inputVariant === "TELEPHONE" || inputType === "tel") return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(TelephoneInput_default, {
				component,
				onSubmit,
				...rest
			});
			if (inputVariant === "NUMBER" || inputType === "number") return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(NumberInput_default, {
				component,
				onSubmit,
				...rest
			});
			if (inputVariant === "DATE" || inputType === "date") return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(DateInput_default, {
				component,
				onSubmit,
				...rest
			});
			if (inputVariant === "CHECKBOX" || inputType === "checkbox") return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(CheckboxInput_default, {
				component,
				onSubmit,
				...rest
			});
			return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(TextInput_default, {
				component,
				onSubmit,
				...rest
			});
		...
		case __thunderid_browser.EmbeddedFlowComponentType.Button: {
			...
			if (buttonVariant === "SOCIAL") {
				if (buttonText.toLowerCase().includes("google")) return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(GoogleButton_default, {
					onClick: () => onSubmit(component, {}),
					...rest,
					children: buttonText
				});
				if (buttonText.toLowerCase().includes("github")) return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(GitHubButton_default, {
					onClick: () => onSubmit(component, {}),
					...rest,
					children: buttonText
				});
				if (buttonText.toLowerCase().includes("microsoft")) return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(MicrosoftButton_default, {
					onClick: () => onSubmit(component, {}),
					...rest,
					children: buttonText
				});
				if (buttonText.toLowerCase().includes("facebook")) return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(FacebookButton_default, {
					onClick: () => onSubmit(component, {}),
					...rest,
					children: buttonText
				});
				if (buttonText.toLowerCase().includes("linkedin")) return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(LinkedInButton_default, {
					onClick: () => onSubmit(component, {}),
					...rest,
					children: buttonText
				});
				if (buttonText.toLowerCase().includes("ethereum")) return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(SignInWithEthereumButton_default, {
					onClick: () => onSubmit(component, {}),
					...rest,
					children: buttonText
				});
			}
			return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(SubmitButton_default, {
				component,
				onSubmit,
				...rest
			});
		}
		case __thunderid_browser.EmbeddedFlowComponentType.Form: return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(FormContainer_default, {
			component,
			onSubmit,
			...rest
		});
		case __thunderid_browser.EmbeddedFlowComponentType.Select: return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(SelectInput_default, {
			component,
			onSubmit,
			...rest
		});
		case __thunderid_browser.EmbeddedFlowComponentType.Divider: return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(DividerComponent_default, {
			component,
			onSubmit,
			...rest
		});
		case __thunderid_browser.EmbeddedFlowComponentType.Image: return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(ImageComponent_default, {
			component,
			onSubmit,
			...rest
		});
...
* @returns Object containing CSS class names for component styling
*/
const useStyles$14 = (theme, colorScheme) => (0, react.useMemo)(() => {
...
const logger$4 = (0, __thunderid_browser.createPackageComponentLogger)("@thunderid/react", "BaseSignUp");
/**
...
const BaseSignUpContent$1 = ({ afterSignUpUrl, onInitialize, onSubmit, onError, onFlowChange, onComplete, className = "", inputClassName = "", buttonClassName = "", errorClassName = "", messageClassName = "", size = "medium", variant = "outlined", isInitialized, children, showTitle = true, showSubtitle = true }) => {
	...
	*/
	const renderComponents = (0, react.useCallback)((components) => renderSignUpComponents$1(components, formValues, touchedFields, formErrors, isLoading, isFormValid, handleInputChange, {
		buttonClassName: buttonClasses,
		inputClassName: inputClasses,
		onSubmit: handleSubmit,
		size,
	...
	if (!isFlowInitialized && isLoading) return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(Card_default, {
		className: (0, __emotion_css.cx)(containerClasses, styles.card),
		variant,
		children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(Card_default.Content, { children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
			className: styles.loadingContainer,
			children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(Spinner_default, { size: "medium" })
		}) })
	});
	if (!currentFlow) return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(Card_default, {
		className: (0, __emotion_css.cx)(containerClasses, styles.card),
		variant,
		children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(Card_default.Content, { children: /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(Alert_default, {
			variant: "error",
			className: errorClasses,
			children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)(Alert_default.Title, { children: t("errors.heading") }), /* @__PURE__ */ (0, react_jsx_runtime.jsx)(Alert_default.Description, { children: t("errors.signup.flow.initialization.failure") })]
		}) })
	});
	return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(Card_default, {
		className: (0, __emotion_css.cx)(containerClasses, styles.card),
		...
		children: [(showTitle || showSubtitle) && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(Card_default.Header, {
		...
		}), /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(Card_default.Content, { children: [flowMessages && flowMessages.length > 0 && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
			className: styles.flowMessagesContainer,
			children: flowMessages.map((message, index) => /* @__PURE__ */ (0, react_jsx_runtime.jsx)(Alert_default, {
			...
			className: styles.contentContainer,
			children: currentFlow.data?.components && currentFlow.data.components.length > 0 ? renderComponents(currentFlow.data.components) : /* @__PURE__ */ (0, react_jsx_runtime.jsx)(Alert_default, {
				variant: "warning",
				children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(Typography_default, {
					variant: "body1",
...
const BaseSignUp$2 = ({ showLogo = true,...rest }) => {
	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", { children: [showLogo && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
		className: styles.logoContainer,
		children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(Logo_default, { size: "large" })
	}), /* @__PURE__ */ (0, react_jsx_runtime.jsx)(FlowProvider_default, { children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(BaseSignUpContent$1, {
		showLogo,
		...rest
	}) })] });
};
...
const logger$3 = (0, __thunderid_browser.createPackageComponentLogger)("@thunderid/react", "BaseSignUp");
/**
...
const BaseSignUpContent = ({ afterSignUpUrl, onInitialize, onSubmit, onError, onFlowChange, onComplete, error: externalError, className = "", inputClassName = "", buttonClassName = "", errorClassName = "", messageClassName = "", size = "medium", variant = "outlined", isInitialized, children, showTitle = true, showSubtitle = true }) => {
	...
	*/
	const extractFormFields = (0, react.useCallback)((components) => {
		...
		const processComponents = (comps) => {
			comps.forEach((component) => {
				if (component.type === __thunderid_browser.EmbeddedFlowComponentTypeV2.TextInput || component.type === __thunderid_browser.EmbeddedFlowComponentTypeV2.PasswordInput || component.type === __thunderid_browser.EmbeddedFlowComponentTypeV2.EmailInput || component.type === __thunderid_browser.EmbeddedFlowComponentTypeV2.Select) {
	...
	*/
	(0, react.useEffect)(() => {
		...
		const performPasskeyRegistration = async () => {
			...
			if (processedResponse.flowStatus === __thunderid_browser.EmbeddedFlowStatus.Complete) onComplete?.(processedResponse);
			else {
	...
	* Render form components based on flow data using the factory
	*/
	const renderComponents = (0, react.useCallback)((components) => renderSignUpComponents(components, formValues, touchedFields, formErrors, isLoading, isFormValid, handleInputChange, {
		_customRenderers: customRenderers,
		_theme: theme,
		buttonClassName: buttonClasses,
		inputClassName: inputClasses,
	...
	*/
	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(Card_default, {
		...
		children: [(showTitle || showSubtitle) && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(Card_default.Header, {
			...
			/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
				className: styles.contentContainer,
				children: componentsWithoutHeadings && componentsWithoutHeadings.length > 0 ? renderComponents(componentsWithoutHeadings) : /* @__PURE__ */ (0, react_jsx_runtime.jsx)(Alert_default, {
					variant: "warning",
					children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(Typography_default, {
						variant: "body1",
						children: t("errors.signup.components.not.available")
...
const BaseSignUp$1 = ({ preferences, showLogo = true,...rest }) => {
	...
	const content = /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", { children: [showLogo && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
		className: styles.logoContainer,
		children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(Logo_default, { size: "large" })
	}), /* @__PURE__ */ (0, react_jsx_runtime.jsx)(FlowProvider_default, { children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(BaseSignUpContent, {
		showLogo,
		...rest
	}) })] });
	if (!preferences) return content;
...
const BaseSignUp = (props) => {
	const { platform } = useThunderID_default();
	if (platform === __thunderid_browser.Platform.ThunderID) return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(BaseSignUp_default$1, { ...props });
	return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(BaseSignUp_default$2, { ...props });
};
...
const SignUp$2 = ({ className, size = "medium", afterSignUpUrl, onError, onComplete, shouldRedirectAfterSignUp = true, children,...rest }) => {
	...
	*/
	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(BaseSignUp_default$2, {
		afterSignUpUrl,
		onInitialize: handleInitialize,
		onSubmit: handleOnSubmit,
		onError,
...
const SignUp$1 = ({ className, size = "medium", afterSignUpUrl, onError, onComplete, shouldRedirectAfterSignUp = true, children,...rest }) => {
	...
	*/
	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(BaseSignUp_default$1, {
		afterSignUpUrl,
		onInitialize: handleInitialize,
		onSubmit: handleOnSubmit,
		onError,
...
const SignUp = (props) => {
	const { platform } = useThunderID_default();
	if (platform === __thunderid_browser.Platform.ThunderID) return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(SignUp_default$2, { ...props });
	return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(SignUp_default$1, { ...props });
};
...
const BaseRecoveryContent$1 = ({ onInitialize, onSubmit, onError, onFlowChange, onComplete, className = "", inputClassName = "", buttonClassName = "", errorClassName = "", messageClassName = "", size = "medium", variant = "outlined", isInitialized, children, showTitle = true, showSubtitle = true }) => {
	...
	const renderComponents = (0, react.useCallback)((components) => renderRecoveryComponents$1(components, formValues, touchedFields, formErrors, isLoading, isFormValid, handleInputChange, {
		buttonClassName: buttonClasses,
		inputClassName: inputClasses,
		onSubmit: handleSubmit,
		size,
	...
	if (!currentFlow) return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(Card_default, {
		...
		children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(Card_default.Content, { children: /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(Alert_default, {
			variant: "error",
			className: errorClasses,
			children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)(Alert_default.Title, { children: t("errors.heading") }), /* @__PURE__ */ (0, react_jsx_runtime.jsx)(Alert_default.Description, { children: t("errors.recovery.flow.initialization.failure") })]
		}) })
	});
	return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(Card_default, {
		className: (0, __emotion_css.cx)(containerClasses, styles.card),
...
const BaseRecovery$2 = ({ showLogo = true,...rest }) => {
	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", { children: [showLogo && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
		className: styles.logoContainer,
		children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(Logo_default, { size: "large" })
	}), /* @__PURE__ */ (0, react_jsx_runtime.jsx)(FlowProvider_default, { children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(BaseRecoveryContent$1, {
		showLogo,
		...rest
	}) })] });
};
...
const BaseRecoveryContent = ({ onInitialize, onSubmit, onError, onFlowChange, onComplete, error: externalError, className = "", inputClassName = "", buttonClassName = "", errorClassName = "", messageClassName = "", size = "medium", variant = "outlined", isInitialized, children, showTitle = true, showSubtitle = true }) => {
	...
	const errorClasses = (0, __emotion_css.cx)([(0, __thunderid_browser.withVendorCSSClassPrefix)("recovery__error")], errorClassName);
	const messageClasses = (0, __emotion_css.cx)([(0, __thunderid_browser.withVendorCSSClassPrefix)("recovery__messages")], messageClassName);
	const renderComponents = (0, react.useCallback)((components) => renderRecoveryComponents(components, formValues, touchedFields, formErrors, isLoading, isFormValid, handleInputChange, {
		_customRenderers: customRenderers,
		_theme: theme,
		buttonClassName: buttonClasses,
		inputClassName: inputClasses,
...
const BaseRecovery$1 = ({ preferences, showLogo = true,...rest }) => {
	...
	const content = /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", { children: [showLogo && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
		className: styles.logoContainer,
		children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(Logo_default, { size: "large" })
	}), /* @__PURE__ */ (0, react_jsx_runtime.jsx)(FlowProvider_default, { children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(BaseRecoveryContent, {
		showLogo,
		...rest
	}) })] });
	if (!preferences) return content;
...
const BaseRecovery = (props) => {
	const { platform } = useThunderID_default();
	if (platform === __thunderid_browser.Platform.ThunderID) return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(BaseRecovery_default$1, { ...props });
	return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(BaseRecovery_default$2, { ...props });
};
...
const Recovery$2 = ({ className, size = "medium", afterRecoveryUrl, onError, onComplete, children,...rest }) => {
	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(BaseRecovery_default$2, {
		afterRecoveryUrl,
		onInitialize: handleInitialize,
		onSubmit: handleOnSubmit,
		onError,
...
const Recovery$1 = ({ className, size = "medium", afterRecoveryUrl, onError, onComplete, tokenUrlParam, children,...rest }) => {
	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(BaseRecovery_default$1, {
		afterRecoveryUrl,
...
const Recovery = (props) => {
	const { platform } = useThunderID_default();
	if (platform === __thunderid_browser.Platform.ThunderID) return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(Recovery_default$2, { ...props });
	return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(Recovery_default$1, { ...props });
};
...
* @returns Object containing CSS class names for component styling
*/
const useStyles$13 = (theme, colorScheme) => (0, react.useMemo)(() => {
	const card = __emotion_css.css`
      background: ${theme.vars.colors.background.surface};
      border-radius: ${theme.vars.borderRadius.large};
      gap: calc(${theme.vars.spacing.unit} * 2);
...
const BaseInviteUser = ({ onInitialize, onSubmit, onError, onFlowChange, className = "", children, fetchOrganizationUnitChildren, isInitialized = true, preferences, size = "medium", variant = "outlined", showTitle = true, showSubtitle = true }) => {
	...
	*/
	const renderComponents = (0, react.useCallback)((components$1) => renderInviteUserComponents(components$1, formValues, touchedFields, formErrors, isLoading, isFormValid, handleInputChange, {
		_customRenderers: customRenderers,
		_theme: theme,
	...
	if (!isInitialized) return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(Card_default, {
	...
	if (!currentFlow && apiError) return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(Card_default, {
		className: (0, __emotion_css.cx)(className, styles.card),
		variant,
		children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(Card_default.Content, { children: /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(Alert_default, {
			variant: "error",
			children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)(Alert_default.Title, { children: "Error" }), /* @__PURE__ */ (0, react_jsx_runtime.jsx)(Alert_default.Description, { children: apiError.message })]
		}) })
	});
	return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(Card_default, {
		className: (0, __emotion_css.cx)(className, styles.card),
		variant,
		children: [(showTitle || showSubtitle) && (title || subtitle) && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(Card_default.Header, {
			className: styles.header,
			children: [showTitle && title && /* @__PURE__ */ (0, react_jsx_runtime.jsx)(Card_default.Title, {
				level: 2,
				className: styles.title,
				children: title
			}), showSubtitle && subtitle && /* @__PURE__ */ (0, react_jsx_runtime.jsx)(Typography_default, {
				variant: "body1",
				className: styles.subtitle,
				children: subtitle
			})]
		}), /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(Card_default.Content, { children: [apiError && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
			style: { marginBottom: "1rem" },
			children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(Alert_default, {
				variant: "error",
				children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(Alert_default.Description, { children: apiError.message })
			})
		}), /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", { children: [componentsWithoutHeadings && componentsWithoutHeadings.length > 0 ? renderComponents(componentsWithoutHeadings) : !isLoading && /* @__PURE__ */ (0, react_jsx_runtime.jsx)(Alert_default, {
			variant: "warning",
			children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(Typography_default, {
				variant: "body1",
			...
			children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(Spinner_default, { size: "small" })
		})] })] })]
	});
};
...
const InviteUser = ({ onError, onFlowChange, className, children, size = "medium", variant = "outlined", showTitle = true, showSubtitle = true }) => {
	...
	*/
	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(BaseInviteUser_default, {
		onInitialize: handleInitialize,
		onSubmit: handleSubmit,
		onError,
		onFlowChange,
		className,
		fetchOrganizationUnitChildren: (0, react.useCallback)(async (parentId, limit, offset$3) => {
...
* @returns Object containing CSS class names for component styling
*/
const useStyles$12 = (theme, colorScheme) => (0, react.useMemo)(() => {
	const card = __emotion_css.css`
      background: ${theme.vars.colors.background.surface};
      border-radius: ${theme.vars.borderRadius.large};
      gap: calc(${theme.vars.spacing.unit} * 2);
...
const BaseAcceptInvite = ({ executionId, inviteToken, onSubmit, onComplete, onError, onFlowChange, onGoToSignIn, className = "", children, preferences, size = "medium", variant = "outlined", showTitle = true, showSubtitle = true }) => {
	...
	*/
	...
	if (isValidatingToken) return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(Card_default, {
		className: (0, __emotion_css.cx)(className, styles.card),
		variant,
		children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(Card_default.Content, { children: /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
			style: {
	...
	if (isTokenInvalid) return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(Card_default, {
		className: (0, __emotion_css.cx)(className, styles.card),
		variant,
		children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)(Card_default.Header, {
			className: styles.header,
			children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(Card_default.Title, {
				level: 2,
				className: styles.title,
				children: "Invalid Invite Link"
			})
		}), /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(Card_default.Content, { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)(Alert_default, {
			variant: "error",
			children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)(Alert_default.Title, { children: "Unable to verify invite" }), /* @__PURE__ */ (0, react_jsx_runtime.jsx)(Alert_default.Description, { children: apiError?.message || "This invite link is invalid or has expired. Please contact your administrator for a new invite." })]
			...
			children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(Button_default, {
				variant: "outline",
	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(Card_default, {
		...
		children: [(showTitle || showSubtitle) && (title || subtitle) && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(Card_default.Header, {
			...
			/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", { children: [componentsWithoutHeadings && componentsWithoutHeadings.length > 0 ? renderInviteUserComponents(componentsWithoutHeadings, formValues, touchedFields, formErrors, isLoading, isFormValid, handleInputChange, {
				_customRenderers: customRenderers,
				_theme: theme,
				onInputBlur: handleInputBlur,
				onSubmit: handleSubmit,
				size,
				variant
			}) : !isLoading && /* @__PURE__ */ (0, react_jsx_runtime.jsx)(Alert_default, {
				variant: "warning",
				children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(Typography_default, {
					variant: "body1",
					children: "No form components available"
			...
			onGoToSignIn && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
				...
				children: /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(Typography_default, {
					variant: "body2",
					children: [
...
const AcceptInvite = ({ baseUrl, executionId: executionIdProp, inviteToken: inviteTokenProp, onComplete, onError, onFlowChange, onGoToSignIn, className, children, size = "medium", variant = "outlined", showTitle = true, showSubtitle = true }) => {
	...
	*/
	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(BaseAcceptInvite_default, {
		executionId,
		inviteToken,
		onSubmit: handleSubmit,
		onComplete,
...
const User$1 = ({ children, fallback = null }) => {
	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(BaseUser_default, {
		user,
		fallback,
		children
	});
...
const Organization = ({ children, fallback = null }) => {
	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(BaseOrganization_default, {
		organization: currentOrganization,
		fallback,
		children
	});
...
* @returns Object containing CSS class names for component styling
*/
const useStyles$10 = (theme, colorScheme, size, variant, backgroundColor) => (0, react.useMemo)(() => {
...
const Avatar = ({ alt = "User avatar", background = "random", className = "", imageUrl, name, size = 64, variant = "circular", isLoading = false }) => {
	...
	const generateBackgroundColor = (inputString) => {
		...
		const generateColor = (offset$3) => {
			const hue1 = (seed + offset$3) % 360;
			const hue2 = (hue1 + 60 + seed % 120) % 360;
			const saturation = 70 + seed % 20;
			return `hsl(${hue1}, ${saturation}%, ${55 + seed % 15}%), hsl(${hue2}, ${saturation}%, ${60 + (seed + offset$3) % 15}%)`;
		};
		return `linear-gradient(${45 + seed % 91}deg, ${generateColor(seed)})`;
	};
	const styles = Avatar_styles_default(theme, colorScheme, size, variant, (0, react.useMemo)(() => {
...
* @returns Object containing CSS class names for component styling
*/
const useStyles$9 = (theme, colorScheme) => (0, react.useMemo)(() => {
...
const DialogHeading = (0, react.forwardRef)(({ children,...props }, ref) => {
	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
		...
		children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("h2", {
			...
			"aria-label": "Close",
			children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(X_default, {
				width: 16,
				height: 16
			})
		})]
...
* @returns Object containing CSS class names for component styling
*/
const useStyles$8 = (theme, colorScheme, disabled, hasError, canAddMore, canRemove) => (0, react.useMemo)(() => {
	const container = __emotion_css.css`
      display: flex;
      flex-direction: column;
      gap: ${theme.vars.spacing.unit};
...
const MultiInput = ({ label, error, required, className, disabled, helperText, placeholder = "Enter value", values = [], onChange, type = "text", fieldType = "STRING", startIcon, endIcon, minFields = 1, maxFields, style = {} }) => {
	...
	const renderInputField = (0, react.useCallback)((value, onValueChange, attachedEndIcon, onEndIconClick) => {
		...
		switch (fieldType) {
			case "DATE_TIME": return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(DatePicker_default, { ...commonProps });
			case "BOOLEAN": return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(Checkbox_default, {
				...commonProps,
...
const BaseUserProfile = ({ fallback = null, className = "", cardLayout = true, profile, schemas = [], flattenedProfile, mode = "inline", title, attributeMapping = {}, editable = true, onOpenChange, onUpdate, open = false, error = null, isLoading = false, preferences, showFields = [], hideFields = [], displayNameAttributes = [] }) => {
	const { theme, colorScheme } = useTheme_default();
	const [editedUser, setEditedUser] = (0, react.useState)(flattenedProfile || profile);
	...
	*/
	const shouldShowField = (0, react.useCallback)((fieldName) => {
	...
	const getFieldPlaceholder = (0, react.useCallback)((schema) => {
	...
	const formatLabel = (0, react.useCallback)((key) => key.split(/(?=[A-Z])|_/).map((word) => word.charAt(0).toUpperCase() + word.slice(1).toLowerCase()).join(" "), []);
	...
	const ObjectDisplay = ({ data }) => {
		...
		return /* @__PURE__ */ (0, react_jsx_runtime.jsx)("table", {
			...
			children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)("tbody", { children: Object.entries(data).map(([key, value]) => /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("tr", { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("td", {
				className: styles.objectKey,
				children: /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("strong", { children: [formatLabel(key), ":"] })
			}), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("td", {
				className: styles.objectValue,
				children: typeof value === "object" ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)(ObjectDisplay, { data: value }) : String(value)
			})] }, key)) })
		});
	};
	...
	const handleFieldSave = (0, react.useCallback)((schema) => {
		...
		let payload = {};
		if (schema.schemaId && schema.schemaId !== __thunderid_browser.WellKnownSchemaIds.User) payload = { [schema.schemaId]: { [fieldName]: fieldValue } };
	...
	const handleFieldCancel = (0, react.useCallback)((fieldName) => {
	...
	const renderSchemaField = (schema, isEditing, onEditValue, onStartEdit) => {
		...
		if (subAttributes && Array.isArray(subAttributes)) return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(react_jsx_runtime.Fragment, { children: subAttributes.map((subAttr, index) => {
			let displayValue$1;
		...
		if (Array.isArray(value) || multiValued) {
			...
			if (isEditing && onEditValue && isEditable$1) {
				...
				return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
					...
					className: styles.value,
					children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(MultiInput_default, {
						values: fieldValues,
						onChange: (newValues) => {
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
				...
				className: (0, __emotion_css.cx)(styles.value, !hasValues ? styles.valuePlaceholder : ""),
				children: !hasValues && isEditable$1 && onStartEdit ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)(Button_default, {
					onClick: onStartEdit,
					variant: "text",
					color: "secondary",
					size: "small",
		...
		if (type === "COMPLEX" && typeof value === "object") return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(ObjectDisplay, { data: value });
		if (isEditing && onEditValue && mutability !== "READ_ONLY" && !readonlyFields.includes(name || "")) {
			...
			switch (type) {
				case "STRING":
					field = /* @__PURE__ */ (0, react_jsx_runtime.jsx)(TextField_default, { ...commonProps });
					break;
				case "DATE_TIME":
					field = /* @__PURE__ */ (0, react_jsx_runtime.jsx)(DatePicker_default, { ...commonProps });
					break;
				case "BOOLEAN":
					field = /* @__PURE__ */ (0, react_jsx_runtime.jsx)(Checkbox_default, {
						...commonProps,
						checked: !!fieldValue,
						onChange: (e) => {
					...
					break;
				case "COMPLEX":
					field = /* @__PURE__ */ (0, react_jsx_runtime.jsx)("textarea", {
						value: fieldValue,
					...
					break;
				default: field = /* @__PURE__ */ (0, react_jsx_runtime.jsx)(TextField_default, { ...commonProps });
			}
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
				className: styles.label,
				children: label
		...
		return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
			...
			className: (0, __emotion_css.cx)(styles.value, !hasValue ? styles.valuePlaceholder : ""),
			children: !hasValue && isEditable && onStartEdit ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)(Button_default, {
				onClick: onStartEdit,
				variant: "text",
				color: "secondary",
				size: "small",
	...
	const renderUserInfo = (schema) => {
		...
		return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
			...
			}), editable && schema.mutability !== "READ_ONLY" && !isReadonlyField && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				className: styles.fieldActions,
				children: [isFieldEditing && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)(Button_default, {
					size: "small",
					color: "primary",
					variant: "solid",
					...
					children: "Cancel"
				})] }), !isFieldEditing && hasValue && /* @__PURE__ */ (0, react_jsx_runtime.jsx)(Button_default, {
					size: "small",
					color: "tertiary",
					variant: "icon",
	...
	const containerClasses = (0, __emotion_css.cx)(styles.root, cardLayout ? styles.card : "", (0, __thunderid_browser.withVendorCSSClassPrefix)("user-profile"), className);
		...
		return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [
			/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				...
				children: [
					...
					getMappedUserProfileValue_default("email", mergedMappings, currentUser) && /* @__PURE__ */ (0, react_jsx_runtime.jsx)(Typography_default, {
						variant: "body2",
						color: "textSecondary",
			...
			/* @__PURE__ */ (0, react_jsx_runtime.jsx)(Divider_default, {}),
			profileEntries.map(([key, value], index) => /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
			...
			}), index < profileEntries.length - 1 && /* @__PURE__ */ (0, react_jsx_runtime.jsx)(Divider_default, {})] }, key))
		] });
	};
	const profileContent = /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(Card_default, {
		className: containerClasses,
		children: [
			error && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(Alert_default, {
				variant: "error",
				className: (0, __emotion_css.cx)((0, __thunderid_browser.withVendorCSSClassPrefix)((0, __thunderid_browser.bem)("user-profile", "alert")), styles.alert),
				children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)(Alert_default.Title, { children: t("errors.heading") || "Error" }), /* @__PURE__ */ (0, react_jsx_runtime.jsx)(Alert_default.Description, { children: error })]
			}),
			schemas && schemas.length > 0 && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
				className: styles.header,
	...
	if (mode === "popup") return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(Dialog_default, {
		open,
		onOpenChange,
		children: /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(Dialog_default.Content, { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)(Dialog_default.Heading, { children: title ?? t("user.profile.heading") }), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
...
const UserProfile = ({ preferences,...rest }) => {
	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(BaseUserProfile_default, {
		profile,
		flattenedProfile,
		schemas,
...
* @returns Object containing CSS class names for component styling
*/
const useStyles$7 = (theme, colorScheme) => (0, react.useMemo)(() => {
...
const BaseUserDropdown = ({ fallback = null, className = "", user, isLoading = false, portalId = "thunderid-user-dropdown", menuItems = [], showTriggerLabel = false, avatarSize = 32, onManageProfile, onSignOut, attributeMapping = {} }) => {
	...
	if (onManageProfile) defaultMenuItems.push({
		icon: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(User_default$1, {
			width: "16",
			height: "16"
		}),
	...
	if (onSignOut) defaultMenuItems.push({
		icon: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(LogOut_default, {
			width: "16",
			height: "16"
		}),
		label: "Sign Out",
	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
		...
		children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)(Button_default, {
			...
			}), showTriggerLabel && /* @__PURE__ */ (0, react_jsx_runtime.jsx)(Typography_default, {
				variant: "body2",
...
const UserDropdown = ({ children, renderTrigger, renderDropdown, onSignOut,...rest }) => {
	...
	if (children) return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [children(renderProps), /* @__PURE__ */ (0, react_jsx_runtime.jsx)(UserProfile_default, {
		mode: "popup",
		open: isProfileOpen,
		onOpenChange: setIsProfileOpen
	})] });
	if (renderTrigger || renderDropdown) return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [renderTrigger ? renderTrigger(renderProps) : /* @__PURE__ */ (0, react_jsx_runtime.jsx)(BaseUserDropdown, {
		user,
		isLoading,
		onManageProfile: handleManageProfile,
		onSignOut: handleSignOut,
		...rest
	}), /* @__PURE__ */ (0, react_jsx_runtime.jsx)(UserProfile_default, {
		mode: "popup",
		open: isProfileOpen,
		onOpenChange: setIsProfileOpen
	})] });
	return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)(BaseUserDropdown, {
		user,
		isLoading,
		onManageProfile: handleManageProfile,
		onSignOut: handleSignOut,
		...rest
	}), isProfileOpen && /* @__PURE__ */ (0, react_jsx_runtime.jsx)(UserProfile_default, {
		mode: "popup",
		open: isProfileOpen,
		onOpenChange: setIsProfileOpen
	})] });
...
* @returns Object containing CSS class names for component styling
*/
const useStyles$6 = (theme, colorScheme) => (0, react.useMemo)(() => {
	const root = __emotion_css.css`
      display: inline-block;
      position: relative;
      font-family: ${theme.vars.typography.fontFamily};
...
*/
const Building = ({ color = "currentColor", height = 24, width = 24 }) => /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("svg", {
	width,
	height,
	viewBox: "0 0 24 24",
	fill: "none",
...
const BaseOrganizationSwitcher = ({ organizations, currentOrganization, loading = false, error, onOrganizationSwitch, onManageProfile, className = "", style, renderOrganization, renderLoading, renderError, showRole = false, showMemberCount = true, menuItems = [], portalId = "thunderid-organization-switcher", showTriggerLabel = true, avatarSize = 24, fallback = null, preferences }) => {
	...
	const defaultRenderOrganization$1 = (organization, isSelected) => /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [
		/* @__PURE__ */ (0, react_jsx_runtime.jsx)(Avatar, {
			variant: "square",
		...
		isSelected && /* @__PURE__ */ (0, react_jsx_runtime.jsx)(Check_default, {
			width: "16",
			height: "16",
			color: theme.vars.colors.text.primary
		})
	] });
	const defaultRenderLoading$1 = () => /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
	...
	const defaultRenderError$1 = (errorMessage) => /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
		...
		children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)(Button_default, {
			...
			size: "medium",
			...getReferenceProps(),
			children: [currentOrganization ? /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)(Avatar, {
				variant: "square",
			...
			})] }) : /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)(Building_default, {
				width: avatarSize,
				height: avatarSize
			}), showTriggerLabel && /* @__PURE__ */ (0, react_jsx_runtime.jsx)(Typography_default, {
				variant: "body2",
				...
				children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(ChevronDown_default, {
					width: "16",
					height: "16"
				})
			})]
							...
							children: [
								...
								/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
									...
									children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)(Typography_default, {
										...
										children: [showMemberCount && currentOrganization.memberCount !== void 0 && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(Typography_default, {
											noWrap: true,
											variant: "caption",
											color: "secondary",
											children: [
										...
										}), showRole && currentOrganization.role && (!showMemberCount || currentOrganization.memberCount === void 0) && /* @__PURE__ */ (0, react_jsx_runtime.jsx)(Typography_default, {
											noWrap: true,
								...
								onManageProfile && /* @__PURE__ */ (0, react_jsx_runtime.jsx)(Button_default, {
									onClick: onManageProfile,
									color: "tertiary",
									variant: "outline",
									size: "small",
...
* @returns Object containing CSS class names for component styling
*/
const useStyles$5 = (theme, colorScheme) => (0, react.useMemo)(() => {
	const root = __emotion_css.css`
      padding: calc(${theme.vars.spacing.unit} * 4);
      min-width: 600px;
      margin: 0 auto;
...
const logger$1 = (0, __thunderid_browser.createPackageComponentLogger)("@thunderid/react", "BaseCreateOrganization");
/**
...
const BaseCreateOrganization = ({ cardLayout = true, className = "", defaultParentId = "", error, initialValues = {}, loading = false, mode = "inline", onCancel, onOpenChange, onSubmit, onSuccess, open = false, preferences, renderAdditionalFields, style, title = "Create Organization" }) => {
	...
	*/
			...
			children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("form", {
				...
				children: [
					...
					/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
						...
						children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(TextField_default, {
					...
					/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
						className: (0, __emotion_css.cx)(styles["fieldGroup"]),
						children: /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(FormControl_default, {
							error: formErrors.description,
							children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)(InputLabel_default, {
								required: true,
				...
				children: [onCancel && /* @__PURE__ */ (0, react_jsx_runtime.jsx)(Button_default, {
					type: "button",
					variant: "outline",
					onClick: onCancel,
					disabled: loading,
	...
	if (mode === "popup") return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(Dialog_default, {
		open,
		onOpenChange,
		children: /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(Dialog_default.Content, { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)(Dialog_default.Heading, { children: title }), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
			className: styles["popup"],
...
const CreateOrganization = ({ onCreateOrganization, fallback = null, onSuccess, defaultParentId,...props }) => {
	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(BaseCreateOrganization, {
		onSubmit: handleSubmit,
		loading,
		error,
...
* @returns Object containing CSS class names for component styling
*/
const useStyles$4 = (theme, colorScheme) => (0, react.useMemo)(() => {
	const root = __emotion_css.css`
      padding: calc(${theme.vars.spacing.unit} * 4);
      min-width: 600px;
      margin: 0 auto;
	...
	children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
		...
		children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)(Avatar, {
			...
			children: [
				...
				/* @__PURE__ */ (0, react_jsx_runtime.jsxs)(Typography_default, {
					variant: "body2",
					color: "textSecondary",
					className: (0, __emotion_css.cx)(styles.organizationHandle),
					children: ["@", organization.orgHandle]
				}),
				showStatus && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(Typography_default, {
					variant: "body2",
					color: "textSecondary",
...
*/
const defaultRenderLoadMore = (onLoadMore, isLoadingMore, t, styles) => /* @__PURE__ */ (0, react_jsx_runtime.jsx)(Button_default, {
	onClick: onLoadMore,
	...
	const organizationListContent = /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
		...
		children: [
			/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				...
				}), onRefresh && /* @__PURE__ */ (0, react_jsx_runtime.jsx)(Button_default, {
					onClick: onRefresh,
...
* @returns Object containing CSS class names for component styling
*/
const useStyles$3 = (theme, colorScheme) => (0, react.useMemo)(() => {
...
const OrganizationList = (props) => {
	...
	const { getAllOrganizations: getAllOrganizations$1, error, isLoading, myOrganizations } = useOrganization_default();
	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
		...
		children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
			...
			children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(BaseOrganizationList, {
				allOrganizations,
				myOrganizations,
				error,
				isLoading,
...
* @returns Object containing CSS class names for component styling
*/
const useStyles$2 = (theme, colorScheme) => (0, react.useMemo)(() => ({
...
* @returns Object containing CSS class names for component styling
*/
const useStyles$1 = (theme, colorScheme, disabled, readOnly, hasError) => (0, react.useMemo)(() => {
	const container = __emotion_css.css`
      display: flex;
      flex-direction: column;
      font-family: ${theme.vars.typography.fontFamily};
...
const KeyValueInput = ({ className = "", disabled = false, error, helperText, keyLabel = "Key", keyPlaceholder = "Enter key", label, maxPairs, onChange, onAdd, onRemove, readOnly = false, removeButtonText = "Remove", required = false, value = {}, valueLabel = "Value", valuePlaceholder = "Enter value" }) => {
	...
	const [pairs, setPairs] = (0, react.useState)(Array.isArray(value) ? value : Object.entries(value).map(([key, val]) => ({
		key,
		value: String(val)
	})));
	const [newKey, setNewKey] = (0, react.useState)("");
	const [newValue, setNewValue] = (0, react.useState)("");
	const handleAddPair = (0, react.useCallback)(() => {
	...
	const handleRemovePair = (0, react.useCallback)((index) => {
	...
	const handleUpdatePair = (0, react.useCallback)((index, field, newVal) => {
	...
	const renderReadOnlyContent = () => {
		if (pairs.length === 0) return /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
			className: (0, __emotion_css.cx)((0, __thunderid_browser.withVendorCSSClassPrefix)((0, __thunderid_browser.bem)("key-value-input", "empty-state")), styles["emptyState"]),
			children: "No attributes defined"
		});
		return pairs.map((pair, index) => /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
			className: (0, __emotion_css.cx)((0, __thunderid_browser.withVendorCSSClassPrefix)((0, __thunderid_browser.bem)("key-value-input", "readonly-pair")), styles["readOnlyPair"]),
			children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", {
				className: (0, __emotion_css.cx)((0, __thunderid_browser.withVendorCSSClassPrefix)((0, __thunderid_browser.bem)("key-value-input", "readonly-key")), styles["readOnlyKey"]),
				children: [pair.key, ":"]
			}), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
				className: (0, __emotion_css.cx)((0, __thunderid_browser.withVendorCSSClassPrefix)((0, __thunderid_browser.bem)("key-value-input", "readonly-value")), styles["readOnlyValue"]),
				children: pair.value
			})]
		}, `${pair.key}-${index}`));
	};
	return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
		className: (0, __emotion_css.cx)((0, __thunderid_browser.withVendorCSSClassPrefix)((0, __thunderid_browser.bem)("key-value-input")), styles["container"], className),
		children: [
			label && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("label", {
				className: (0, __emotion_css.cx)((0, __thunderid_browser.withVendorCSSClassPrefix)((0, __thunderid_browser.bem)("key-value-input", "label")), styles["label"]),
				children: [label, required && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
					className: (0, __emotion_css.cx)((0, __thunderid_browser.withVendorCSSClassPrefix)((0, __thunderid_browser.bem)("key-value-input", "required")), styles["requiredIndicator"]),
					children: " *"
				})]
			}),
			/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				className: (0, __emotion_css.cx)((0, __thunderid_browser.withVendorCSSClassPrefix)((0, __thunderid_browser.bem)("key-value-input", "pairs-list")), styles["pairsList"]),
				children: [readOnly ? renderReadOnlyContent() : pairs.map((pair, index) => /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
					className: (0, __emotion_css.cx)((0, __thunderid_browser.withVendorCSSClassPrefix)((0, __thunderid_browser.bem)("key-value-input", "pair-row")), styles["pairRow"]),
					children: [
						/* @__PURE__ */ (0, react_jsx_runtime.jsx)(TextField_default, {
							placeholder: keyPlaceholder,
							value: pair.key,
							onChange: (e) => handleUpdatePair(index, "key", e.target.value),
							disabled: disabled || readOnly,
							className: (0, __emotion_css.cx)((0, __thunderid_browser.withVendorCSSClassPrefix)((0, __thunderid_browser.bem)("key-value-input", "pair-input")), styles["pairInput"]),
						...
						!readOnly && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
							...
							disabled,
							className: (0, __emotion_css.cx)((0, __thunderid_browser.withVendorCSSClassPrefix)((0, __thunderid_browser.bem)("key-value-input", "remove-button")), styles["removeButton"]),
				...
				}, `${pair.key}-${index}`)), !readOnly && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
					className: (0, __emotion_css.cx)((0, __thunderid_browser.withVendorCSSClassPrefix)((0, __thunderid_browser.bem)("key-value-input", "add-row")), styles["addRow"]),
					children: [
						/* @__PURE__ */ (0, react_jsx_runtime.jsx)(TextField_default, {
							placeholder: keyPlaceholder,
							value: newKey,
						...
						/* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
							...
							className: (0, __emotion_css.cx)((0, __thunderid_browser.withVendorCSSClassPrefix)((0, __thunderid_browser.bem)("key-value-input", "add-button")), styles["addButton"]),
							"aria-label": "Add new key-value pair",
							children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(Plus_default, {
								width: 16,
								height: 16
							})
						})
			...
			(helperText || error) && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
				className: (0, __emotion_css.cx)((0, __thunderid_browser.withVendorCSSClassPrefix)((0, __thunderid_browser.bem)("key-value-input", "helper-text")), styles["helperText"]),
				children: error || helperText
			}),
			maxPairs && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				className: (0, __emotion_css.cx)((0, __thunderid_browser.withVendorCSSClassPrefix)((0, __thunderid_browser.bem)("key-value-input", "counter")), styles["counterText"]),
				children: [
					pairs.length,
					" of ",
					maxPairs,
...
const BaseOrganizationProfile = ({ fallback = null, className = "", cardLayout = true, organization, title = "Organization Profile", mode = "inline", editable = true, onOpenChange, onUpdate, open = false, saveButtonText = "Save Changes", cancelButtonText = "Cancel", fields = [
	...
	const renderField = (field, isEditing, onEditValue, onStartEdit) => {
		...
		if (isEditing && onEditValue && fieldEditable && editable) {
			...
			let fieldInput;
			if (key === "attributes") fieldInput = /* @__PURE__ */ (0, react_jsx_runtime.jsx)(KeyValueInput_default, {
			...
			else fieldInput = /* @__PURE__ */ (0, react_jsx_runtime.jsx)(TextField_default, { ...commonProps });
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
		...
		let displayValue;
		if (hasValue) displayValue = key === "attributes" && typeof value === "object" && value !== null ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)(KeyValueInput_default, {
			value,
			readOnly: true,
			label: ""
		...
		return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
			...
			children: !hasValue && isFieldEditable && onStartEdit ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)(Button_default, {
				onClick: onStartEdit,
				variant: "text",
				color: "secondary",
				size: "small",
	...
	const renderOrganizationField = (field) => {
		...
		return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
			...
			children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
				...
				})] }) : hasValue && /* @__PURE__ */ (0, react_jsx_runtime.jsx)(Button_default, {
...
* ```
*/
const getOrganization = async ({ fetcher, instanceId = 0,...requestConfig }) => {
	const defaultFetcher = async (url, config) => {
		const response = await __thunderid_browser.FetchHttpClient.getInstance(instanceId).request({
			headers: config.headers,
			method: config.method || "GET",
	...
	return (0, __thunderid_browser.getOrganization)({
		...requestConfig,
		fetcher: fetcher || defaultFetcher
	});
};
...
* ```
*/
const updateOrganization = async ({ fetcher, instanceId = 0,...requestConfig }) => {
	const defaultFetcher = async (url, config) => {
		const response = await __thunderid_browser.FetchHttpClient.getInstance(instanceId).request({
			data: config.body ? JSON.parse(config.body) : void 0,
			headers: config.headers,
	...
	return (0, __thunderid_browser.updateOrganization)({
		...requestConfig,
		fetcher: fetcher || defaultFetcher
	});
};
...
const OrganizationProfile = ({ organizationId, mode = "default", open = false, onOpenChange, onUpdate, popupTitle, loadingFallback, errorFallback, preferences,...rest }) => {
	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(BaseOrganizationProfile_default, {
		organization,
...
const OrganizationSwitcher = ({ currentOrganization: propCurrentOrganization, fallback = null, onOrganizationSwitch: propOnOrganizationSwitch, organizations: propOrganizations, preferences,...props }) => {
	...
	if (currentOrganization) defaultMenuItems.push({
		icon: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(BuildingAlt_default, {}),
	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [
		/* @__PURE__ */ (0, react_jsx_runtime.jsx)(BaseOrganizationSwitcher, {
			organizations,
			currentOrganization,
		...
		/* @__PURE__ */ (0, react_jsx_runtime.jsx)(CreateOrganization, {
			mode: "popup",
		...
		currentOrganization && /* @__PURE__ */ (0, react_jsx_runtime.jsx)(OrganizationProfile_default, {
		...
		/* @__PURE__ */ (0, react_jsx_runtime.jsx)(OrganizationList_default, {
			mode: "popup",
	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
		...
		children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("button", {
			...
			children: [
				...
				hasMultipleLanguages && /* @__PURE__ */ (0, react_jsx_runtime.jsx)(ChevronDown_default, {})
			]
				...
				children: languages.map((lang) => /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("button", {
					...
					children: [
						...
						lang.code === currentLanguage && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
							...
							children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(Check_default, {})
						})
					]
				}, lang.code))
			})
...
const useFlowMeta = () => {
	const context = (0, react.useContext)(FlowMetaContext_default);
...
const LanguageSwitcher = ({ children, className }) => {
	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(BaseLanguageSwitcher_default, {
		currentLanguage,
		isLoading,
		languages,
...
exports.BaseOrganization = BaseOrganization_default;
...
exports.BaseRecovery = BaseRecovery_default;
...
exports.Consent = Consent_default;
exports.ConsentCheckboxList = ConsentCheckboxList_default;
...
exports.EmailOtp = EmailOtp_default;
...
exports.MultiInput = MultiInput_default;
exports.MultiOptionButton = MultiOptionButton_default;
exports.Organization = Organization_default;
exports.OrganizationContext = OrganizationContext_default;
...
exports.ThunderIDContext = ThunderIDContext_default;
...
exports.Totp = Totp_default;
exports.TriangleAlert = TriangleAlert_default;
exports.Typography = Typography_default;
exports.User = User_default;
exports.UserContext = UserContext_default;
exports.UserDropdown = UserDropdown_default;
exports.UserIcon = User_default$1;
exports.UserProfile = UserProfile_default;
exports.UserProvider = UserProvider_default;
exports.UsernamePassword = UsernamePassword_default;
...
exports.getMeProfile = getScim2Me_default;
...
exports.useBrandingContext = useBrandingContext_default;
exports.useBrowserUrl = useBrowserUrl_default;
exports.useFlow = useFlow_default;
exports.useForm = useForm_default;
...
exports.useTranslation = useTranslation_default;

 ...
 * ```
 */
export default function useGetChildOrganizationUnits(parentId: string | undefined, params?: OrganizationUnitListParams): UseQueryResult<OrganizationUnitListResponse>;

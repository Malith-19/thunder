...
*/
const useStyles = (theme, colorScheme, disabled, hasError, length) => (0, react.useMemo)(() => {
...
//#endregion
exports.default = OtpField_styles_default;
//# sourceMappingURL=OtpField.styles.cjs.map
...
*/
const useStyles = (theme, colorScheme, variant, align, color, noWrap, inline, gutterBottom, fontWeight, fontSize, lineHeight) => (0, react.useMemo)(() => {
...
//#endregion
exports.default = Typography_styles_default;

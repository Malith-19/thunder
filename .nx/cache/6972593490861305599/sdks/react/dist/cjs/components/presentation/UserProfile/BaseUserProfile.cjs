...
const require_BaseUserProfile_styles = require('./BaseUserProfile.styles.cjs');
...
const require_MultiInput = require('../../primitives/MultiInput/MultiInput.cjs');
...
const BaseUserProfile = ({ fallback = null, className = "", cardLayout = true, profile, schemas = [], flattenedProfile, mode = "inline", title, attributeMapping = {}, editable = true, onOpenChange, onUpdate, open = false, error = null, isLoading = false, preferences, showFields = [], hideFields = [], displayNameAttributes = [] }) => {
	...
	*/
	...
	const styles = require_BaseUserProfile_styles.default(theme, colorScheme);
	...
	const renderSchemaField = (schema, isEditing, onEditValue, onStartEdit) => {
		...
		if (Array.isArray(value) || multiValued) {
			...
			if (isEditing && onEditValue && isEditable$1) {
				...
				return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
					...
					className: styles.value,
					children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(require_MultiInput.default, {
						values: fieldValues,
						onChange: (newValues) => {
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
				...
				children: !hasValues && isEditable$1 && onStartEdit ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)(require_Button.default, {
					onClick: onStartEdit,
					variant: "text",
					color: "secondary",
					size: "small",
		...
		if (isEditing && onEditValue && mutability !== "READ_ONLY" && !readonlyFields.includes(name || "")) {
			...
			switch (type) {
				case "STRING":
					field = /* @__PURE__ */ (0, react_jsx_runtime.jsx)(require_TextField.default, { ...commonProps });
					break;
				case "DATE_TIME":
					field = /* @__PURE__ */ (0, react_jsx_runtime.jsx)(require_DatePicker.default, { ...commonProps });
					break;
				case "BOOLEAN":
					field = /* @__PURE__ */ (0, react_jsx_runtime.jsx)(require_Checkbox.default, {
						...commonProps,
						checked: !!fieldValue,
						onChange: (e) => {
				...
				case "COMPLEX":
					...
					break;
				default: field = /* @__PURE__ */ (0, react_jsx_runtime.jsx)(require_TextField.default, { ...commonProps });
			}
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
				className: styles.label,
				children: label
		...
		return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
			...
			children: !hasValue && isEditable && onStartEdit ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)(require_Button.default, {
				onClick: onStartEdit,
				variant: "text",
				color: "secondary",
				size: "small",
		...
		return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
			...
			children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
				...
				children: [isFieldEditing && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)(require_Button.default, {
					...
					children: "Cancel"
				})] }), !isFieldEditing && hasValue && /* @__PURE__ */ (0, react_jsx_runtime.jsx)(require_Button.default, {
					size: "small",
					color: "tertiary",
					variant: "icon",
	...
	const renderProfileWithoutSchemas = () => {
		...
		const displayName = require_getDisplayName.default(mergedMappings, profile, displayNameAttributes);
		...
		return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [
			/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				...
				children: [
					/* @__PURE__ */ (0, react_jsx_runtime.jsx)(require_Avatar.Avatar, {
						imageUrl: require_getMappedUserProfileValue.default("picture", mergedMappings, currentUser),
						name: displayName,
						size: 70,
					...
					require_getMappedUserProfileValue.default("email", mergedMappings, currentUser) && /* @__PURE__ */ (0, react_jsx_runtime.jsx)(require_Typography.default, {
						variant: "body2",
						color: "textSecondary",
						children: require_getMappedUserProfileValue.default("email", mergedMappings, currentUser)
					})
				]
			}),
			/* @__PURE__ */ (0, react_jsx_runtime.jsx)(require_Divider.default, {}),
			...
			}), index < profileEntries.length - 1 && /* @__PURE__ */ (0, react_jsx_runtime.jsx)(require_Divider.default, {})] }, key))
		] });
	};
		...
		children: [
			...
			schemas && schemas.length > 0 && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
				...
				children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(require_Avatar.Avatar, {
					imageUrl: require_getMappedUserProfileValue.default("picture", mergedMappings, currentUser),
					name: require_getDisplayName.default(mergedMappings, profile),
					size: 80,
					alt: `${require_getDisplayName.default(mergedMappings, profile)}'s avatar`,
					isLoading
				})
			}),
			/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
	...
	if (mode === "popup") return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(require_Dialog.default, {
		open,
		onOpenChange,
		children: /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(require_Dialog.default.Content, { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)(require_Dialog.default.Heading, { children: title ?? t("user.profile.heading") }), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
...
//#endregion
exports.default = BaseUserProfile_default;
//# sourceMappingURL=BaseUserProfile.cjs.map
const require_resolveTranslationsInObject = require('./resolveTranslationsInObject.cjs');
...
const resolveTranslationsInArray = (items, t, properties, meta) => items.map((item) => {
	const resolved = require_resolveTranslationsInObject.resolveTranslationsInObject(item, t, properties, meta);
...
//#endregion
exports.default = resolveTranslationsInArray_default;
//# sourceMappingURL=resolveTranslationsInArray.cjs.map
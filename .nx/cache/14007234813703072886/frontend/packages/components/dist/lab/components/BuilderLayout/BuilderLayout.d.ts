 ...
 */
declare function BuilderLayout({ open, onPanelToggle, panelWidth, panelContent, expandTooltip, panelPaperSx, children, rightPanel, ...rest }: BuilderLayoutProps): ReactElement;
declare const _default: import("react").MemoExoticComponent<typeof BuilderLayout>;

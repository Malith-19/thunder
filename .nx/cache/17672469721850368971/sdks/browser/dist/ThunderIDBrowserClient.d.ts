 ...
 * under the License.
 */
import { ThunderIDJavaScriptClient, User, IsomorphicCrypto, IdToken, OIDCEndpoints, Storage, TokenResponse, HttpRequestConfig, HttpResponse } from '@thunderid/javascript';
...
declare class ThunderIDBrowserClient<T = BrowserAuthConfig> extends ThunderIDJavaScriptClient<T> {
    ...
    refreshAccessToken(userId?: string): Promise<User | TokenResponse>;
    revokeAccessToken(userId?: string): Promise<boolean | Response>;

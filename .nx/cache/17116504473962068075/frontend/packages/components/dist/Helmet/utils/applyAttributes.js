//#region src/Helmet/utils/applyAttributes.ts
/**
...
function applyAttributes(el, props) {
	for (const [key, value] of Object.entries(props)) {
		...
		} else if (typeof value === "string" || typeof value === "number" || typeof value === "bigint") el.setAttribute(attrName, String(value));
	}
}

//#endregion
export { applyAttributes as default };
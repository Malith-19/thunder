 ...
 * @public
 */
export default function DesignProvider({ children, design: externalDesign, shouldResolveDesignInternally, isLoading: isExternalLoading, }: DesignProviderProps): import("react/jsx-runtime").JSX.Element;

...
import { Alert, Box, Button, Chip, CircularProgress, FormControl, FormLabel, IconButton, InputAdornment, PageContent, PageTitle, Stack, Tab, Tabs, TextField, Tooltip, Typography } from "@wso2/oxygen-ui";
...
function UserEditPage() {
	...
	if (isUserLoading || isSchemaLoading) return /* @__PURE__ */ jsx(Box, {
		sx: {
			display: "flex",

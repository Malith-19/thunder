...
//#region ../configure-organization-units/dist/api/useGetOrganizationUnit.js
/**
...
function useGetOrganizationUnit(id, enabled = true) {
	...
	return (0, __tanstack_react_query.useQuery)({
		queryKey: [require_organization_unit_query_keys.organization_unit_query_keys_default.ORGANIZATION_UNIT, id],
		queryFn: async () => {
...
//#endregion
exports.useGetOrganizationUnit = useGetOrganizationUnit;
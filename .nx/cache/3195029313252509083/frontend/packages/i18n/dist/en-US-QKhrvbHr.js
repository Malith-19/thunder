...
const translations = {
	common: {
		...
		"welcome.mcpTryout.steps.installInspector.description": "Launch MCP Inspector locally — a browser-based reference UI for MCP servers with built-in OAuth support.",
		...
		"welcome.mcpTryout.scenarios.connect.step2": "Set Transport to Streamable HTTP and Server URL to http://localhost:8787/mcp.",
		"welcome.mcpTryout.scenarios.connect.step3": "Enable OAuth. Set Client ID to EXTERNAL-MCP-CLIENT and leave Client Secret blank (public client).",
		"welcome.mcpTryout.scenarios.connect.step4": "Click Connect. You are redirected to {{productName}} — sign in as john.doe / john.doe.",

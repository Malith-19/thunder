...
const translations = {
	common: {
		...
		"welcome.createProject.subtitle": "This wizard will guide you through minimal configuration for your project and generate the necessary configs to run {{productName}}.",
		"welcome.createProject.cards.configure.title": "Configure Project",
		"welcome.createProject.cards.configure.description": "Set up your project's authentication flows, choose sign-in methods, and customize the user experience.",
		"welcome.createProject.cards.verify.title": "Verify",
		"welcome.createProject.cards.verify.description": "Test your project configuration to ensure everything works as expected.",
		...
		"welcome.wayfinderSampleSetup.steps.getSample.description": "Download the latest Wayfinder sample distribution and extract the archive. It ships with the web frontend, AI agent service, and Wayfinder server.",
		...
		"welcome.consumerAppTryout.subtitle": "Run consumer app use cases against the Wayfinder sample, a fictional consumer travel-booking app.",
		"welcome.consumerAppTryout.steps.getSample.title": "Get the Wayfinder Sample",
		"welcome.consumerAppTryout.steps.getSample.description": "Download the latest Wayfinder sample distribution and extract the archive. It ships with the web frontend, AI agent service, and Wayfinder server.",
		...
		"welcome.consumerAppTryout.steps.importConfigs.description": "Apply the Wayfinder sample configurations to {{productName}}.",
		"welcome.consumerAppTryout.steps.runSample.title": "Run the Sample",
		"welcome.consumerAppTryout.steps.runSample.description": "Start all Wayfinder services from the extracted sample directory.",
		...
		"welcome.consumerAppTryout.steps.login.description": "Open the Wayfinder sample app and sign in with the demo credentials below.",
		...
		"welcome.consumerAppTryout.scenarios.login.description": "Sign in with the demo consumer account to explore the Wayfinder app.",
		...
		"welcome.consumerAppTryout.scenarios.signup.description": "Register a new customer account and see ThunderID assign the Traveler role automatically on completion.",
		...
		"welcome.consumerAppTryout.scenarios.signup.step4": "Submit. ThunderID creates a Customer user, records terms acceptance, and assigns the Traveler role.",
		"welcome.consumerAppTryout.scenarios.signup.step5": "The browser redirects back to Wayfinder with the new account authenticated.",
		"welcome.consumerAppTryout.scenarios.profile.description": "Explore the self-service profile page — view account details, edit attributes, and change your password.",
		"welcome.consumerAppTryout.scenarios.profile.step1": "Sign in as john.doe at <a>http://localhost:5173</a>.",
		"welcome.consumerAppTryout.scenarios.profile.step2": "Click the username in the top-right corner and select Profile.",
		"welcome.consumerAppTryout.scenarios.profile.step3": "View account details, edit profile attributes, or change your password. The page calls the identity provider directly with your session token.",
		"welcome.consumerAppTryout.scenarios.recovery.description": "Walk through the password recovery flow — John forgets his password and resets it via email.",
		"welcome.consumerAppTryout.scenarios.recovery.smtpNote": "Recovery emails require a configured SMTP server. Add your SMTP settings under email.smtp in {{productName}}'s deployment.yaml and restart the server before trying this flow.",
		...
		"welcome.consumerAppTryout.scenarios.recovery.step4": "ThunderID sends a recovery email to John's registered address.",
		...
		"welcome.consumerAppTryout.scenarios.onboard.description": "Invite and onboard a new staff member using the staff invitation flow. The invited user selects a role (Support or DestinationsAdmin) during onboarding.",
		"welcome.consumerAppTryout.scenarios.onboard.smtpNote": "Staff invitation emails require a configured SMTP server. Add your SMTP settings under email.smtp in {{productName}}'s deployment.yaml and restart the server before trying this flow.",
		"welcome.consumerAppTryout.scenarios.onboard.step1": "Sign in as alex.carter (OpsAdmin) at <a>http://localhost:5173</a> using the credentials below.",
		"welcome.consumerAppTryout.scenarios.onboard.step2": "Navigate to the staff management section and invite a new staff member by email.",
		"welcome.consumerAppTryout.scenarios.onboard.step3": "The invited user receives an onboarding email. They open the link and complete the onboarding flow, choosing between the Support and DestinationsAdmin roles.",
		"welcome.consumerAppTryout.scenarios.onboard.step4": "Once onboarded, the new staff member can sign in to the app with their chosen role permissions active.",
		...
		"welcome.aiAgentsTryout.steps.getSample.description": "Download the latest Wayfinder sample distribution and extract the archive. It ships with the Wayfinder web frontend, the AI Agent service, and the Wayfinder Server.",
		...
		"welcome.aiAgentsTryout.scenarios.protect.step1": "Open <a>http://localhost:5173</a> and sign in as john.doe / john.doe.",
		"welcome.aiAgentsTryout.scenarios.protect.step2": "Open the chat widget (bottom-right corner) and send any message. The concierge responds — John's token carries the agent:access scope.",
		"welcome.aiAgentsTryout.scenarios.protect.step3": "Sign out and sign in as jane.smith / jane.smith.",
		"welcome.aiAgentsTryout.scenarios.protect.step4": "Open the chat and send a message. The request is rejected with a 403 — Jane does not have the Wayfinder Chat User role.",
		...
		"welcome.aiAgentsTryout.scenarios.browse.description": "Watch the agent use its own machine-to-machine token to call read-only tools — no user consent popup required.",
		"welcome.aiAgentsTryout.scenarios.browse.step1": "Sign in as john.doe at <a>http://localhost:5173</a> and open the chat widget.",
		"welcome.aiAgentsTryout.scenarios.browse.step2": "Ask a browsing question, for example: \"What flights are there from Colombo to Singapore?\"",
		...
		"welcome.aiAgentsTryout.scenarios.browse.step4": "You can also try: \"Suggest a few flight deals.\" The agent calls the recommend_bookings tool, which requires the booking:recommend scope — granted to the Wayfinder Concierge via its Recommender role.",
		...
		"welcome.aiAgentsTryout.scenarios.book.step1": "Sign in as john.doe at <a>http://localhost:5173</a> and open the chat widget.",
		"welcome.aiAgentsTryout.scenarios.book.step2": "Ask the agent to book something, for example: \"Book flight 2\".",
		"welcome.aiAgentsTryout.scenarios.book.step3": "The agent returns a consent request. A popup opens — sign in as john.doe and select which booking permissions to grant (booking:read, booking:create, booking:cancel).",
		"welcome.aiAgentsTryout.scenarios.book.step4": "After approval the agent retries the action using a user-context token. The booking succeeds.",
		"welcome.aiAgentsTryout.scenarios.book.step5": "To see the rejection path, repeat the flow but deny booking:create in the consent screen. The agent returns a 403.",
		...
		"welcome.mcpTryout.scenarios.connect.step5": "At the consent screen select the booking permissions to grant (booking:read, booking:create, booking:cancel) and confirm.",
		...
		"welcome.mcpTryout.scenarios.permissions.step1": "In the Tools tab, call create_booking. Set type=flight, itemId=flight-cmb-sin-01, travelers=1. The call succeeds if you granted booking:create.",
		"welcome.mcpTryout.scenarios.permissions.step2": "Call delete_all_bookings. If booking:cancel was not granted you get: \"Insufficient scope for tool delete_all_bookings. Required: booking:cancel\".",

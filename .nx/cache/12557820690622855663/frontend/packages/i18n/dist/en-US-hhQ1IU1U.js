...
const translations = {
	common: {
		...
		"welcome.createProject.subtitle": "Onboard your digital resources, configure security, verify the setup, and run {{productName}} with your configuration in production deployment.",
		"welcome.createProject.cards.configure.title": "Configure",
		"welcome.createProject.cards.configure.description": "Set up authentication flows, choose sign-in methods, and customize the user experience.",
		...
		"welcome.createProject.cards.runServer.description": "{{productName}} will run in immutable mode with the attached configurations.",
		...
		"welcome.wayfinderSampleSetup.steps.getSample.description": "Download the latest Wayfinder sample distribution and extract the archive. It ships with the <strong>web frontend</strong>, <strong>AI agent service</strong>, <strong>MCP</strong>, <strong>SMTP mail server</strong> and <strong>Wayfinder server</strong>.",
		"welcome.wayfinderSampleSetup.steps.configure.title": "Configure Wayfinder Sample in {{productName}}",
		"welcome.wayfinderSampleSetup.steps.configure.description": "Apply the Wayfinder sample configurations to {{productName}}. Skip this step if already done.",
		"welcome.wayfinderSampleSetup.steps.run.title": "Run the Sample",
		"welcome.wayfinderSampleSetup.steps.run.description": "Start all Wayfinder services from the extracted sample directory.",
		...
		"welcome.getStarted.options.onboardApp.description": "Register your application in {{productName}} and integrate authentication step by step.",
		...
		"welcome.getStarted.options.secureAiAgent.description": "Protect your AI agents with token-based access control and scope enforcement.",
		"welcome.getStarted.options.secureMcp.title": "Secure MCP Server / Client",
		"welcome.getStarted.options.secureMcp.description": "Authorize MCP clients to access your MCP server with fine-grained permissions.",
		"welcome.getStarted.options.comingSoon": "Coming Soon",
		"welcome.getStarted.options.skip.title": "Skip for now",
		"welcome.getStarted.options.skip.description": "Head straight to the console and explore {{productName}} on your own.",
		...
		"welcome.applicationTryout.subtitle": "Run web application use cases against the Wayfinder sample, a fictional travel-booking application.",
		"welcome.applicationTryout.steps.getSample.title": "Get the Wayfinder Sample",
		"welcome.applicationTryout.steps.getSample.description": "Download the latest Wayfinder sample distribution and extract the archive. It ships with the web frontend, AI agent service, MCP, SMTP mail server and Wayfinder server.",
		...
		"welcome.applicationTryout.steps.importConfigs.description": "Apply the Wayfinder sample configurations to {{productName}}.",
		"welcome.applicationTryout.steps.runSample.title": "Run the Sample",
		"welcome.applicationTryout.steps.runSample.description": "Start all Wayfinder services from the extracted sample directory.",
		...
		"welcome.applicationTryout.steps.login.description": "Open the Wayfinder sample app and sign in with the demo credentials below.",
		...
		"welcome.applicationTryout.scenarios.login.description": "Sign in with the test user account to explore {{productName}} Sign in experience.",
		...
		"welcome.applicationTryout.scenarios.signup.description": "Register a new customer account and see {{productName}} assign the Traveler role automatically on completion.",
		...
		"welcome.applicationTryout.scenarios.signup.step4": "Fill in the registration form using these sample details and click Submit.",
		"welcome.applicationTryout.scenarios.signup.step5": "{{productName}} will create a Customer user and assign the Traveler role. The browser shows a confirmation screen with a link to redirect back to the Wayfinder app.",
		"welcome.applicationTryout.scenarios.profile.description": "Explore the self-service profile page - view account details, edit attributes, and change your password.",
		"welcome.applicationTryout.scenarios.profile.step1": "Sign in as John at <a>http://localhost:5173</a>.",
		"welcome.applicationTryout.scenarios.profile.step2": "Click the username in the top-right corner and select Profile.",
		"welcome.applicationTryout.scenarios.profile.step3": "View account details, edit profile attributes, or change your password. The page calls {{productName}} directly with your session token.",
		"welcome.applicationTryout.scenarios.recovery.description": "Walk through the password recovery flow - John forgets his password and resets it via email.",
		...
		"welcome.applicationTryout.scenarios.recovery.step4": "{{productName}} sends a recovery email to John's registered address. Open it from the inbox at <mail>http://localhost:8788</mail>.",
		...
		"welcome.applicationTryout.scenarios.onboard.step4": "Pick Support as the role, enter Sam Rivera's email (sam.rivera@example.com), and click Send invitation. An invite link is emailed to Sam.",
		"welcome.applicationTryout.scenarios.onboard.step5": "Open Sam's invitation email from the inbox at <mail>http://localhost:8788</mail> and open the link. The browser opens a Complete Your Profile page.",
		"welcome.applicationTryout.scenarios.onboard.step6": "Fill in the additional attributes and submit. Sam's account is now active with the Support role attached.",
		"welcome.applicationTryout.scenarios.onboard.step7": "Repeat the flow for Maya Patel (email maya.patel@example.com), picking DestinationsAdmin as the role.",
		"welcome.aiAgentsTryout.breadcrumb": "Tryout Secured AI Agent",
		"welcome.aiAgentsTryout.overline": "Secured AI Agent",
		"welcome.aiAgentsTryout.subtitle": "Run AI agent use cases against the Wayfinder sample, a travel-booking app with a built-in AI chat assistant.",
		"welcome.aiAgentsTryout.steps.getSample.title": "Get the Wayfinder Sample",
		"welcome.aiAgentsTryout.steps.getSample.description": "Download the latest Wayfinder sample distribution and extract the archive. It ships with the web frontend, AI agent service, MCP, SMTP mail server and Wayfinder server.",
		"welcome.aiAgentsTryout.steps.importConfigs.title": "Configure Wayfinder Sample in {{productName}}",
		"welcome.aiAgentsTryout.steps.importConfigs.description": "Apply the Wayfinder sample configurations to {{productName}}.",
		"welcome.aiAgentsTryout.steps.configureSample.title": "Configure the AI Provider Details in Wayfinder Sample",
		"welcome.aiAgentsTryout.steps.configureSample.description": "Copy each .env.example to .env in backend/, ai-agent/, and frontend/. Fill in your LLM API key in ai-agent/.env — an Anthropic key from console.anthropic.com or a Gemini key from aistudio.google.com.",
		"welcome.aiAgentsTryout.steps.runSample.title": "Run the Sample",
		"welcome.aiAgentsTryout.steps.runSample.description": "Start all Wayfinder services from the extracted sample directory.",
		"welcome.aiAgentsTryout.steps.login.title": "Sign-In to the App",
		"welcome.aiAgentsTryout.steps.login.description": "Open the Wayfinder sample app and sign in with the demo credentials below.",
		"welcome.aiAgentsTryout.apiKeySetup.getKey.title": "Get an LLM API key",
		"welcome.aiAgentsTryout.apiKeySetup.getKey.description": "The AI agent needs access to an LLM. Obtain a free API key from one of the providers below.",
		"welcome.aiAgentsTryout.apiKeySetup.setKey.title": "Add the key to ai-agent/.env",
		"welcome.aiAgentsTryout.apiKeySetup.setKey.description": "Open ai-agent/.env and set the key for the provider you chose.",
		"welcome.aiAgentsTryout.scenarios.title": "Try the following AI agents security patterns",
		"welcome.aiAgentsTryout.scenarios.apiKeyNote": "The AI agent requires an LLM API key. Edit ai-agent/.env in the sample directory and set ANTHROPIC_API_KEY or GOOGLE_API_KEY before starting the services.",
		...
		"welcome.aiAgentsTryout.scenarios.protect.description": "See scope-based access control in action - John can use the AI concierge, but Jane cannot.",
		"welcome.aiAgentsTryout.scenarios.protect.step1": "Open <a>http://localhost:5173</a> and sign in as John Doe.",
		"welcome.aiAgentsTryout.scenarios.protect.step2": "Open the chat widget (bottom-right corner) and send any message. The concierge responds — John's token carries the <code>agent:access</code> scope.",
		"welcome.aiAgentsTryout.scenarios.protect.step3": "Sign out and sign in as Jane Smith.",
		"welcome.aiAgentsTryout.scenarios.protect.step4": "Open the chat. Since Jane does not have the Wayfinder Chat User role. Chat agent will not be accessible and the widget will show an error message instead.",
		...
		"welcome.aiAgentsTryout.scenarios.browse.description": "Watch the agent use its own Machine-to-Machine (M2M) token to call read-only tools - no user consent popup required.",
		"welcome.aiAgentsTryout.scenarios.browse.step1": "Sign in as John at <a>http://localhost:5173</a> and open the chat widget.",
		"welcome.aiAgentsTryout.scenarios.browse.step2": "Ask a browsing question in the chat:",
		"welcome.aiAgentsTryout.scenarios.browse.step3": "The agent calls the Wayfinder MCP server with its own M2M token (client_credentials grant). No popup appears.",
		"welcome.aiAgentsTryout.scenarios.browse.step4": "You can also try asking for flight deals — the agent calls the recommend_bookings tool, which requires the <code>booking:recommend</code> scope — granted to the Wayfinder Concierge via its Recommender role.",
		"welcome.aiAgentsTryout.scenarios.browse.step4Prompt": "Suggest a few flight deals.",
		"welcome.aiAgentsTryout.scenarios.book.description": "Trigger the on-behalf-of consent flow - the agent pauses, asks for your permission, and only proceeds after you approve.",
		"welcome.aiAgentsTryout.scenarios.book.step1": "Sign in as John at <a>http://localhost:5173</a> and open the chat widget.",
		...
		"welcome.aiAgentsTryout.scenarios.book.step3": "The agent returns a consent request. A popup opens - sign in as John and select which booking permissions to grant (<code>booking:read</code>, <code>booking:create</code>, <code>booking:cancel</code>).",
		"welcome.aiAgentsTryout.scenarios.book.step4": "Click Authorize. The agent will retries the action using a user's context token. And you should see the booking confirmation in the chat window shortly after.",
		"welcome.aiAgentsTryout.scenarios.book.step5": "To see the rejection path, repeat the flow but deny <code>booking:create</code> in the consent screen. The agent returns a 403.",
		"welcome.mcpTryout.breadcrumb": "Tryout Secured MCP Server",
		"welcome.mcpTryout.overline": "Secured MCP Server",
		"welcome.mcpTryout.subtitle": "Connect an external MCP client to the Wayfinder MCP server, signed in through {{productName}}.",
		"welcome.mcpTryout.steps.prerequisite.title": "Complete AI Agents Setup",
		"welcome.mcpTryout.steps.prerequisite.description": "This tryout extends the AI Agents environment. Complete the Securing AI Agents tryout setup first — the same bundle seeds the EXTERNAL-MCP-CLIENT application used here.",
		"welcome.mcpTryout.steps.importConfigs.title": "Configure Wayfinder Sample in {{productName}}",
		"welcome.mcpTryout.steps.importConfigs.description": "Apply the Wayfinder sample configurations to {{productName}}.",
		"welcome.mcpTryout.steps.verifyApp.title": "Verify the Application",
		"welcome.mcpTryout.steps.verifyApp.description": "In the {{productName}} Console, open Applications and confirm EXTERNAL-MCP-CLIENT is listed.",
		...
		"welcome.mcpTryout.steps.installInspector.description": "Launch MCP Inspector locally — a browser-based reference UI for MCP servers with built-in OAuth support. Open a new terminal in the sample app directory and run:",
		"welcome.mcpTryout.steps.allowCors.title": "Allow Inspector in CORS",
		"welcome.mcpTryout.steps.allowCors.description": "Add Inspector's origin to {{productName}}'s CORS allow-list in repository/conf/deployment.yaml, then restart {{productName}}.",
		...
		"welcome.mcpTryout.scenarios.connect.description": "Point MCP Inspector at the Wayfinder MCP server, authenticate through {{productName}}, and grant booking permissions at the consent screen.",
		"welcome.mcpTryout.scenarios.connect.step1": "Open <a>http://localhost:6274</a> in your browser (Inspector should already be running from the setup step above).",
		...
		"welcome.mcpTryout.scenarios.connect.step4": "Click Connect. You are redirected to {{productName}} Sign in page — Sign in as John.",
		"welcome.mcpTryout.scenarios.connect.step5": "At the consent screen select the booking permissions to grant (<code>booking:read</code>, <code>booking:create</code>, <code>booking:cancel</code>) and confirm.",
		...
		"welcome.mcpTryout.scenarios.permissions.description": "Call MCP tools and observe how {{productName}} enforces the scopes you granted at consent. Reconnect with different permissions to see the difference.",
		"welcome.mcpTryout.scenarios.permissions.step0": "At the consent screen select the booking permissions to grant (<code>booking:read</code>, <code>booking:create</code>, <code>booking:cancel</code>) and confirm.",
		"welcome.mcpTryout.scenarios.permissions.step1": "In the Tools tab, call create_booking. Set type=flight, itemId=flight-cmb-sin-01, travelers=1. The call succeeds if you granted <code>booking:create</code>.",
		"welcome.mcpTryout.scenarios.permissions.step2": "Call delete_all_bookings. If <code>booking:cancel</code> was not granted you get: \"Insufficient scope for tool delete_all_bookings. Required: <code>booking:cancel</code>\".",
		"welcome.mcpTryout.scenarios.permissions.step3": "To narrow or expand permissions, disconnect from Inspector and reconnect.",
		"welcome.mcpTryout.scenarios.permissions.step4": "Re-authenticate as john.doe and toggle different scopes at the consent screen, then retry the previously denied tool call — it now succeeds.",
		"welcome.setupComplete.breadcrumb": "Complete",
		"welcome.setupComplete.title": "You're all set!",
		"welcome.setupComplete.subtitle": "The essential configuration is done. Start exploring the designer, build your project, onboard applications, and export the config when ready to run {{productName}}.",
		...
		"welcome.setupComplete.nextSteps.onboardApp.description": "Register your first application to start integrating sign-in and identity flows.",
		...
		"welcome.setupComplete.nextSteps.exportConfig.description": "Export your {{productName}} configuration to deploy and run {{productName}}.",
		...
		"dataTable.toolbarFiltersTooltipActive": (count) => count !== 1 ? `${count} active filters` : `${count} active filter`,
		...
		"dataTable.columnHeaderFiltersTooltipActive": (count) => count !== 1 ? `${count} active filters` : `${count} active filter`,
		"dataTable.columnHeaderFiltersLabel": "Show filters",
		"dataTable.columnHeaderSortIconLabel": "Sort",
		"dataTable.footerRowSelected": (count) => count !== 1 ? `${count.toLocaleString()} rows selected` : `${count.toLocaleString()} row selected`,
		"dataTable.footerTotalRows": "Total Rows:",
		"dataTable.footerTotalVisibleRows": (visibleCount, totalCount) => `${visibleCount.toLocaleString()} of ${totalCount.toLocaleString()}`,
		...
		"dataTable.groupColumn": (name) => `Group by ${name}`,
		"dataTable.unGroupColumn": (name) => `Stop grouping by ${name}`,
		...
		"dataTable.paginationDisplayedRows": ({ from, to, count }) => `${from}–${to} of ${count !== -1 ? count : `more than ${to}`}`,
	...
	users: {
		...
		"createWizard.errors.noOuAccess": "You do not have permission to access the organization units for the selected user type, and no organization unit could be resolved.",
	...
	userTypes: {
		...
		"removeCredentialDialog.description": "Removing the credential flag will cause this field to no longer be hashed or protected. Existing hashed values may become inaccessible. Are you sure you want to proceed?",
	...
	agentTypes: {
		...
		"edit.general.dangerZone.deleteAgentTypeDescription": "Permanently delete this agent type and all associated schema definitions. This action cannot be undone.",
	...
	agents: {
		...
		"clientSecret.securityReminder.description": "Store the client secret somewhere safe. If you lose it, you will need to regenerate it from the agent settings.",
		...
		"regenerateSecret.dialog.message": "A new client secret will be generated for this agent. Any service using the current client secret will stop working immediately.",
		"regenerateSecret.dialog.disclaimer": "This action cannot be undone. The current client secret will be invalidated as soon as you confirm.",
		...
		"regenerateSecret.success.subtitle": "Copy your new client secret and store it somewhere safe. It won't be shown again.",
		...
		"regenerateSecret.success.securityReminder.description": "Store the new client secret somewhere safe. If you lose it, you'll need to regenerate it again.",
		...
		"edit.general.dangerZone.deleteAgent.description": "Permanently delete this agent and all associated data. This action cannot be undone.",
		"edit.general.dangerZone.deleteAgent.button": "Delete Agent",
		"edit.flows.allowedUserTypes.title": "Allowed User Types",
		"edit.flows.allowedUserTypes.description": "Restrict which user types can authenticate or register through this agent.",
		...
		"edit.advanced.redirectUris.required": "At least one valid redirect URI is required for the authorization code grant.",
	...
	organizationUnits: {
		...
		"edit.general.sections.dangerZone.deleteOU.description": "Deleting this organization unit is permanent and cannot be undone.",
		...
		"edit.general.dangerZone.delete.message": "Are you sure you want to delete this organization unit? This action cannot be undone.",
	...
	roles: {
		...
		"createWizard.permissions.subtitle": "Choose what this role grants. You can skip this step and add permissions later.",
		...
		"edit.permissions.scopes.description": "The OAuth scopes granted by these permissions. Copy them for use in your application.",
	...
	applications: {
		...
		"regenerateSecret.dialog.title": "Regenerate Client Secret",
		"regenerateSecret.dialog.message": "Are you sure you want to regenerate the client secret for this application? This will immediately invalidate the current client secret and generate a new one.",
		"regenerateSecret.dialog.disclaimer": "Warning: Regenerating the client secret will invalidate the current secret and the application may stop working until the new client secret is updated in its configuration.",
		"regenerateSecret.dialog.confirmButton": "Regenerate",
		"regenerateSecret.dialog.regenerating": "Regenerating...",
		...
		"regenerateSecret.success.securityReminder.description": "Never share your client secret publicly or store it in version control. If you believe your secret has been compromised, regenerate it immediately.",
		"regenerateAppSecret.dialog.title": "Regenerate App Secret",
		"regenerateAppSecret.dialog.message": "Are you sure you want to regenerate the App Secret for this application? This will immediately invalidate the current App Secret and generate a new one.",
		"regenerateAppSecret.dialog.disclaimer": "Warning: Regenerating the App Secret invalidates the current secret. Server-side flow initiation will fail until the new App Secret is deployed.",
		...
		"regenerateAppSecret.success.subtitle": "This is the only time you'll see this App Secret. Store it somewhere safe.",
		...
		"regenerateAppSecret.success.securityReminder.description": "Never share your App Secret publicly or store it in version control. If you believe your App Secret has been compromised, regenerate it immediately.",
		...
		"onboarding.configure.SignInOptions.noSelectionWarning": "At least one sign-in option is required. Please select at least one authentication method.",
		"onboarding.configure.SignInOptions.noIntegrations": "No social sign-in integrations available. Please configure an integration first.",
		"onboarding.configure.SignInOptions.hint": "You can always change these settings later in the application settings.",
		...
		"onboarding.configure.approach.inbuilt.description": "Users will be redirected to system-hosted sign-in and sign-up pages, which can be customized and branded using the Flow Designer and easily integrated with SDKs in just a few steps.",
		"onboarding.configure.approach.native.title": "Embedded sign-in/sign-up components in your app",
		"onboarding.configure.approach.native.description": "Users will sign in or sign up through your app using the UI components or APIs provided by {{product}}. You can customize and brand the flows using the designer or through code.",
		...
		"onboarding.configure.stack.platform.custom.description": "Fully customizable application with all configuration options available",
		...
		"onboarding.configure.details.wallet.clientId.helperText": "Leave empty to auto-generate. Known wallets pre-fill their fixed client ID.",
		...
		"onboarding.configure.details.hostingUrl.error.invalid": "Please enter a valid URL (must start with http:// or https://)",
		...
		"onboarding.configure.details.callbackUrl.error.invalid": "Please enter a valid URL (must start with http:// or https://)",
		"onboarding.configure.details.callbackUrl.info": "The URL is where users will be redirected after sign-in. For most applications, using the same URL as your application access URL is recommended.",
		...
		"onboarding.configure.details.mobile.description": "Configure the deep link or universal link for your mobile application",
		"onboarding.configure.details.mobile.info": "Deep links (e.g., myapp://callback) or universal links (e.g., https://example.com/callback) are used to redirect users back to your mobile app after authentication.",
		...
		"onboarding.configure.details.noConfigRequired.description": "Your application is ready to go! You can proceed to the next step.",
		...
		"onboarding.configure.setup.info": "Your {{platform}} configuration is set up automatically. You can customize these settings later.",
		...
		"onboarding.configure.oauth.hostedGuidance": "OAuth configuration is recommended for redirect-based authentication. Configure OAuth settings to enable secure authentication flows.",
		"onboarding.configure.oauth.nativeGuidance": "OAuth configuration is optional for custom sign-in UI. You can skip this step and use the Flow API for authentication instead.",
		...
		"onboarding.configure.oauth.errors.publicClientRequiresPKCE": "Public clients must have PKCE enabled. PKCE is automatically enabled for public clients.",
		"onboarding.configure.oauth.errors.publicClientRequiresNone": "Public clients must use \"None\" as the token endpoint authentication method.",
		"onboarding.configure.oauth.errors.publicClientNoClientCredentials": "Public clients cannot use the client_credentials grant type.",
		"onboarding.configure.oauth.errors.authorizationCodeRequiresRedirectURIs": "Authorization Code grant type requires at least one redirect URI.",
		"onboarding.configure.oauth.errors.clientCredentialsRequiresAuth": "Client Credentials grant type cannot use \"None\" authentication method.",
		"onboarding.configure.oauth.errors.atLeastOneGrantTypeRequired": "At least one grant type must be selected.",
		"onboarding.configure.oauth.errors.refreshTokenRequiresAuthorizationCode": "Refresh Token grant type requires Authorization Code grant type to be selected.",
		"onboarding.complete.title": "Application Created Successfully",
		"onboarding.complete.description": "Your application has been created. Please save the client secret below as it will only be shown once.",
		"onboarding.complete.warning.title": "Important: Save Your Client Secret",
		"onboarding.complete.warning.message": "This is the only time you will see this client secret. Please copy it now and store it securely. You will not be able to retrieve it later.",
		...
		"setupComplete.securityNote": "Your client secret was shown on the previous screen. Store it securely — it cannot be retrieved again.",
		...
		"clientSecret.warning": "Make sure to copy your client secret now. You won't be able to see it again for security reasons.",
		"clientSecret.clientIdLabel": "Client ID",
		"clientSecret.clientSecretLabel": "Client Secret",
		...
		"clientSecret.securityReminder.description": "Your client secret is a confidential key used to authenticate your application. It should be treated with the same level of security as a password. Never expose it in browser console, version control, or logs.",
		"appSecret.label": "App Secret",
		"appSecret.purpose": "Used to authenticate your server when it starts a sign-in flow directly via the Flow Execution API.",
		...
		"view.values.yes": "Yes",
		"view.values.no": "No",
		"edit.customization.tosUri.hint": "URL to your application's Terms of Service. May be displayed to users during consent or user sign-in, sign-up or recovery flows.",
		"edit.customization.policyUri.hint": "URL to your application's Privacy Policy. May be displayed to users during consent or user sign-in, sign-up or recovery flows.",
		"edit.advanced.oauth2Config.intro": "Configure OAuth 2.0 settings for this {{entity}}.",
		"edit.advanced.redirectUris.hint": "Allowed callback URLs where users will be redirected after authentication. Must be exact matches for security.",
		"edit.advanced.grantTypes.placeholder": "Select grant types",
		"edit.advanced.grantTypes.hint": "OAuth 2.0 flows this {{entity}} can use (e.g., authorization_code, client_credentials, refresh_token).",
		"edit.advanced.responseTypes.placeholder": "Select response types",
		"edit.advanced.publicClient.public": "This is a public client (SPA, mobile app) that cannot securely store credentials.",
		"edit.advanced.publicClient.confidential": "This is a confidential client (server-side app) that can securely store credentials.",
		...
		"edit.advanced.publicClient.requiresAuthorizationCode": "Available only for clients using the authorization code flow.",
		...
		"edit.advanced.tokenEndpointAuthMethod.hint": "Defines how the client authenticates at the token endpoint. Use client_secret_basic or client_secret_post for confidential clients, and none for public clients.",
		...
		"edit.general.sections.dangerZone.regenerateSecret.description": "Regenerating the client secret will immediately invalidate the current client secret and cannot be undone.",
		...
		"edit.general.sections.dangerZone.regenerateAppSecret.description": "Regenerating the App Secret immediately invalidates the current one. Server-side flow initiation will fail until the new secret is deployed.",
		...
		"edit.general.sections.dangerZone.deleteApplication.description": "Permanently delete this application and all associated data. This action cannot be undone.",
		...
		"edit.flows.authFlow.alert": "To modify the selected flow, <0>open the flow builder</0>. To create a new flow, visit the <1>Flows page</1>.",
		...
		"edit.flows.registrationFlow.alert": "To modify the selected flow, <0>open the flow builder</0>. To create a new flow, visit the <1>Flows page</1>.",
		...
		"edit.flows.recoveryFlow.alert": "To modify the selected flow, <0>open the flow builder</0>. To create a new flow, visit the <1>Flows page</1>.",
		...
		"edit.customization.theme.placeholder": "Select a Theme",
		"edit.customization.theme.hint": "Choose a theme to customize authentication pages. Select the Default Theme (shared across all applications) or pick an app-specific theme.",
		...
		"edit.token.token_profile_card.description": "Configure the response types and user attributes included in your tokens and user info responses",
		...
		"edit.token.scope_mapper.hint": "Select a scope to configure which user attributes are exposed when it is requested.",
		...
		"edit.advanced.acrValues.hint": "When acr_values is included in the authorization request, only values configured here are accepted.",
	...
	importExport: {
		...
		"upload.errors.unknownResourceType": "Unknown resource type: \"{{resourceType}}\". Allowed types are: {{allowedTypes}}",
		...
		"envViewer.placeholderWarning": "Some environment variables contain placeholder values. Edit them below before importing.",
		...
		"configureExport.runProduct.subtitle": "Use the following command to start {{productName}} with your configuration:",
		...
		"summary.env.editInfo": "You can edit the environment variables below to fix missing or placeholder values. The validation will update automatically.",
		...
		"summary.precheck.readyAllEnvAvailable": "Ready to proceed. All {{count}} referenced environment values are available.",
		"summary.precheck.missingEnvValues": "{{count}} environment value(s) are missing. Add them before importing.",
		"summary.precheck.availableEnvValues": "{{resolved}} of {{total}} referenced environment values are already available.",
		...
		"summary.import.tooltip.missingVariables": "Cannot import: {{count}} environment variable is missing. Edit the environment variables above to fix.",
		"summary.import.tooltip.missingVariables_plural": "Cannot import: {{count}} environment variables are missing. Edit the environment variables above to fix.",
		"summary.import.tooltip.configUnavailable": "Cannot import: configuration content is unavailable. Re-upload the configuration file.",
	...
	validations: { "form.field.required": "{{field}} is required." },
	flows: {
		"listing.title": "Flows",
		...
		"core.executions.identifying.description": "Configure the identifying executor mode. Use \"Resolve\" to enable user disambiguation when multiple users match.",
		...
		"core.executions.passkey.relyingPartyId.hint": "The domain identifier for passkey registration (typically your domain name)",
		...
		"core.executions.openid4vp.description": "Select the presentation definition this executor requests from the wallet.",
		"core.executions.openid4vp.allowAuthenticationWithoutLocalUser.label": "Allow authentication without a local user",
		"core.executions.openid4vp.allowAuthenticationWithoutLocalUser.hint": "When enabled, a holder with no matching local user is provisioned just-in-time. When disabled, login requires an existing matching user.",
		...
		"core.executions.permissionValidator.requiredScopes.hint": "Comma-separated list of scopes. The user must have at least one of these scopes.",
		"core.executions.federation.connection.description": "Select a connection from the following list to link it with the login flow.",
		...
		"core.executions.federation.connection.noConnections": "No connections available. Please create a connection to link with the login flow.",
		"core.executions.federation.allowAuthenticationWithoutLocalUser.label": "Allow Authentication Without Local User",
		"core.executions.federation.allowAuthenticationWithoutLocalUser.hint": "Allow users to authenticate even when no matching local user exists.",
		"core.executions.federation.allowRegistrationWithExistingUser.label": "Allow Registration With Existing User",
		"core.executions.federation.allowRegistrationWithExistingUser.hint": "Allow existing users to proceed through registration flows.",
		"core.executions.federation.allowCrossOUProvisioning.label": "Allow Cross-OU Provisioning",
		"core.executions.federation.allowCrossOUProvisioning.hint": "Allow creating a user in a different organizational unit.",
		...
		"core.executions.provisioning.includeOptional.hint": "Prompt for optional non-credential attributes during dynamic input collection.",
		"core.executions.provisioning.includeOptionalCredentials.label": "Include Optional Credentials",
		"core.executions.provisioning.includeOptionalCredentials.hint": "Prompt for optional credential attributes during dynamic input collection.",
		"core.executions.provisioning.maxPerPrompt.label": "Max Per Prompt",
		"core.executions.provisioning.maxPerPrompt.placeholder": "0",
		"core.executions.provisioning.maxPerPrompt.hint": "Number of dynamic inputs to show per prompt when connected to this provisioning executor.",
		...
		"core.executions.userTypeResolver.allowedUserTypes.hint": "Comma-separated list of allowed user type names to filter available types.",
		...
		"core.validation.fields.input.general": "Required fields are not properly configured for the input field with ID <code>{{id}}</code>.",
		...
		"core.validation.fields.button.general": "Required fields are not properly configured for the button with ID <code>{{id}}</code>.",
		...
		"core.validation.fields.checkbox.general": "Required fields are not properly configured for the checkbox with ID <code>{{id}}</code>.",
		"core.validation.fields.checkbox.label": "Label is required",
		"core.validation.fields.checkbox.ref": "Attribute is required",
		"core.validation.fields.divider.general": "Required fields are not properly configured for the divider with ID <code>{{id}}</code>.",
		"core.validation.fields.divider.variant": "Variant is required",
		"core.validation.fields.typography.general": "Required fields are not properly configured for the typography with ID <code>{{id}}</code>.",
		...
		"core.validation.fields.image.general": "Required fields are not properly configured for the image with ID <code>{{id}}</code>.",
		...
		"core.validation.fields.richText.general": "Required fields are not properly configured for the rich text with ID <code>{{id}}</code>.",
		...
		"core.validation.fields.form.noSubmitButton": "Form <code>{{id}}</code> has input fields but no submit button. Add a button with type \"Submit\" so that users can submit the form.",
		...
		"core.elements.textPropertyField.i18nCard.commonKeyWarning": "This is a common key shared across screens. Changes will affect all usages.",
		...
		"core.elements.textPropertyField.i18nCard.invalidKeyFormat": "Invalid key format. Use only letters, numbers, dots, underscores, and hyphens.",
		"core.dialogs.formRequiresView.formOnCanvas.title": "Form Requires a View",
		"core.dialogs.formRequiresView.formOnCanvas.description": "Form components cannot be placed directly on the canvas. They must be inside a View component.",
		...
		"core.dialogs.formRequiresView.inputOnCanvas.description": "Input components cannot be placed directly on the canvas. They must be inside a Form, which must be inside a View.",
		"core.dialogs.formRequiresView.inputOnCanvas.alertMessage": "Would you like to create a View with a Form and add the Input inside it?",
		...
		"core.dialogs.formRequiresView.inputOnView.description": "Input components cannot be placed directly inside a View. They must be inside a Form component.",
		...
		"core.dialogs.formRequiresView.widgetOnCanvas.description": "Widgets cannot be placed directly on the canvas. They must be inside a View component.",
		"core.dialogs.formRequiresView.widgetOnCanvas.alertMessage": "Would you like to create a View and add the Widget inside it?",
	...
	translations: {
		...
		"language.create.country.helperText": "Country name will be used to derive a BCP 47 compliant locale code for the language.",
		...
		"language.create.language.helperText": "Language picked here together with the country selection will determine the BCP 47 compliant locale code.",
		"language.create.localeCode.title": "Review Locale Code",
		"language.create.localeCode.subtitle": "The locale code was derived from your selection. Override it here if you need a different tag.",
		...
		"language.create.initialize.copyFromEnglish.description": "All keys will be pre-filled with English (en-US) text as a starting point. You can edit them afterwards.",
		"language.create.initialize.startEmpty.label": "Start empty",
		"language.create.initialize.startEmpty.description": "All keys will be created with empty values. Useful when you have your own translations ready to paste in.",
		...
		"language.add.code.helperText": "If you are manually modifying the generated code, use BCP 47 format (e.g. fr-FR for French, de-DE for German, etc.).",
		...
		"editor.namespace.helperText": "A namespace typically represents a page or a section within a page. It helps group and organize related translation keys for better structure and maintainability.",
	...
	design: {
		...
		"themes.forms.settings.fields.default_color_scheme.helper_text": "Select whether you want a light, dark or system color scheme as the default.",
		"themes.forms.settings.fields.default_text_direction.label": "Default Text Direction",
		"themes.forms.settings.fields.default_text_direction.helper_text": "Select the default text direction for your theme. This will affect the layout and alignment of components.",
		...
		"layouts.config.custom_css.fields.url.warnings.insecure_protocol": "Using HTTP is insecure. Consider using HTTPS instead.",
		...
		"layouts.config.custom_css.empty_state.description": "Add an inline stylesheet or link an external CSS file to customize the appearance.",
	...
	home: {
		...
		"next_steps.login_box.description": "Build themes and attach them to your applications to personalise the sign-in experience.",
		"next_steps.login_box.actions.primary.label": "Open Design Studio",
		"next_steps.social_login.title": "Social Integrations",
		"next_steps.social_login.description": "Let users sign in with their favourite identity providers — Google, GitHub, and more.",
	...
	resourceServers: {
		...
		"create.name.handleHint": "The handle prefixes every permission in this resource server. It cannot be changed after creation.",
		"create.separator.title": "Choose your permission delimiter",
		"create.separator.subtitle": "The delimiter character joins parts of a permission string. This cannot be changed after creation.",
		...
		"edit.advanced.identifier.hint": "A unique value that identifies this resource server. When set as an URI,enables RFC 8707 resource indicator support in OAuth2 authorization requests.",
	...
	"verifiable-presentations": {
		...
		"verify.notConfigured": "Presentation verification is not enabled. Configure a verifier signing key to start verification requests.",
		...
		"form.dangerZone.deleteDescription": "Permanently delete this presentation definition. This action cannot be undone.",
		...
		"form.issuerTrust.enforce.noAnchorsHint": "No trust anchors are configured, so issuer trust cannot be enforced. Configure trust anchors first.",
		...
		"claims.valuesHint": "If set, the disclosed value must match one of these (compared as text). Enforced at verification.",
	...
	"verifiable-credentials": {
		...
		"offer.notConfigured": "Credential issuance is not enabled. Configure an issuer signing key to generate credential offers.",
...
var en_US_default = translations;

//#endregion
Object.defineProperty(exports, 'en_US_default', {
  enumerable: true,
  get: function () {

 ...
 */
export default function EditGeneralSettings({ userType, editedOuId, editedAllowSelfRegistration, editedDisplayAttribute, onFieldChange, onDeleteClick, eligibleDisplayProperties, }: EditGeneralSettingsProps): JSX.Element;

 ...
 * @public
 */
export default function ConfigureGeneral({ ouId, onOuIdChange, allowSelfRegistration, onAllowSelfRegistrationChange, onReadyChange, }: ConfigureGeneralProps): JSX.Element;

 ...
 */
declare const renderSchemaField: <T extends Record<string, unknown>>(fieldName: string, fieldDef: PropertyDefinition, control: Control<T>, errors: FieldErrors<T>, resolveDisplayName?: (displayName: string) => string) => import("react/jsx-runtime").JSX.Element | null;

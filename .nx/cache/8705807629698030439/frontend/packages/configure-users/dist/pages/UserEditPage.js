...
function UserEditPage() {
	...
	return /* @__PURE__ */ jsxs(PageContent, { children: [
		user.isReadOnly && /* @__PURE__ */ jsx(Alert, {
			severity: "info",
			sx: { mb: 2 },
			...
			children: /* @__PURE__ */ jsxs(Stack, {
				...
				children: [
					...
					/* @__PURE__ */ jsx(SettingsCard, {
						...
						headerAction: !isEditMode && hasEditableFields && !user.isReadOnly ? /* @__PURE__ */ jsx(Button, {
							variant: "outlined",
							size: "small",
					...
					!user.isReadOnly && /* @__PURE__ */ jsxs(SettingsCard, {

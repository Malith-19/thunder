 ...
 */
declare const normalizeTranslations: (translations: Record<string, string | Record<string, string>> | null | undefined) => I18nTranslations;
export default normalizeTranslations;
//# sourceMappingURL=normalizeTranslations.d.ts.map
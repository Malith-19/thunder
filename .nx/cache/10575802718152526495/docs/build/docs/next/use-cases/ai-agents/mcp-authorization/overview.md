...
See it running: [Try It Out — Protect Your MCP Server](https://thunderid.dev/docs/next/use-cases/ai-agents/try-it-out.md).
...
See it running: [Try It Out — Govern MCP Clients](https://thunderid.dev/docs/next/use-cases/ai-agents/try-it-out.md).
...
Once you know which patterns apply, the next decision is how to integrate. See **[Solution Patterns](https://thunderid.dev/docs/next/use-cases/ai-agents/solution-patterns.md)** to compare server-side and client-side options.

...
Choose an approach that fits your application, then see it running against the Wayfinder sample in **[Try It Out](https://thunderid.dev/docs/next/use-cases/try-it-out.md)**.

...
3. The agent decides this is a mutating tool and returns `need_user_consent`. A popup opens, hosted by ThunderID. Sign in inside the popup as `john.doe`.

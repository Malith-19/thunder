...
:::note Prerequisites
Complete the environment steps in [Set Up Sample Application](https://thunderid.dev/docs/next/use-cases/b2c/setup.md#set-up-your-environment) first — run ThunderID, configure CORS, and get the Wayfinder sample running. Then return here and follow the steps below instead of the bundle import.
:::
...
- [Build the Registration Flow](#build-the-registration-flow) — needed for [Self Sign-Up](https://thunderid.dev/docs/next/use-cases/b2c/self-sign-up.md).
- [Build the Account Recovery Flow](#build-the-account-recovery-flow) — needed for [Account Recovery](https://thunderid.dev/docs/next/use-cases/b2c/account-recovery.md).
- [Set up Internal User Onboarding](#set-up-internal-user-onboarding) — needed for [Onboard Internal Users](https://thunderid.dev/docs/next/use-cases/b2c/onboard-internal-users.md).
...
The registration flow drives [Self Sign-Up](https://thunderid.dev/docs/next/use-cases/b2c/self-sign-up.md). It:
...
The recovery flow drives [Account Recovery](https://thunderid.dev/docs/next/use-cases/b2c/account-recovery.md). It:
...
SMTP must be configured for the recovery email to reach the user. The SMTP step is covered in the [Set Up Account Recovery](https://thunderid.dev/docs/next/use-cases/b2c/account-recovery.md#set-up-account-recovery) and is required regardless of which path you took.
...
These resources drive [Onboard Internal Users](https://thunderid.dev/docs/next/use-cases/b2c/onboard-internal-users.md).

...
Build B2C identity where each user owns their account. Users sign themselves up, sign in with the method they prefer, manage their own profile, and recover access when things go wrong.
  ...
  <div className="uc-b2b-intro-kicker">When to use this pattern
...
See it running: [Try It Out - Add Login](https://thunderid.dev/docs/next/use-cases/try-it-out/add-login.md).
...
See it running: [Try It Out - Self Sign-Up](https://thunderid.dev/docs/next/use-cases/try-it-out/self-sign-up.md).
...
See it running: [Try It Out - Profile Section](https://thunderid.dev/docs/next/use-cases/try-it-out/profile-section.md).
...
See it running: [Try It Out - Account Recovery](https://thunderid.dev/docs/next/use-cases/try-it-out/account-recovery.md).
...
See it running: [Try It Out - Onboard Internal Users](https://thunderid.dev/docs/next/use-cases/try-it-out/onboard-internal-users.md).
...
Once you know which use cases apply, the next step is deciding how to integrate. See **[Solution Patterns](https://thunderid.dev/docs/next/use-cases/solution-patterns.md)** to compare integration approaches and find the right fit for your application.

...
This is the same identity primitive used in the [Securing AI Agents](https://thunderid.dev/docs/next/use-cases/overview.md) patterns — choose this when the MCP client *is* an agent in your system, not just an OAuth client.
...
Pick the server-side and client-side patterns that fit your environment, then see them running in **[Try It Out](https://thunderid.dev/docs/next/use-cases/ai-agents/try-it-out.md)**.

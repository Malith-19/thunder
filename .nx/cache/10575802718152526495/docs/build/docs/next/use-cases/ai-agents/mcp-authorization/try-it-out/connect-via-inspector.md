...
:::note Prerequisites
Complete [Set Up Your Environment](https://thunderid.dev/docs/next/use-cases/ai-agents/try-it-out.md#set-up-your-environment) before starting this walkthrough.
:::
...
- Curious how `EXTERNAL-MCP-CLIENT` and the consent step map to ThunderID concepts? See [Application](https://thunderid.dev/docs/next/use-cases/ai-agents/identity-concepts.md#application) and [Consent at Sign-In](https://thunderid.dev/docs/next/use-cases/ai-agents/identity-concepts.md#consent-at-sign-in) in the Identity Concepts.

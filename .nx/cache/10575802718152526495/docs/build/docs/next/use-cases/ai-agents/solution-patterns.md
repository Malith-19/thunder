...
When you decide to add identity to an AI agent, you face a small set of token-flow choices. This page describes them at a generic level, so you can compare options before mapping them to specific patterns from [Identity for AI Agents](https://thunderid.dev/docs/next/use-cases/overview.md).
...
This flow is built using the standard OAuth2 `client_credentials` grant. See [Agent Authentication](https://thunderid.dev/docs/next/guides/guides/agents/agent-authentication.md).
...
This flow is built using OAuth2 authorization code followed by a token exchange that converts the user's token into an on-behalf-of (OBO) token carrying the agent as actor. See [Agent Authentication](https://thunderid.dev/docs/next/guides/guides/agents/agent-authentication.md).
...
This flow is built using the OpenID Connect CIBA grant. See [Backchannel Authentication (CIBA)](https://thunderid.dev/docs/next/guides/guides/protocols/oauth-oidc/backchannel-authentication.md).
...
This flow is built using OAuth2 token exchange ([RFC 8693](https://datatracker.ietf.org/doc/html/rfc8693)). See [Agent Authentication](https://thunderid.dev/docs/next/guides/guides/agents/agent-authentication.md).
...
Choose the flow that fits your agent, then see it running in **[Try It Out](https://thunderid.dev/docs/next/use-cases/try-it-out.md)**.

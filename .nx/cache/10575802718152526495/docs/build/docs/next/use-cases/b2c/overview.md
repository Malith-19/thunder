...
- You are building a SaaS product for business customers with organizations, tenants, delegated admins, or enterprise onboarding. Use [Multi-Tenant SaaS Identity for B2B](https://thunderid.dev/docs/next/b2b/multi-tenant-saas.md).
- You are securing autonomous agents, tools, APIs, or machine-to-machine workflows. Use [Identity for AI Agents](https://thunderid.dev/docs/next/ai-agents/overview.md).
...
The [B2C integration patterns](https://thunderid.dev/docs/next/use-cases/integration-patterns.md) guide helps you compare these options and choose the right integration style before you move into implementation.

...
When your application is wrapped with ``, you can use the `useThunderID` composable to access the authenticated `http` module. This module has the following features:

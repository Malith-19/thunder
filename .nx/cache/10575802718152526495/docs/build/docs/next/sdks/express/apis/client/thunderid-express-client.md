...
In most applications, you do not instantiate this class directly. The [`thunderID()`](https://thunderid.dev/docs/next/sdks/express/apis/middleware/thunderid.md) middleware creates and initializes it for you, then attaches it to `req.thunderIDAuth` and `res.thunderIDAuth`.

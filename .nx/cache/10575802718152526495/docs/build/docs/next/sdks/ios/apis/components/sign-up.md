...
`SignUpState` exposes the same properties and methods as `SignInState`. See [SignIn — SignInState Properties](https://thunderid.dev/docs/next/sdks/ios/apis/components/sign-in.md#signinstate-properties) for the full reference.

...
| :--- | :--- | :---: | :--- | :--- |
| `afterSignInUrl` | `string` | ❌ | `$/login` | Callback URL used after sign-in when not explicitly set |
| `afterSignOutUrl` | `string` | ❌ | `$/logout` | Callback URL used after sign-out when not explicitly set |
...
- Use `mode: 'embedded'` only when you plan to mount [`handleFlow()`](https://thunderid.dev/docs/next/sdks/express/apis/middleware/handle-flow.md)
...
- [`CookieConfig`](https://thunderid.dev/docs/next/sdks/express/apis/constants/cookie-config.md)

...
To get started quickly, check out our [Vanilla JavaScript Quickstart Guide](https://thunderid.dev/docs/next/guides/getting-started/connect-your-application/browser.md) for step-by-step instructions.

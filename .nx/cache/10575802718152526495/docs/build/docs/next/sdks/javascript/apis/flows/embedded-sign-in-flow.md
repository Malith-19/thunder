...
> **Note**
>
> For new integrations, prefer the [V2 flow functions](https://thunderid.dev/docs/next/sdks/javascript/apis/flows/embedded-sign-in-flow-v2.md), which offer a richer response model and better error handling.

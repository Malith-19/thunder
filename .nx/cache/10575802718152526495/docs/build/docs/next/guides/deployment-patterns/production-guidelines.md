...
- A running ThunderID instance configured for your deployment target (see [Choose Your Deployment](https://thunderid.dev/docs/next/guides/deployment-patterns/..md)).
...
- Review the [Kubernetes deployment guide](https://thunderid.dev/docs/next/guides/kubernetes.md) for Helm-based configuration of the settings covered here.

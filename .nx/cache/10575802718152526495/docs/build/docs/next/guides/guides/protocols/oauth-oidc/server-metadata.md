...
| `authorization_response_iss_parameter_supported` | Always `true` (see [Issuer Identification](https://thunderid.dev/docs/next/guides/guides/protocols/issuer-identification.md)) |
...
- [JWKS](https://thunderid.dev/docs/next/guides/guides/protocols/jwks.md) — the public-key endpoint pointed to by `jwks_uri`
- [Issuer Identification](https://thunderid.dev/docs/next/guides/guides/protocols/issuer-identification.md) — uses the `issuer` value advertised here
- [Pushed Authorization Requests](https://thunderid.dev/docs/next/guides/guides/protocols/par.md) — `pushed_authorization_request_endpoint`
- [Dynamic Client Registration](https://thunderid.dev/docs/next/guides/guides/protocols/dynamic-client-registration.md) — `registration_endpoint`

...
This catalog provides the complete property reference for [themes](https://thunderid.dev/docs/next/guides/guides/themes.md) and [layouts](https://thunderid.dev/docs/next/guides/guides/layouts.md). Refer to this page when configuring your design.

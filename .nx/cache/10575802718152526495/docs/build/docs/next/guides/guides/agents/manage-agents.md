...
- An optional [organization unit](https://thunderid.dev/docs/next/guides/organization-units.md) that places the agent in the organizational hierarchy.
...
- [Agent Authentication](https://thunderid.dev/docs/next/guides/guides/agent-authentication.md) — Get M2M and OBO tokens using the OAuth 2.0 token endpoint.
- [Manage Groups](https://thunderid.dev/docs/next/guides/users/manage-groups.md) — Add agents to groups to grant scopes and permissions.
- [Resource Servers](https://thunderid.dev/docs/next/guides/resource-servers.md) — Configure audience and scope validation on your protected APIs.
- [Organization Units](https://thunderid.dev/docs/next/guides/organization-units.md) — Manage the organizational hierarchy that agents belong to.

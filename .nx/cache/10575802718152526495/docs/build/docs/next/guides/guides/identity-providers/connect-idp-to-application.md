...
- You have created an application. See [Manage Applications](https://thunderid.dev/docs/next/guides/applications/manage-applications.md).
...
- [Application Settings](https://thunderid.dev/docs/next/guides/applications/application-settings.md) — Configure tokens, flows, and consent for your application.
- [Build a Sign-In Flow](https://thunderid.dev/docs/next/guides/flows/build-a-flow.md) — Learn more about customizing authentication flows.
- [Manage Identity Providers](https://thunderid.dev/docs/next/guides/guides/manage-identity-providers.md) — Update or remove identity providers.

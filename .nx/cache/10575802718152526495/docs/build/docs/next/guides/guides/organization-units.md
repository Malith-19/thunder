...
All users belong to an OU and each user also has a [user type](https://thunderid.dev/docs/next/guides/users/user-types.md). A user type defines:
...
```bash
curl -kL "https://localhost:8090/organization-units/" \
  -H 'Authorization: Bearer <access-token>'
```
...
```bash
curl -kL "https://localhost:8090/organization-units/tree/" \
  -H 'Authorization: Bearer <access-token>'
```
...
```bash
curl -kL -X PUT "https://localhost:8090/organization-units/" \
  -H 'Authorization: Bearer <access-token>' \
  -H 'Content-Type: application/json' \
  -d ''
```
...
```bash
curl -kL -X PUT "https://localhost:8090/organization-units/tree/" \
  -H 'Authorization: Bearer <access-token>' \
  -H 'Content-Type: application/json' \
  -d ''
```
...
| `GET /organization-units//ous` | List child organization units by parent ID |
| `GET /organization-units/tree//ous` | List child organization units by hierarchical path |
...
```bash
curl -kL "https://localhost:8090/organization-units//users" \
  -H 'Authorization: Bearer <access-token>'
```
...
```bash
curl -kL "https://localhost:8090/organization-units/tree//users" \
  -H 'Authorization: Bearer <access-token>'
```
...
```bash
curl -kL "https://localhost:8090/organization-units//users?include=display" \
  -H 'Authorization: Bearer <access-token>'
```
...
```bash
curl -kL "https://localhost:8090/organization-units//groups" \
  -H 'Authorization: Bearer <access-token>'
```
...
```bash
curl -kL "https://localhost:8090/organization-units/tree//groups" \
  -H 'Authorization: Bearer <access-token>'
```
...
```bash
curl -kL -X DELETE "https://localhost:8090/organization-units/" \
  -H 'Authorization: Bearer <access-token>'
```
...
```bash
curl -kL -X DELETE "https://localhost:8090/organization-units/tree/" \
  -H 'Authorization: Bearer <access-token>'
```

## Related Guides

- [User Types](https://thunderid.dev/docs/next/guides/users/user-types.md) - User types are scoped to an organization unit
- [Users](https://thunderid.dev/docs/next/guides/users/manage-users.md) - Each user belongs to an organization unit
- [Groups](https://thunderid.dev/docs/next/guides/users/manage-groups.md) - Each group belongs to an organization unit

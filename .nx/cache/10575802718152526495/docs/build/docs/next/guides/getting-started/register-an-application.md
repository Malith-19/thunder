...
- Everything ready to [build your sign-in flow](https://thunderid.dev/docs/next/guides/build-a-flow.md) and [connect your app](https://thunderid.dev/docs/next/guides/connect-your-application.md)

## Prerequisites

- ThunderID is running. If not, [get ThunderID](https://thunderid.dev/docs/next/guides/get-thunderid.md) first.
...
Your application is registered and your test user is ready. The next step is building the sign-in flow that authenticates them.
  ...
  - [Build a Sign-In Flow](https://thunderid.dev/docs/next/guides/getting-started/build-a-flow.md) — Use the visual flow designer to configure how users authenticate: password, passkeys, social login, or any combination.

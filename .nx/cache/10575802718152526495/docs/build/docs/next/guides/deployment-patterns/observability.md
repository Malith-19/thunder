...
All backends are disabled by default. For the full list of configuration settings for each backend, see [Observability Configuration](https://thunderid.dev/docs/next/getting-started/configuration.md#observability-configuration).
...
- A running ThunderID instance with access to `deployment.yaml`.
- An OTLP-compatible backend reachable from the ThunderID server. Supported options include:
...
- `service_name` — Identifies ThunderID in your tracing backend. Use a consistent name across deployments.
...
For valid category values, see [Event Categories](https://thunderid.dev/docs/next/getting-started/configuration.md#event-categories) in the configuration reference.
...
- Check ThunderID startup logs for any errors from the OpenTelemetry subscriber.

## Next Steps

- See [Observability Configuration](https://thunderid.dev/docs/next/getting-started/configuration.md#observability-configuration) for the full list of settings for each output backend.
- See the [Observability Contributing Guide](https://thunderid.dev/docs/community/contributing/contributing-code/backend-development/observability.md) to learn how to add instrumentation to new ThunderID components.

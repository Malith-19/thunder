...
- [Authorization Code](https://thunderid.dev/docs/next/guides/guides/protocols/authorization-code.md) — the flow PKCE protects
- [Pushed Authorization Requests](https://thunderid.dev/docs/next/guides/guides/protocols/par.md) — PAR + PKCE together is the recommended high-security pattern
- [Client Authentication Methods](https://thunderid.dev/docs/next/guides/guides/protocols/client-authentication-methods.md) — `none` requires PKCE

...
ThunderID Create (`@thunderid/create`) is a CLI scaffolding tool that automates the creation of feature packages and shared packages in the ThunderID frontend workspace. The tool generates complete, production-ready package structures with pre-configured build tools, testing infrastructure, and best practices.

## Overview

ThunderID Create provides:
...
Before using ThunderID Create:

- Run the tool from within the ThunderID monorepo
...
Execute from anywhere in the ThunderID workspace:

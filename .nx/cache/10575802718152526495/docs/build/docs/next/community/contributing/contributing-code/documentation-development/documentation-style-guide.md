...
# ThunderID Documentation Style Guide

This style guide defines the writing and formatting standards for ThunderID documentation. Following these guidelines ensures consistency, clarity, and a high-quality experience for all readers.

All contributors must review and follow these standards when creating or updating documentation.

## Audience

ThunderID documentation serves:
...
- Do not assume deep familiarity with identity protocols or ThunderID internals.
- Define ThunderID-specific concepts on first use.
...
When generating content using AI tools, adhere to the following guidelines to ensure quality and compliance with ThunderID documentation standards.
...
By adhering to this style guide, you contribute to creating high-quality, user-friendly documentation for ThunderID.

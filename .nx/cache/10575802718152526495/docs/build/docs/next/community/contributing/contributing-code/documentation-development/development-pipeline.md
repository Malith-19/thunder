...
**See**: [Prerequisites - Development Tools](https://thunderid.dev/docs/next/community/contributing/prerequisites.md#development-tools) for complete setup instructions.

...
This guide explains how to share ideas, explore problems, and create feature requests for ThunderID.
...
* ❌ Bug reports → Use [bug report](https://thunderid.dev/docs/next/community/overview.md#-reporting-bugs)
* ❌ Minor improvements → Use [fast track](https://thunderid.dev/docs/next/community/overview.md#-fast-track-contributions)
...
* Specific (not "ThunderID needs better UX")
...
**What it means**: Good idea, but not appropriate for ThunderID.

**Reasons**:

* Out of ThunderID's scope
* Already solved differently
* Technical infeasibility
* Conflicts with ThunderID's vision
...
**Bad** ❌: "ThunderID needs SAML support"
**Good** ✅: "Enterprise customers cannot integrate ThunderID with their existing SAML-based SSO systems, forcing them to maintain duplicate user identities."
...
* **Administrators**: Configure and manage ThunderID
* **Developers**: Integrate applications with ThunderID
...
**Once assigned**: Move to the [Design Guide](https://thunderid.dev/docs/next/community/proposing-features.md) to start designing the solution.
...
* Move to [Design Guide](https://thunderid.dev/docs/next/community/proposing-features.md) if assigned

**Thank you for helping shape ThunderID's roadmap!** Every problem definition makes ThunderID better. 🙏⚡

...
This guide explains how to create design discussions for approved ThunderID features. The design discussion serves as your proposal for how to solve the problem.
...
* ❌ Unclear ideas or feature requests → Use [problem definition guide](https://thunderid.dev/docs/next/community/sharing-ideas.md)
* ❌ Development process → See [development pipeline](https://thunderid.dev/docs/next/community/contributing-code/development-pipeline.md)
...
* Ensure alignment with ThunderID's vision
...
* Implement it yourself (move to [Development Guide](https://thunderid.dev/docs/next/community/contributing-code/development-pipeline.md))

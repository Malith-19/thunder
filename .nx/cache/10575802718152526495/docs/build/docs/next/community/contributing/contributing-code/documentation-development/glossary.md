...
A permission boundary that limits what an application can access. ThunderID supports the following OIDC scopes: `openid`, `profile`, `email`, `phone`, `address`, and `roles`. The `system` scope grants access to ThunderID management APIs.

...
For area-specific coding standards, see the [Backend Development](https://thunderid.dev/docs/next/community/contributing/contributing-code/backend-development/overview.md) and [Frontend Development](https://thunderid.dev/docs/next/community/contributing/contributing-code/frontend-development/overview.md) guides.

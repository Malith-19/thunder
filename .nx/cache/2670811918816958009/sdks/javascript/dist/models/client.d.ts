...
export interface ThunderIDClient<T> {
     ...
     */
    signIn(options?: SignInOptions, sessionId?: string, onSignInSuccess?: (afterSignInUrl: string) => void): Promise<User | TokenResponse | undefined>;
    /**
     ...
     * @returns A promise that resolves to an EmbeddedFlowExecuteResponse containing the flow execution details.
     */
    signIn(payload: EmbeddedSignInFlowHandleRequestPayload, request: EmbeddedFlowExecuteRequestConfig<EmbeddedSignInFlowHandleRequestPayload>, sessionId?: string, onSignInSuccess?: (afterSignInUrl: string) => void): Promise<User | TokenResponse | undefined>;
    /**
     ...
     */
    signOut(options?: SignOutOptions, sessionId?: string, afterSignOut?: (afterSignOutUrl: string) => void): Promise<string | boolean>;
    /**

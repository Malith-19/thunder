...
__thunderid_browser = __toESM(__thunderid_browser);
let vue = require("vue");
vue = __toESM(vue);
...
*/
const BrandingProvider = (0, vue.defineComponent)({
	...
	setup(props, { slots }) {
		const theme = (0, vue.ref)(null);
		const activeTheme = (0, vue.ref)(null);
		const processBranding = () => {
			...
			theme.value = (0, __thunderid_browser.transformBrandingPreferenceToTheme)(props.brandingPreference, props.forceTheme);
		};
		(0, vue.watch)(() => [
		...
		(0, vue.provide)(BRANDING_KEY, {
			activeTheme: (0, vue.readonly)(activeTheme),
			brandingPreference: (0, vue.readonly)((0, vue.computed)(() => props.brandingPreference)),
			error: (0, vue.readonly)((0, vue.computed)(() => props.error)),
			fetchBranding,
			isLoading: (0, vue.readonly)((0, vue.computed)(() => props.isLoading)),
			refetch: props.refetch ?? fetchBranding,
			theme: (0, vue.shallowReadonly)(theme)
		});
		return () => (0, vue.h)("div", { style: "display:contents" }, slots["default"]?.());
	}
});
...
const FlowMetaProvider = (0, vue.defineComponent)({
	...
	setup(props, { slots }) {
		const thunderIDContext = (0, vue.inject)(THUNDERID_KEY);
		const i18nContext = (0, vue.inject)(I18N_KEY, null);
		const meta = (0, vue.ref)(null);
		const isLoading = (0, vue.ref)(false);
		const error = (0, vue.ref)(null);
		const pendingLanguage = (0, vue.ref)(null);
		...
		const fetchFlowMeta = async () => {
			...
			error.value = null;
			try {
				meta.value = await (0, __thunderid_browser.getFlowMetaV2)({
					baseUrl,
					id: applicationId,
		...
		(0, vue.watch)(pendingLanguage, (lang) => {
			if (lang && i18nContext?.setLanguage) {
				i18nContext.setLanguage(lang);
				pendingLanguage.value = null;
			}
		});
		(0, vue.watch)(() => meta.value?.i18n?.translations, (translations) => {
			if (!translations || !i18nContext?.injectBundles) return;
			const metaLanguage = (meta.value?.i18n)?.language || __thunderid_browser.TranslationBundleConstants.FALLBACK_LOCALE;
			const flatTranslations = {};
...
const FlowProvider = (0, vue.defineComponent)({
	name: "FlowProvider",
	props: {
		initialStep: {
			default: null,
	...
	setup(props, { slots }) {
		const currentStep = (0, vue.ref)(props.initialStep ?? null);
		const title = (0, vue.ref)(props.initialTitle ?? "");
		const subtitle = (0, vue.ref)(props.initialSubtitle);
		const messages = (0, vue.ref)([]);
		const error = (0, vue.ref)(null);
		const isLoading = (0, vue.ref)(false);
		const showBackButton = (0, vue.ref)(false);
		const onGoBack = (0, vue.ref)(void 0);
		...
		(0, vue.provide)(FLOW_KEY, {
			addMessage,
			clearMessages,
			currentStep: (0, vue.readonly)(currentStep),
			error: (0, vue.readonly)(error),
			isLoading: (0, vue.readonly)(isLoading),
			messages: (0, vue.shallowReadonly)(messages),
			navigateToFlow,
			onGoBack: (0, vue.readonly)(onGoBack),
			removeMessage,
			reset,
			setCurrentStep,
			setError,
			...
			setSubtitle,
			setTitle,
			showBackButton: (0, vue.readonly)(showBackButton),
			subtitle: (0, vue.readonly)(subtitle),
			title: (0, vue.readonly)(title)
		});
		return () => (0, vue.h)("div", { style: "display:contents" }, slots["default"]?.());
	}
});
...
*/
const logger$7 = (0, __thunderid_browser.createPackageLogger)(PACKAGE_NAME);
/**
...
*/
const createVueLogger = (component) => (0, __thunderid_browser.createPackageComponentLogger)(PACKAGE_NAME, component);
...
const I18nProvider = (0, vue.defineComponent)({
	name: "I18nProvider",
	props: { preferences: {
		default: void 0,
		type: Object
	...
	setup(props, { slots }) {
		...
		const determineInitialLanguage = () => {
			...
			return props.preferences?.fallbackLanguage || __thunderid_browser.TranslationBundleConstants.FALLBACK_LOCALE;
		};
		const currentLanguage = (0, vue.ref)(determineInitialLanguage());
		const fallbackLanguage = props.preferences?.fallbackLanguage || __thunderid_browser.TranslationBundleConstants.FALLBACK_LOCALE;
		const injectedBundles = (0, vue.ref)({});
		const injectBundles = (newBundles) => {
			...
			Object.entries(newBundles).forEach(([languageKey, bundle]) => {
				...
				if (mergedBundles[languageKey]) mergedBundles[languageKey] = {
					...
					translations: (0, __thunderid_browser.deepMerge)(mergedBundles[languageKey].translations, normalizedTranslations)
				};
		...
		*/
		const mergedBundlesComputed = (0, vue.computed)(() => {
			const merged = {};
		...
		(0, vue.watch)(currentLanguage, (lang) => {
			storage.write(lang);
		});
		const t = (key, params) => {
			let translation;
		...
		(0, vue.provide)(I18N_KEY, {
			bundles: (0, vue.readonly)(mergedBundlesComputed),
			currentLanguage: (0, vue.readonly)(currentLanguage),
			fallbackLanguage,
			injectBundles,
			setLanguage,
			t
...
const OrganizationProvider = (0, vue.defineComponent)({
	...
	setup(props, { slots }) {
		...
		const switchOrganization = async (organization) => {
			if (!props.onOrganizationSwitch) throw new __thunderid_browser.ThunderIDRuntimeError("onOrganizationSwitch callback is required", "OrganizationProvider-SwitchError-001", "vue", "The onOrganizationSwitch callback must be provided to handle organization switching.");
			isLoading.value = true;
			error.value = null;
			try {
		...
		const currentOrganizationRef = (0, vue.computed)(() => props.currentOrganization);
		const myOrganizationsRef = (0, vue.computed)(() => props.myOrganizations);
		(0, vue.provide)(ORGANIZATION_KEY, {
...
const ThemeProvider = (0, vue.defineComponent)({
	name: "ThemeProvider",
	props: {
		detection: {
			default: () => ({}),
		...
		mode: {
			default: __thunderid_browser.DEFAULT_THEME,
			type: String
		},
		theme: {
			default: void 0,
	...
	setup(props, { slots }) {
		const brandingContext = (0, vue.inject)(BRANDING_KEY, null);
		const initColorScheme = () => {
			if (props.mode === "light" || props.mode === "dark") return props.mode;
			if (props.mode === "branding") return (0, __thunderid_browser.detectThemeMode)("system", props.detection);
			return (0, __thunderid_browser.detectThemeMode)(props.mode, props.detection);
		};
		const colorScheme = (0, vue.ref)(initColorScheme());
		(0, vue.watch)(() => brandingContext?.activeTheme.value, (brandingActiveTheme) => {
		...
		const finalThemeConfig = (0, vue.computed)(() => {
		...
		const resolvedTheme = (0, vue.computed)(() => (0, __thunderid_browser.createTheme)(finalThemeConfig.value, colorScheme.value === "dark"));
		const direction = (0, vue.computed)(() => finalThemeConfig.value?.direction || "ltr");
		const toggleTheme = () => {
		...
		(0, vue.watch)(resolvedTheme, (theme) => applyToDom(theme), { immediate: true });
		(0, vue.watch)(direction, (dir) => {
		...
		(0, vue.onMounted)(() => {
			...
			if (props.mode === "class") {
				...
				if (targetElement) classObserver = (0, __thunderid_browser.createClassObserver)(targetElement, handleThemeChange, props.detection);
			} else if (props.mode === "system") {
				if (!props.inheritFromBranding || !brandingContext?.activeTheme.value) mediaQuery = (0, __thunderid_browser.createMediaQueryListener)(handleThemeChange);
			}
		});
		...
		(0, vue.provide)(THEME_KEY, {
			brandingError: brandingContext?.error ?? (0, vue.readonly)((0, vue.ref)(null)),
			colorScheme: (0, vue.readonly)(colorScheme),
			direction: (0, vue.readonly)(direction),
			inheritFromBranding: props.inheritFromBranding,
			isBrandingLoading: brandingContext?.isLoading ?? (0, vue.readonly)((0, vue.ref)(false)),
			theme: (0, vue.shallowReadonly)(resolvedTheme),
			toggleTheme
		});
		return () => (0, vue.h)("div", { style: "display:contents" }, slots["default"]?.());
	}
...
const UserProvider = (0, vue.defineComponent)({
	name: "UserProvider",
	props: {
		onUpdateProfile: {
			default: void 0,
	...
	setup(props, { slots }) {
		const profileRef = (0, vue.computed)(() => props.profile);
		const flattenedProfileRef = (0, vue.computed)(() => props.profile?.flattenedProfile ?? null);
		const schemasRef = (0, vue.computed)(() => props.profile?.schemas ?? null);
		(0, vue.provide)(USER_KEY, {
...
*/
var ThunderIDVueClient = class extends __thunderid_browser.ThunderIDBrowserClient {
	loadingState = false;
	...
	reInitialize(config) {
		return this.withLoading(async () => {
			...
			try {
				...
				throw new __thunderid_browser.ThunderIDRuntimeError(`Failed to check if the client is initialized: ${error instanceof Error ? error.message : String(error)}`, "ThunderIDVueClient-reInitialize-RuntimeError-001", "vue", "An error occurred while checking the initialization status of the client.");
			}
	...
	async getUser(options) {
		try {
			...
			return (0, __thunderid_browser.generateUserProfile)(await getScim2Me_default({ baseUrl }), (0, __thunderid_browser.flattenUserSchema)(await getSchemas_default({ baseUrl })));
		} catch (error) {
	...
	async getUserProfile(options) {
		return this.withLoading(async () => {
			try {
				...
				const processedSchemas = (0, __thunderid_browser.flattenUserSchema)(await getSchemas_default({
					baseUrl,
					instanceId: this.getInstanceId()
				}));
				return {
					flattenedProfile: (0, __thunderid_browser.generateFlattenedUserProfile)(profile, processedSchemas),
					profile,
					schemas: processedSchemas
				};
			} catch (error) {
				return {
					flattenedProfile: (0, __thunderid_browser.extractUserClaimsFromIdToken)(await this.getDecodedIdToken()),
					profile: (0, __thunderid_browser.extractUserClaimsFromIdToken)(await this.getDecodedIdToken()),
					schemas: []
				};
			}
		});
	...
	async getMyOrganizations(options) {
		try {
			...
			throw new __thunderid_browser.ThunderIDRuntimeError(`Failed to fetch the user's associated organizations: ${error instanceof Error ? error.message : String(error)}`, "ThunderIDVueClient-getMyOrganizations-RuntimeError-001", "vue", "An error occurred while fetching associated organizations of the signed-in user.");
		}
	}
	async getAllOrganizations(options) {
		try {
			...
			throw new __thunderid_browser.ThunderIDRuntimeError(`Failed to fetch all organizations: ${error instanceof Error ? error.message : String(error)}`, "ThunderIDVueClient-getAllOrganizations-RuntimeError-001", "vue", "An error occurred while fetching all the organizations associated with the user.");
		}
	}
	async getCurrentOrganization() {
		try {
			...
			throw new __thunderid_browser.ThunderIDRuntimeError(`Failed to fetch the current organization: ${error instanceof Error ? error.message : String(error)}`, "ThunderIDVueClient-getCurrentOrganization-RuntimeError-001", "vue", "An error occurred while fetching the current organization of the signed-in user.");
		}
	}
	async switchOrganization(organization) {
		return this.withLoading(async () => {
			try {
				...
				if (!organization.id) throw new __thunderid_browser.ThunderIDRuntimeError("Organization ID is required for switching organizations", "vue-ThunderIDVueClient-SwitchOrganizationError-001", "vue", "The organization object must contain a valid ID to perform the organization switch.");
				...
				throw new __thunderid_browser.ThunderIDRuntimeError(`Failed to switch organization: ${error.message || error}`, "vue-ThunderIDVueClient-SwitchOrganizationError-003", "vue", "An error occurred while switching to the specified organization. Please try again.");
			}
		});
	}
	isLoading() {
	...
	async signUp(...args) {
		...
		return (0, __thunderid_browser.executeEmbeddedSignUpFlowV2)({
			authId,
			baseUrl,
...
function hasAuthParams(url, afterSignInUrl) {
	return (0, __thunderid_browser.hasAuthParamsInUrl)() && !!afterSignInUrl && new URL(url.origin + url.pathname).toString() === new URL(afterSignInUrl).toString() || url.searchParams.get("error") !== null;
}
/**
...
* ```
*/
const ThunderIDProvider = (0, vue.defineComponent)({
	...
	setup(props, { slots }) {
		...
		const isSignedIn = (0, vue.ref)(false);
		const isInitialized = (0, vue.ref)(false);
		const isLoading = (0, vue.ref)(true);
		const user = (0, vue.shallowRef)(null);
		const currentOrganization = (0, vue.shallowRef)(null);
		const myOrganizations = (0, vue.shallowRef)([]);
		const userProfile = (0, vue.shallowRef)(null);
		const resolvedBaseUrl = (0, vue.ref)(props.baseUrl);
		...
		async function signIn(...args) {
			...
			try {
				...
				throw new __thunderid_browser.ThunderIDRuntimeError(`Sign in failed: ${error instanceof Error ? error.message : String(JSON.stringify(error))}`, "thunderid-signIn-Error", "vue", "An error occurred while trying to sign in.");
			} finally {
				if (!isV2FlowRequest) {
					isUpdatingSession = false;
					isLoading.value = client.isLoading();
		...
		async function signInSilently(options) {
			try {
				...
				throw new __thunderid_browser.ThunderIDRuntimeError(`Error while signing in silently: ${error instanceof Error ? error.message : String(JSON.stringify(error))}`, "thunderid-signInSilently-Error", "vue", "An error occurred while trying to sign in silently.");
			} finally {
				isUpdatingSession = false;
				isLoading.value = client.isLoading();
			}
		...
		async function switchOrganization(organization) {
			try {
				...
				throw new __thunderid_browser.ThunderIDRuntimeError(`Failed to switch organization: ${error instanceof Error ? error.message : String(JSON.stringify(error))}`, "thunderid-switchOrganization-Error", "vue", "An error occurred while switching to the specified organization.");
			} finally {
				isUpdatingSession = false;
				isLoading.value = client.isLoading();
			}
		}
		(0, vue.provide)(THUNDERID_KEY, {
			afterSignInUrl: props.afterSignInUrl,
			applicationId: props.applicationId,
			baseUrl: props.baseUrl,
		...
		(0, vue.onMounted)(async () => {
			...
			if (await client.isSignedIn()) await updateSession();
				...
				if (hasAuthParams(currentUrl, initializedConfig?.afterSignInUrl) && (0, __thunderid_browser.hasCalledForThisInstanceInUrl)(props.instanceId ?? 0, currentUrl.search)) try {
		...
		return () => (0, vue.h)(I18nProvider_default, null, { default: () => (0, vue.h)(FlowMetaProvider_default, { enabled: true }, { default: () => (0, vue.h)(BrandingProvider_default, null, { default: () => (0, vue.h)(ThemeProvider_default, null, { default: () => (0, vue.h)(FlowProvider_default, null, { default: () => (0, vue.h)(UserProvider_default, {
			onUpdateProfile: (updatedUser) => {
				user.value = updatedUser;
				userProfile.value = {
					flattenedProfile: (0, __thunderid_browser.generateFlattenedUserProfile)(updatedUser, userProfile.value?.schemas ?? []),
					profile: updatedUser,
			...
			revalidateProfile: async () => {
				try {
					const claims = (0, __thunderid_browser.extractUserClaimsFromIdToken)(await client.getDecodedIdToken());
					user.value = claims;
					userProfile.value = {
						flattenedProfile: claims,
						profile: claims,
		...
		}, { default: () => (0, vue.h)(OrganizationProvider_default, {
...
*/
const useThunderID = () => {
	const context = (0, vue.inject)(THUNDERID_KEY);
	...
	const flowMetaContext = (0, vue.inject)(FLOW_META_KEY, null);
	const i18nContext = (0, vue.inject)(I18N_KEY, null);
	const meta = flowMetaContext?.meta ?? (0, vue.ref)(null);
	return {
		...context,
		meta,
...
*/
const useBranding = () => {
	const context = (0, vue.inject)(BRANDING_KEY);
...
*/
const useFlow = () => {
	const context = (0, vue.inject)(FLOW_KEY);
...
*/
const useFlowMeta = () => {
	const context = (0, vue.inject)(FLOW_META_KEY);
...
*/
const useI18n = () => {
	const context = (0, vue.inject)(I18N_KEY);
...
const useOrganization = () => {
	const context = (0, vue.inject)(ORGANIZATION_KEY);
...
*/
const useTheme = () => {
	const context = (0, vue.inject)(THEME_KEY);
...
*/
const useUser = () => {
	const context = (0, vue.inject)(USER_KEY);
	...
	setup(props, { slots, emit, attrs }) {
		return () => {
			return (0, vue.h)("button", {
				class: [
					(0, __thunderid_browser.withVendorCSSClassPrefix)("button"),
					(0, __thunderid_browser.withVendorCSSClassPrefix)(`button--${props.variant}`),
					(0, __thunderid_browser.withVendorCSSClassPrefix)(`button--${props.color}`),
					(0, __thunderid_browser.withVendorCSSClassPrefix)(`button--${props.size}`),
					props.fullWidth ? (0, __thunderid_browser.withVendorCSSClassPrefix)("button--full-width") : "",
					props.loading ? (0, __thunderid_browser.withVendorCSSClassPrefix)("button--loading") : "",
					attrs.class || ""
				].filter(Boolean).join(" "),
				...
				props.startIcon ? (0, vue.h)("span", { class: (0, __thunderid_browser.withVendorCSSClassPrefix)("button__start-icon") }, [props.startIcon]) : null,
				(0, vue.h)("span", { class: (0, __thunderid_browser.withVendorCSSClassPrefix)("button__content") }, slots["default"]?.()),
				props.endIcon ? (0, vue.h)("span", { class: (0, __thunderid_browser.withVendorCSSClassPrefix)("button__end-icon") }, [props.endIcon]) : null,
				props.loading ? (0, vue.h)("span", {
					"aria-hidden": "true",
					class: (0, __thunderid_browser.withVendorCSSClassPrefix)("button__spinner")
				}) : null
			]);
		};
	}
...
const Card = (0, vue.defineComponent)({
	name: "Card",
	props: { variant: {
		default: "elevated",
		type: String
	...
	setup(props, { slots, attrs }) {
		return () => (0, vue.h)("div", {
			class: [
				(0, __thunderid_browser.withVendorCSSClassPrefix)("card"),
				(0, __thunderid_browser.withVendorCSSClassPrefix)(`card--${props.variant}`),
				attrs.class || ""
			].filter(Boolean).join(" "),
			style: attrs.style
		}, slots["default"]?.());
...
const Alert = (0, vue.defineComponent)({
	name: "Alert",
	props: {
		dismissible: {
			default: false,
	...
	setup(props, { slots, emit, attrs }) {
		return () => (0, vue.h)("div", {
			class: [
				(0, __thunderid_browser.withVendorCSSClassPrefix)("alert"),
				(0, __thunderid_browser.withVendorCSSClassPrefix)(`alert--${props.severity}`),
				attrs.class || ""
			].filter(Boolean).join(" "),
			role: "alert",
			style: attrs.style
		}, [(0, vue.h)("div", { class: (0, __thunderid_browser.withVendorCSSClassPrefix)("alert__content") }, slots["default"]?.()), props.dismissible ? (0, vue.h)("button", {
			"aria-label": "Dismiss",
			class: (0, __thunderid_browser.withVendorCSSClassPrefix)("alert__dismiss"),
...
const TextField = (0, vue.defineComponent)({
	name: "TextField",
	props: {
		autoComplete: {
			default: void 0,
	...
	setup(props, { emit, attrs }) {
		return () => {
			...
			const wrapperClass = [
				(0, __thunderid_browser.withVendorCSSClassPrefix)("text-field"),
				hasError ? (0, __thunderid_browser.withVendorCSSClassPrefix)("text-field--error") : "",
				attrs.class || ""
			].filter(Boolean).join(" ");
			let helperContent;
			if (hasError) helperContent = (0, vue.h)("span", { class: (0, __thunderid_browser.withVendorCSSClassPrefix)("text-field__error") }, props.error);
			else if (props.helperText) helperContent = (0, vue.h)("span", { class: (0, __thunderid_browser.withVendorCSSClassPrefix)("text-field__helper") }, props.helperText);
			else helperContent = null;
			return (0, vue.h)("div", {
				class: wrapperClass,
				style: attrs.style
			}, [
				props.label ? (0, vue.h)("label", {
					class: (0, __thunderid_browser.withVendorCSSClassPrefix)("text-field__label"),
					for: props.name
				}, [props.label, props.required ? (0, vue.h)("span", { class: (0, __thunderid_browser.withVendorCSSClassPrefix)("text-field__required") }, " *") : null]) : null,
				(0, vue.h)("input", {
					autocomplete: props.autoComplete,
					class: (0, __thunderid_browser.withVendorCSSClassPrefix)("text-field__input"),
...
const icon = (paths) => (0, vue.h)("svg", { ...defaultProps }, paths);
const CheckIcon = () => icon([(0, vue.h)("polyline", { points: "20 6 9 17 4 12" })]);
const XIcon = () => icon([(0, vue.h)("line", {
	x1: "18",
	x2: "6",
	y1: "6",
	y2: "18"
...
const EyeIcon = () => icon([(0, vue.h)("path", { d: "M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z" }), (0, vue.h)("circle", {
	cx: "12",
	cy: "12",
	r: "3"
})]);
const EyeOffIcon = () => icon([
	(0, vue.h)("path", { d: "M17.94 17.94A10.07 10.07 0 0 1 12 20c-7 0-11-8-11-8a18.45 18.45 0 0 1 5.06-5.94" }),
	(0, vue.h)("path", { d: "M9.9 4.24A9.12 9.12 0 0 1 12 4c7 0 11 8 11 8a18.5 18.5 0 0 1-2.16 3.19" }),
	(0, vue.h)("line", {
		x1: "1",
		x2: "23",
		y1: "1",
...
const CircleCheckIcon = () => icon([(0, vue.h)("path", { d: "M22 11.08V12a10 10 0 1 1-5.93-9.14" }), (0, vue.h)("polyline", { points: "22 4 12 14.01 9 11.01" })]);
const InfoIcon = () => icon([
	(0, vue.h)("circle", {
		cx: "12",
		cy: "12",
...
const TriangleAlertIcon = () => icon([
	(0, vue.h)("path", { d: "M10.29 3.86L1.82 18a2 2 0 0 0 1.71 3h16.94a2 2 0 0 0 1.71-3L13.71 3.86a2 2 0 0 0-3.42 0z" }),
	(0, vue.h)("line", {
		x1: "12",
		x2: "12",
		y1: "9",
...
const PlusIcon = () => icon([(0, vue.h)("line", {
	x1: "12",
	x2: "12",
	y1: "5",
	y2: "19"
...
const LogOutIcon = () => icon([
	(0, vue.h)("path", { d: "M9 21H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h4" }),
	(0, vue.h)("polyline", { points: "16 17 21 12 16 7" }),
	(0, vue.h)("line", {
		x1: "21",
		x2: "9",
		y1: "12",
...
const UserIcon = () => icon([(0, vue.h)("path", { d: "M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2" }), (0, vue.h)("circle", {
	cx: "12",
	cy: "7",
	r: "4"
})]);
const ArrowLeftRightIcon = () => icon([
	(0, vue.h)("polyline", { points: "7 16 3 12 7 8" }),
	(0, vue.h)("line", {
		x1: "21",
		x2: "3",
		y1: "12",
	...
	(0, vue.h)("polyline", { points: "17 8 21 12 17 16" })
]);
...
const ChevronDownIcon = () => icon([(0, vue.h)("polyline", { points: "6 9 12 15 18 9" })]);
const GlobeIcon = () => icon([
	...
	(0, vue.h)("path", { d: "M12 2a15.3 15.3 0 0 1 4 10 15.3 15.3 0 0 1-4 10 15.3 15.3 0 0 1-4-10 15.3 15.3 0 0 1 4-10z" })
]);
const PencilIcon = () => icon([(0, vue.h)("path", { d: "M17 3a2.828 2.828 0 1 1 4 4L7.5 20.5 2 22l1.5-5.5L17 3z" })]);

//#endregion
//#region src/components/primitives/PasswordField/PasswordField.ts
const PasswordField = (0, vue.defineComponent)({
	name: "PasswordField",
	props: {
		disabled: {
			default: false,
	...
	setup(props, { emit, attrs }) {
		...
		return () => {
			...
			return (0, vue.h)("div", {
				class: [
					(0, __thunderid_browser.withVendorCSSClassPrefix)("password-field"),
					hasError ? (0, __thunderid_browser.withVendorCSSClassPrefix)("password-field--error") : "",
					attrs.class || ""
				].filter(Boolean).join(" "),
				style: attrs.style
			}, [
				props.label ? (0, vue.h)("label", {
					class: (0, __thunderid_browser.withVendorCSSClassPrefix)("password-field__label"),
					for: props.name
				}, [props.label, props.required ? (0, vue.h)("span", { class: (0, __thunderid_browser.withVendorCSSClassPrefix)("password-field__required") }, " *") : null]) : null,
				(0, vue.h)("div", { class: (0, __thunderid_browser.withVendorCSSClassPrefix)("password-field__wrapper") }, [(0, vue.h)("input", {
					class: (0, __thunderid_browser.withVendorCSSClassPrefix)("password-field__input"),
					"data-testid": attrs["data-testid"],
					disabled: props.disabled,
					id: props.name,
					name: props.name,
					...
					class: (0, __thunderid_browser.withVendorCSSClassPrefix)("password-field__toggle"),
					onClick: () => {
				...
				hasError ? (0, vue.h)("span", { class: (0, __thunderid_browser.withVendorCSSClassPrefix)("password-field__error") }, props.error) : null
			]);
		};
	}
});
...
const Select = (0, vue.defineComponent)({
	...
	setup(props, { emit, attrs }) {
		return () => {
			const hasError = !!props.error;
			const wrapperClass = [
				(0, __thunderid_browser.withVendorCSSClassPrefix)("select"),
				hasError ? (0, __thunderid_browser.withVendorCSSClassPrefix)("select--error") : "",
				attrs.class || ""
			].filter(Boolean).join(" ");
			let helperContent;
			if (hasError) helperContent = (0, vue.h)("span", { class: (0, __thunderid_browser.withVendorCSSClassPrefix)("select__error") }, props.error);
			else if (props.helperText) helperContent = (0, vue.h)("span", { class: (0, __thunderid_browser.withVendorCSSClassPrefix)("select__helper") }, props.helperText);
			else helperContent = null;
			return (0, vue.h)("div", {
				class: wrapperClass,
				style: attrs.style
				...
				props.label ? (0, vue.h)("label", {
					class: (0, __thunderid_browser.withVendorCSSClassPrefix)("select__label"),
					for: props.name
				}, [props.label, props.required ? (0, vue.h)("span", { class: (0, __thunderid_browser.withVendorCSSClassPrefix)("select__required") }, " *") : null]) : null,
				(0, vue.h)("select", {
					class: (0, __thunderid_browser.withVendorCSSClassPrefix)("select__input"),
					"data-testid": attrs["data-testid"],
					disabled: props.disabled,
					id: props.name,
					name: props.name,
					...
					required: props.required,
					value: props.modelValue
				}, [props.placeholder ? (0, vue.h)("option", {
					disabled: true,
					value: ""
				}, props.placeholder) : null, ...props.options.map((opt) => (0, vue.h)("option", {
					key: opt.value,
					value: opt.value
				}, opt.label))]),
				helperContent
...
const Checkbox = (0, vue.defineComponent)({
	...
	setup(props, { emit, attrs }) {
		return () => {
			return (0, vue.h)("div", {
				class: [
					(0, __thunderid_browser.withVendorCSSClassPrefix)("checkbox"),
					props.error ? (0, __thunderid_browser.withVendorCSSClassPrefix)("checkbox--error") : "",
					attrs.class || ""
				].filter(Boolean).join(" "),
				style: attrs.style
			}, [(0, vue.h)("label", { class: (0, __thunderid_browser.withVendorCSSClassPrefix)("checkbox__wrapper") }, [(0, vue.h)("input", {
				checked: props.modelValue,
				class: (0, __thunderid_browser.withVendorCSSClassPrefix)("checkbox__input"),
				"data-testid": attrs["data-testid"],
				disabled: props.disabled,
				id: props.name,
				name: props.name,
				...
				required: props.required,
				type: "checkbox"
			}), props.label ? (0, vue.h)("span", { class: (0, __thunderid_browser.withVendorCSSClassPrefix)("checkbox__label") }, props.label) : null]), props.error ? (0, vue.h)("span", { class: (0, __thunderid_browser.withVendorCSSClassPrefix)("checkbox__error") }, props.error) : null]);
		};
	}
});
...
const DatePicker = (0, vue.defineComponent)({
	...
	setup(props, { emit, attrs }) {
		return () => {
			...
			return (0, vue.h)("div", {
				class: [
					(0, __thunderid_browser.withVendorCSSClassPrefix)("date-picker"),
					hasError ? (0, __thunderid_browser.withVendorCSSClassPrefix)("date-picker--error") : "",
					attrs.class || ""
				].filter(Boolean).join(" "),
				style: attrs.style
			}, [
				props.label ? (0, vue.h)("label", {
					class: (0, __thunderid_browser.withVendorCSSClassPrefix)("date-picker__label"),
					for: props.name
				}, [props.label, props.required ? (0, vue.h)("span", { class: (0, __thunderid_browser.withVendorCSSClassPrefix)("date-picker__required") }, " *") : null]) : null,
				(0, vue.h)("input", {
					class: (0, __thunderid_browser.withVendorCSSClassPrefix)("date-picker__input"),
					"data-testid": attrs["data-testid"],
					disabled: props.disabled,
					id: props.name,
					name: props.name,
				...
				hasError ? (0, vue.h)("span", { class: (0, __thunderid_browser.withVendorCSSClassPrefix)("date-picker__error") }, props.error) : null
			]);
		};
	}
});
...
const OtpField = (0, vue.defineComponent)({
	name: "OtpField",
	props: {
		disabled: {
			default: false,
	...
	setup(props, { emit, attrs }) {
		...
		const handleInput = (index, e) => {
			...
			if (val && index < props.length - 1) (0, vue.nextTick)(() => inputRefs.value[index + 1]?.focus());
		};
		const handleKeydown = (index, e) => {
			if (e.key === "Backspace" && !e.target.value && index > 0) (0, vue.nextTick)(() => inputRefs.value[index - 1]?.focus());
		};
		return () => {
			const digits = (props.modelValue || "").split("");
			while (digits.length < props.length) digits.push("");
			return (0, vue.h)("div", {
				class: [(0, __thunderid_browser.withVendorCSSClassPrefix)("otp-field"), attrs.class || ""].filter(Boolean).join(" "),
				style: attrs.style
			}, [
				props.label ? (0, vue.h)("label", { class: (0, __thunderid_browser.withVendorCSSClassPrefix)("otp-field__label") }, [props.label, props.required ? (0, vue.h)("span", { class: (0, __thunderid_browser.withVendorCSSClassPrefix)("otp-field__required") }, " *") : null]) : null,
				(0, vue.h)("div", { class: (0, __thunderid_browser.withVendorCSSClassPrefix)("otp-field__inputs") }, Array.from({ length: props.length }, (_, i) => (0, vue.h)("input", {
					"aria-label": `Digit ${i + 1}`,
					class: (0, __thunderid_browser.withVendorCSSClassPrefix)("otp-field__digit"),
					disabled: props.disabled,
					inputmode: "numeric",
					key: i,
					maxlength: 1,
				...
				props.error ? (0, vue.h)("span", { class: (0, __thunderid_browser.withVendorCSSClassPrefix)("otp-field__error") }, props.error) : null
			]);
		};
	}
});
...
const Typography = (0, vue.defineComponent)({
	name: "Typography",
	props: {
		component: {
			default: void 0,
	...
	setup(props, { slots, attrs }) {
		return () => {
			return (0, vue.h)(props.component || {
				body1: "p",
				body2: "p",
				caption: "span",
				h1: "h1",
				...
				class: [
					(0, __thunderid_browser.withVendorCSSClassPrefix)("typography"),
					(0, __thunderid_browser.withVendorCSSClassPrefix)(`typography--${props.variant}`),
					attrs.class || ""
				].filter(Boolean).join(" "),
				style: attrs.style
			}, slots["default"]?.());
...
const Divider = (0, vue.defineComponent)({
	name: "Divider",
	props: { orientation: {
		default: "horizontal",
		type: String
	...
	setup(props, { slots, attrs }) {
		return () => {
			...
			const cssClass = [
				(0, __thunderid_browser.withVendorCSSClassPrefix)("divider"),
				(0, __thunderid_browser.withVendorCSSClassPrefix)(`divider--${props.orientation}`),
				hasContent ? (0, __thunderid_browser.withVendorCSSClassPrefix)("divider--with-content") : "",
				attrs.class || ""
			].filter(Boolean).join(" ");
			if (hasContent) return (0, vue.h)("div", {
				class: cssClass,
				role: "separator",
				style: attrs.style
			}, [
				(0, vue.h)("span", { class: (0, __thunderid_browser.withVendorCSSClassPrefix)("divider__line") }),
				(0, vue.h)("span", { class: (0, __thunderid_browser.withVendorCSSClassPrefix)("divider__content") }, slots["default"]?.()),
				(0, vue.h)("span", { class: (0, __thunderid_browser.withVendorCSSClassPrefix)("divider__line") })
			]);
			return (0, vue.h)("hr", {
				class: cssClass,
...
const Logo = (0, vue.defineComponent)({
	name: "Logo",
	props: {
		alt: {
			default: "Logo",
	...
	setup(props, { attrs }) {
		return () => {
			const img = (0, vue.h)("img", {
				alt: props.alt,
				class: (0, __thunderid_browser.withVendorCSSClassPrefix)("logo__image"),
				height: props.height,
				src: props.src,
				width: props.width
			});
			if (props.href) return (0, vue.h)("a", {
				class: [(0, __thunderid_browser.withVendorCSSClassPrefix)("logo"), attrs.class || ""].filter(Boolean).join(" "),
				href: props.href,
				style: attrs.style
			}, [img]);
			return (0, vue.h)("div", {
...
const Spinner = (0, vue.defineComponent)({
	name: "Spinner",
	props: { size: {
		default: "medium",
		type: String
	...
	setup(props, { attrs }) {
		return () => (0, vue.h)("div", {
			"aria-label": "Loading",
			class: [
				(0, __thunderid_browser.withVendorCSSClassPrefix)("spinner"),
				(0, __thunderid_browser.withVendorCSSClassPrefix)(`spinner--${props.size}`),
				attrs.class || ""
			].filter(Boolean).join(" "),
			role: "status",
			style: attrs.style
		}, [(0, vue.h)("svg", {
			class: (0, __thunderid_browser.withVendorCSSClassPrefix)("spinner__svg"),
			fill: "none",
			viewBox: "0 0 24 24",
			xmlns: "http://www.w3.org/2000/svg"
		}, [(0, vue.h)("circle", {
			class: (0, __thunderid_browser.withVendorCSSClassPrefix)("spinner__circle"),
			cx: "12",
			cy: "12",
			r: "10",
			stroke: "currentColor",
...
*/
const BaseSignInButton = (0, vue.defineComponent)({
	...
	setup(props, { slots, emit, attrs }) {
		...
		return () => {
			if (props.unstyled) return (0, vue.h)("button", {
				class: [(0, __thunderid_browser.withVendorCSSClassPrefix)("sign-in-button-wrapper"), attrs.class || ""].filter(Boolean).join(" "),
				disabled: props.disabled || props.isLoading,
				onClick: handleClick,
				style: attrs.style,
				type: "button"
			}, slots.default ? slots.default({ isLoading: props.isLoading }) : "Sign In");
			return (0, vue.h)(Button_default, {
				class: [(0, __thunderid_browser.withVendorCSSClassPrefix)("sign-in-button"), attrs.class || ""].filter(Boolean).join(" "),
				disabled: props.disabled || props.isLoading,
...
*/
const SignInButton = (0, vue.defineComponent)({
	name: "SignInButton",
	props: { signInOptions: {
		default: void 0,
		type: Object
	...
	setup(props, { slots, emit, attrs }) {
		...
		const handleSignIn = async (e) => {
			try {
				...
				emit("error", error);
				throw new __thunderid_browser.ThunderIDRuntimeError(`Sign in failed: ${error instanceof Error ? error.message : String(error)}`, "SignInButton-handleSignIn-RuntimeError-001", "vue", "Something went wrong while trying to sign in. Please try again later.");
			} finally {
				isLoading.value = false;
			}
		};
		return () => {
			...
			return (0, vue.h)(BaseSignInButton_default, {
				class: attrs.class,
...
*/
const BaseSignOutButton = (0, vue.defineComponent)({
	...
	setup(props, { slots, emit, attrs }) {
		...
		return () => {
			if (props.unstyled) return (0, vue.h)("button", {
				class: [(0, __thunderid_browser.withVendorCSSClassPrefix)("sign-out-button-wrapper"), attrs.class || ""].filter(Boolean).join(" "),
				disabled: props.disabled || props.isLoading,
				onClick: handleClick,
				style: attrs.style,
				type: "button"
			...
			return (0, vue.h)(Button_default, {
				class: [(0, __thunderid_browser.withVendorCSSClassPrefix)("sign-out-button"), attrs.class || ""].filter(Boolean).join(" "),
				disabled: props.disabled || props.isLoading,
				loading: props.isLoading,
				onClick: handleClick,
				style: attrs.style,
...
*/
const SignOutButton = (0, vue.defineComponent)({
	name: "SignOutButton",
	emits: ["click", "error"],
	setup(_, { slots, emit, attrs }) {
		...
		const handleSignOut = async (e) => {
			try {
				...
				emit("error", error);
				throw new __thunderid_browser.ThunderIDRuntimeError(`Sign out failed: ${error instanceof Error ? error.message : String(error)}`, "SignOutButton-handleSignOut-RuntimeError-001", "vue", "Something went wrong while trying to sign out. Please try again later.");
			} finally {
				isLoading.value = false;
			}
		};
		return () => {
			const slotContent = slots["default"] ? () => slots["default"]({ isLoading: isLoading.value }) : void 0;
			return (0, vue.h)(BaseSignOutButton_default, {
				class: attrs.class,
				isLoading: isLoading.value,
...
*/
const BaseSignUpButton = (0, vue.defineComponent)({
	...
	setup(props, { slots, emit, attrs }) {
		...
		return () => {
			if (props.unstyled) return (0, vue.h)("button", {
				class: [(0, __thunderid_browser.withVendorCSSClassPrefix)("sign-up-button-wrapper"), attrs.class || ""].filter(Boolean).join(" "),
				disabled: props.disabled || props.isLoading,
				onClick: handleClick,
				style: attrs.style,
				type: "button"
			...
			return (0, vue.h)(Button_default, {
				class: [(0, __thunderid_browser.withVendorCSSClassPrefix)("sign-up-button"), attrs.class || ""].filter(Boolean).join(" "),
				color: "primary",
				disabled: props.disabled || props.isLoading,
				loading: props.isLoading,
				onClick: handleClick,
...
* Falls back to i18n translation for the button text.
*/
const SignUpButton = (0, vue.defineComponent)({
	name: "SignUpButton",
	emits: ["click", "error"],
	setup(_, { slots, emit, attrs }) {
		...
		const handleSignUp = async (e) => {
			try {
				...
				emit("error", error);
				throw new __thunderid_browser.ThunderIDRuntimeError(`Sign up failed: ${error instanceof Error ? error.message : String(error)}`, "SignUpButton-handleSignUp-RuntimeError-001", "vue", "Something went wrong while trying to sign up. Please try again later.");
			} finally {
				isLoading.value = false;
			}
		};
		return () => {
			const slotContent = slots["default"] ? () => slots["default"]({ isLoading: isLoading.value }) : void 0;
			return (0, vue.h)(BaseSignUpButton_default, {
				class: attrs.class,
				isLoading: isLoading.value,
		...
		(0, vue.onMounted)(() => {
			...
			try {
				...
				if (oauthError) {
					...
					params$1.set("error", oauthError);
					if (errorDescription) params$1.set("error_description", errorDescription);
					navigate$4(`${returnPath}?${params$1.toString()}`);
					return;
				}
				...
				navigate$4(`${returnPath}?${params.toString()}`);
			} catch (err) {
...
*/
const FacebookButton = (0, vue.defineComponent)({
	name: "FacebookButton",
	props: { isLoading: {
		default: false,
		type: Boolean
	...
	setup(props, { slots, emit, attrs }) {
		...
		const facebookIcon = () => (0, vue.h)("svg", {
			height: "18",
			viewBox: "0 0 512 512",
			width: "18",
			xmlns: "http://www.w3.org/2000/svg"
...
*/
const GitHubButton = (0, vue.defineComponent)({
	name: "GitHubButton",
	props: { isLoading: {
		default: false,
		type: Boolean
	...
	setup(props, { slots, emit, attrs }) {
		const { t } = useI18n_default();
		const gitHubIcon = () => (0, vue.h)("svg", {
			height: "18",
			viewBox: "0 0 67.91 66.233",
			width: "18",
			xmlns: "http://www.w3.org/2000/svg"
		}, [(0, vue.h)("g", { transform: "translate(-386.96 658.072)" }, [(0, vue.h)("path", {
...
*/
const GoogleButton = (0, vue.defineComponent)({
	name: "GoogleButton",
	props: { isLoading: {
		default: false,
		type: Boolean
	...
	setup(props, { slots, emit, attrs }) {
		const { t } = useI18n_default();
		const googleIcon = () => (0, vue.h)("svg", {
			height: "18",
			viewBox: "0 0 67.91 67.901",
			width: "18",
			xmlns: "http://www.w3.org/2000/svg"
		}, [(0, vue.h)("g", { transform: "translate(-0.001 -0.001)" }, [
			(0, vue.h)("path", {
...
*/
const MicrosoftButton = (0, vue.defineComponent)({
	...
	setup(props, { slots, emit, attrs }) {
		const { t } = useI18n_default();
		const microsoftIcon = () => (0, vue.h)("svg", {
			height: "14",
			viewBox: "0 0 23 23",
			width: "14",
			xmlns: "http://www.w3.org/2000/svg"
...
const createField = (config) => {
	...
	switch (type) {
		case __thunderid_browser.FieldType.Password: return (0, vue.h)(PasswordField_default, {
			...commonProps,
			"onUpdate:modelValue": onChange
		});
		case __thunderid_browser.FieldType.Text: return (0, vue.h)(TextField_default, {
			...commonProps,
			autocomplete: "off",
			"onUpdate:modelValue": onChange,
			type: "text"
		});
		case __thunderid_browser.FieldType.Email: return (0, vue.h)(TextField_default, {
			...commonProps,
			autocomplete: "email",
			"onUpdate:modelValue": onChange,
			type: "email"
		});
		case __thunderid_browser.FieldType.Date: return (0, vue.h)(DatePicker_default, {
			...commonProps,
			"onUpdate:modelValue": onChange
		});
		case __thunderid_browser.FieldType.Checkbox: {
			const isChecked = value === "true" || value === true;
			return (0, vue.h)(Checkbox_default, {
				...commonProps,
				modelValue: isChecked,
				"onUpdate:modelValue": (checked) => onChange(checked.toString())
			});
		}
		case __thunderid_browser.FieldType.Otp: return (0, vue.h)(OtpField_default, {
			...commonProps,
			"onUpdate:modelValue": onChange
		});
		case __thunderid_browser.FieldType.Number: return (0, vue.h)(TextField_default, {
			...commonProps,
		...
		case __thunderid_browser.FieldType.Select: {
			...
			if (fieldOptions.length > 0) return (0, vue.h)(Select_default, {
				...commonProps,
				helperText: "Select from available options",
				"onUpdate:modelValue": onChange,
				options: fieldOptions
			});
			return (0, vue.h)(TextField_default, {
				...commonProps,
		...
		default: return (0, vue.h)(TextField_default, {
			...commonProps,
...
*/
const FieldFactory = (0, vue.defineComponent)({
	name: "FieldFactory",
	props: {
		className: {
			default: void 0,
...
const renderFormFields = (props) => {
	...
	const fieldNodes = (authenticator.metadata?.params?.sort((a, b) => a.order - b.order)?.filter((param) => param.param !== "totp") || []).map((param) => (0, vue.h)("div", { key: param.param }, createField({
	...
	fieldNodes.push((0, vue.h)(Button_default, {
...
const renderMultiOptionButton = (props) => {
	...
	if (authenticator.idp !== __thunderid_browser.EmbeddedSignInFlowAuthenticatorKnownIdPType.Local) authenticatorName = authenticator.idp;
	...
	return (0, vue.h)(Button_default, {
		...
		startIcon: (0, vue.h)("svg", {
			...
			d: {
				[__thunderid_browser.ApplicationNativeAuthenticationConstants.SupportedAuthenticators.SmsOtp]: "M20 15.5c-1.25 0-2.45-.2-3.57-.57a1.02 1.02 0 0 0-1.02.24l-2.2 2.2a15.074 15.074 0 0 1-6.59-6.59l2.2-2.2c.27-.27.35-.67.24-1.02A11.36 11.36 0 0 1 8.5 4c0-.55-.45-1-1-1H4c-.55 0-1 .45-1 1 0 9.39 7.61 17 17 17 .55 0 1-.45 1-1v-3.5c0-.55-.45-1-1-1M12 3v10l3-3h6V3z",
				[__thunderid_browser.ApplicationNativeAuthenticationConstants.SupportedAuthenticators.EmailOtp]: "M20 4H4c-1.1 0-1.99.9-1.99 2L2 18c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2m0 4l-8 5l-8-5V6l8 5l8-5z",
				[__thunderid_browser.ApplicationNativeAuthenticationConstants.SupportedAuthenticators.Totp]: "M12 1L3 5v6c0 5.55 3.84 10.74 9 12c5.16-1.26 9-6.45 9-12V5z"
...
const createSignInOption = (props) => {
	...
	switch (authenticator.authenticatorId) {
		case __thunderid_browser.ApplicationNativeAuthenticationConstants.SupportedAuthenticators.UsernamePassword:
		case __thunderid_browser.ApplicationNativeAuthenticationConstants.SupportedAuthenticators.IdentifierFirst: return (0, vue.h)("div", {}, renderFormFields(props));
		case __thunderid_browser.ApplicationNativeAuthenticationConstants.SupportedAuthenticators.Google: return (0, vue.h)(GoogleButton_default, {
			class: buttonClassName,
			isLoading,
			onClick: () => onSubmit(authenticator)
		});
		case __thunderid_browser.ApplicationNativeAuthenticationConstants.SupportedAuthenticators.GitHub: return (0, vue.h)(GitHubButton_default, {
			class: buttonClassName,
			isLoading,
			onClick: () => onSubmit(authenticator)
		});
		case __thunderid_browser.ApplicationNativeAuthenticationConstants.SupportedAuthenticators.Microsoft: return (0, vue.h)(MicrosoftButton_default, {
			class: buttonClassName,
			isLoading,
			onClick: () => onSubmit(authenticator)
		});
		case __thunderid_browser.ApplicationNativeAuthenticationConstants.SupportedAuthenticators.Facebook: return (0, vue.h)(FacebookButton_default, {
			class: buttonClassName,
			isLoading,
			onClick: () => onSubmit(authenticator)
		});
		case __thunderid_browser.ApplicationNativeAuthenticationConstants.SupportedAuthenticators.EmailOtp:
		case __thunderid_browser.ApplicationNativeAuthenticationConstants.SupportedAuthenticators.Totp:
		case __thunderid_browser.ApplicationNativeAuthenticationConstants.SupportedAuthenticators.SmsOtp: return hasParams ? (0, vue.h)("div", {}, renderFormFields(props)) : renderMultiOptionButton(props);
		default:
			if (authenticator.idp !== __thunderid_browser.EmbeddedSignInFlowAuthenticatorKnownIdPType.Local) return renderSocialButton(props);
			return hasParams ? (0, vue.h)("div", {}, renderFormFields(props)) : renderMultiOptionButton(props);
	}
};
/**
...
*/
const BaseSignIn$2 = (0, vue.defineComponent)({
	name: "BaseSignInV1",
	props: {
		afterSignInUrl: {
			default: void 0,
	...
	setup(props, { emit }) {
		...
		const isInitRequestLoading = (0, vue.ref)(false);
		const isInitialized = (0, vue.ref)(false);
		const currentFlow = (0, vue.ref)(null);
		const currentAuthenticator = (0, vue.ref)(null);
		const error = (0, vue.ref)(null);
		const messages = (0, vue.ref)([]);
		const formValues = (0, vue.ref)({});
		const touchedFields = (0, vue.ref)({});
		...
		const processNextStep = (response) => {
			if (response && "flowId" in response && "nextStep" in response) {
				...
				if (response.nextStep?.authenticators?.length > 0) if (response.nextStep.stepType === __thunderid_browser.EmbeddedSignInFlowStepType.MultiOptionsPrompt && response.nextStep.authenticators.length > 1) currentAuthenticator.value = null;
				else {
		...
		const handleRedirectionIfNeeded = (response) => {
			if (response && "nextStep" in response && response.nextStep && response.nextStep.stepType === __thunderid_browser.EmbeddedSignInFlowStepType.AuthenticatorPrompt && response.nextStep.authenticators?.length === 1) {
				...
				if (responseAuth.metadata?.promptType === __thunderid_browser.EmbeddedSignInFlowAuthenticatorPromptType.RedirectionPrompt && responseAuth.metadata?.additionalData?.redirectUrl) {
							...
							try {
								...
								if (popupUrl && (popupUrl.includes("code=") || popupUrl.includes("error="))) {
									...
									if (code && state) {
										...
										if (submitResponse?.flowStatus === __thunderid_browser.EmbeddedSignInFlowStatus.SuccessCompleted) emit("success", submitResponse.authData);
									}
								}
							} catch {}
						} catch {}
		...
		const handleSubmit = async (submittedValues) => {
			...
			try {
				...
				error.value = err instanceof __thunderid_browser.ThunderIDAPIError ? err.message : t("errors.signin.flow.failure");
				emit("error", err);
			} finally {
		...
		handleAuthenticatorSelection = async (authenticator, formData) => {
			...
			try {
				...
				if (authenticator.metadata?.promptType === __thunderid_browser.EmbeddedSignInFlowAuthenticatorPromptType.RedirectionPrompt) {
					const payload = {
						flowId: currentFlow.value.flowId,
						selectedAuthenticator: {
							authenticatorId: authenticator.authenticatorId,
		...
		const hasMultipleOptions = () => !!(currentFlow.value && "nextStep" in currentFlow.value && currentFlow.value.nextStep?.stepType === __thunderid_browser.EmbeddedSignInFlowStepType.MultiOptionsPrompt && currentFlow.value.nextStep?.authenticators && currentFlow.value.nextStep.authenticators.length > 1);
		...
		(0, vue.watch)(() => props.isLoading, (loading) => {
			if (!loading && !initAttempted && props.onInitialize) {
				...
				(async () => {
					...
					try {
						...
						error.value = err instanceof __thunderid_browser.ThunderIDAPIError ? err.message : t("errors.signin.initialization");
						emit("error", err);
					} finally {
						isInitRequestLoading.value = false;
					}
		...
		const renderMessages = () => messages.value.map((msg, i) => (0, vue.h)(Alert_default, {
			key: i,
			severity: renderAlertVariant(msg.type)
		}, { default: () => msg.message }));
		const renderError = () => error.value ? (0, vue.h)(Alert_default, { severity: "error" }, { default: () => error.value }) : null;
		return () => {
			const cardClass = [
				(0, __thunderid_browser.withVendorCSSClassPrefix)("signin"),
				(0, __thunderid_browser.withVendorCSSClassPrefix)(`signin--${props.size}`),
				(0, __thunderid_browser.withVendorCSSClassPrefix)(`signin--${props.variant}`),
				props.className
			].filter(Boolean).join(" ");
			if (!isInitialized.value && isLoading()) return (0, vue.h)("div", {}, [props.showLogo ? (0, vue.h)("div", { class: (0, __thunderid_browser.withVendorCSSClassPrefix)("signin__logo") }, [(0, vue.h)(Logo_default)]) : null, (0, vue.h)(Card_default, {
				class: cardClass,
				variant: props.variant
			}, { default: () => [(0, vue.h)("div", { class: (0, __thunderid_browser.withVendorCSSClassPrefix)("signin__loading") }, [(0, vue.h)(Spinner_default, { size: "medium" }), (0, vue.h)(Typography_default, { variant: "body1" }, { default: () => t("messages.loading.placeholder") })])] })]);
			if (hasMultipleOptions() && !currentAuthenticator.value) {
				const available = getAvailableAuthenticators();
				const userPromptAuths = available.filter((auth) => auth.metadata?.promptType === __thunderid_browser.EmbeddedSignInFlowAuthenticatorPromptType.UserPrompt || auth.idp === "LOCAL" && auth.metadata?.params && auth.metadata.params.length > 0);
				...
				return (0, vue.h)("div", {}, [props.showLogo ? (0, vue.h)("div", { class: (0, __thunderid_browser.withVendorCSSClassPrefix)("signin__logo") }, [(0, vue.h)(Logo_default)]) : null, (0, vue.h)(Card_default, {
					class: cardClass,
					variant: props.variant
				}, { default: () => {
					const children = [];
					if (props.showTitle || props.showSubtitle) children.push((0, vue.h)("div", { class: (0, __thunderid_browser.withVendorCSSClassPrefix)("signin__header") }, [props.showTitle ? (0, vue.h)(Typography_default, { variant: "h2" }, { default: () => flowTitle.value || t("signin.heading") }) : null, props.showSubtitle ? (0, vue.h)(Typography_default, { variant: "body1" }, { default: () => flowSubtitle.value || t("signin.subheading") }) : null]));
					if (flowMessages.value?.length > 0) children.push((0, vue.h)("div", { class: (0, __thunderid_browser.withVendorCSSClassPrefix)("signin__flow-messages") }, flowMessages.value.map((fm, i) => (0, vue.h)(Alert_default, {
						key: fm.id || i,
						severity: fm.type
					}, { default: () => fm.message }))));
					if (messages.value.length > 0) children.push((0, vue.h)("div", {}, renderMessages()));
					const errNode = renderError();
					if (errNode) children.push(errNode);
					userPromptAuths.forEach((auth, index) => {
						if (index > 0) children.push((0, vue.h)(Divider_default, {}, { default: () => "OR" }));
						children.push((0, vue.h)("form", { onSubmit: (e) => {
							e.preventDefault();
							const fd = {};
					...
					if (userPromptAuths.length > 0 && optionAuths.length > 0) children.push((0, vue.h)(Divider_default, {}, { default: () => "OR" }));
					optionAuths.forEach((auth) => {
						children.push((0, vue.h)("div", { key: auth.authenticatorId }, [createSignInOptionFromAuthenticator(auth, formValues.value, touchedFields.value, isLoading(), handleInputChange, (a, fd) => handleAuthenticatorSelection(a, fd), t, {
							buttonClassName: props.buttonClassName,
							error: error.value,
							inputClassName: props.inputClassName
						})]));
			...
			if (!currentAuthenticator.value) return (0, vue.h)("div", {}, [props.showLogo ? (0, vue.h)("div", { class: (0, __thunderid_browser.withVendorCSSClassPrefix)("signin__logo") }, [(0, vue.h)(Logo_default)]) : null, (0, vue.h)(Card_default, {
				class: cardClass,
				variant: props.variant
			}, { default: () => {
				const errNode = renderError();
				return errNode ? [errNode] : [(0, vue.h)(Typography_default, { variant: "body1" }, { default: () => t("messages.loading.placeholder") })];
			} })]);
			if (isPasskeyAuthenticator(currentAuthenticator.value) && !isLoading()) {
				...
				return (0, vue.h)("div", {}, [props.showLogo ? (0, vue.h)("div", { class: (0, __thunderid_browser.withVendorCSSClassPrefix)("signin__logo") }, [(0, vue.h)(Logo_default)]) : null, (0, vue.h)(Card_default, {
					class: cardClass,
					variant: props.variant
				}, { default: () => [(0, vue.h)("div", { style: "text-align:center" }, [(0, vue.h)(Spinner_default, { size: "large" }), (0, vue.h)(Typography_default, { variant: "body1" }, { default: () => t("passkey.authenticating") || "Authenticating with passkey..." })])] })]);
			}
			return (0, vue.h)("div", {}, [props.showLogo ? (0, vue.h)("div", { class: (0, __thunderid_browser.withVendorCSSClassPrefix)("signin__logo") }, [(0, vue.h)(Logo_default)]) : null, (0, vue.h)(Card_default, {
				class: cardClass,
				variant: props.variant
				...
				const children = [];
				children.push((0, vue.h)("div", { class: (0, __thunderid_browser.withVendorCSSClassPrefix)("signin__header") }, [(0, vue.h)(Typography_default, { variant: "h2" }, { default: () => flowTitle.value || t("signin.heading") }), (0, vue.h)(Typography_default, { variant: "body1" }, { default: () => flowSubtitle.value || t("signin.subheading") })]));
				if (flowMessages.value?.length > 0) children.push((0, vue.h)("div", { class: (0, __thunderid_browser.withVendorCSSClassPrefix)("signin__flow-messages") }, flowMessages.value.map((fm, i) => (0, vue.h)(Alert_default, {
					key: fm.id || i,
					severity: fm.type
				}, { default: () => fm.message }))));
				...
				const errNode = renderError();
				if (errNode) children.push(errNode);
				children.push((0, vue.h)("form", {
					class: (0, __thunderid_browser.withVendorCSSClassPrefix)("signin__form"),
					onSubmit: (e) => {
						e.preventDefault();
						const fd = {};
...
*/
const SignIn$2 = (0, vue.defineComponent)({
	name: "SignInV1",
	props: {
		className: {
			default: "",
	...
	setup(props, { emit, attrs }) {
		...
		return () => (0, vue.h)(BaseSignIn_default$1, {
			...attrs,
			afterSignInUrl,
...
const resolveEmojiUrisInHtml = (html) => {
	return html.replace(/<img([^>]*)src="(emoji:[^"]+)"([^>]*)\/?>/gi, (_match, pre, src, post) => {
		const emoji = (0, __thunderid_browser.extractEmojiFromUri)(src);
	...
	}).replace(/emoji:([^\s"<>&]+)/g, (_, rest) => (0, __thunderid_browser.isEmojiUri)(`emoji:${rest}`) ? rest : `emoji:${rest}`);
};
/**
...
const createAuthComponentFromFlow = (component, formValues, touchedFields, formErrors, isLoading, isFormValid, onInputChange, options = {}) => {
	...
	switch (component.type) {
		...
		case __thunderid_browser.EmbeddedFlowComponentTypeV2.Action: {
			...
			if (matchesSocialProvider$1(actionId, eventType, buttonText, "google")) return (0, vue.h)(GoogleButton_default, {
				class: options.buttonClassName,
				key,
				onClick: handleClick
			});
			if (matchesSocialProvider$1(actionId, eventType, buttonText, "github")) return (0, vue.h)(GitHubButton_default, {
				class: options.buttonClassName,
				key,
				onClick: handleClick
			});
			if (matchesSocialProvider$1(actionId, eventType, buttonText, "facebook")) return (0, vue.h)(FacebookButton_default, {
				class: options.buttonClassName,
				key,
				onClick: handleClick
			});
			if (matchesSocialProvider$1(actionId, eventType, buttonText, "microsoft")) return (0, vue.h)(MicrosoftButton_default, {
				class: options.buttonClassName,
				key,
				onClick: handleClick
			});
			const startIconVNode = component.startIcon ? (0, vue.h)("img", {
				alt: "",
				"aria-hidden": "true",
			...
			const endIconVNode = component.endIcon ? (0, vue.h)("img", {
				alt: "",
				"aria-hidden": "true",
		...
		case __thunderid_browser.EmbeddedFlowComponentTypeV2.Text: {
			const variant = getTypographyVariant(component.variant ?? "");
			return (0, vue.h)(Typography_default, {
				key,
				style: {
					marginBottom: "0.5rem",
		...
		case __thunderid_browser.EmbeddedFlowComponentTypeV2.Divider: {
			const dividerLabel = resolve(component.label) || "";
			return (0, vue.h)(Divider_default, { key }, dividerLabel ? { default: () => dividerLabel } : void 0);
		}
		...
		case __thunderid_browser.EmbeddedFlowComponentTypeV2.Block:
			...
			return null;
		case __thunderid_browser.EmbeddedFlowComponentTypeV2.RichText: return (0, vue.h)("div", {
			innerHTML: dompurify.default.sanitize(resolveEmojiUrisInHtml(resolve(component.label))),
			key,
...
* ```
*/
const BaseSignIn$1 = (0, vue.defineComponent)({
	name: "BaseSignIn",
	props: {
		additionalData: {
			default: () => ({}),
	...
	setup(props, { slots, emit, attrs }) {
		...
		const apiError = (0, vue.ref)(null);
		const isLoading = (0, vue.computed)(() => props.isLoading || isSubmitting.value);
		const formValues = (0, vue.ref)({});
		const touchedFields = (0, vue.ref)({});
		(0, vue.watch)(() => props.components, (newComponents) => {
		...
		const formErrors = (0, vue.computed)(() => {
		...
		const isFormValid = (0, vue.computed)(() => Object.keys(formErrors.value).length === 0);
		...
		return () => {
			...
			if (isLoading.value && (!props.components || props.components.length === 0)) return (0, vue.h)(Card_default, {
				class: containerClass,
				variant: props.variant
			}, () => (0, vue.h)("div", { style: "display:flex;justify-content:center;padding:2rem" }, (0, vue.h)(Spinner_default)));
			if (!props.components || props.components.length === 0) return (0, vue.h)(Card_default, {
				class: containerClass,
				variant: props.variant
			}, () => (0, vue.h)(Alert_default, { severity: "warning" }, () => (0, vue.h)(Typography_default, { variant: "body1" }, () => t("errors.signin.components.not.available") || "No sign-in options available")));
			const messages = flowMessages.value || [];
			const externalError = props.error;
			return (0, vue.h)(Card_default, {
				class: containerClass,
				...attrs,
				variant: props.variant
			}, () => [(externalError || messages.length > 0) && (0, vue.h)("div", { class: [(0, __thunderid_browser.withVendorCSSClassPrefix)("signin__messages"), props.messageClassName].filter(Boolean).join(" ") }, [externalError && (0, vue.h)(Alert_default, { severity: "error" }, () => (0, vue.h)(Typography_default, { variant: "body2" }, () => externalError.message)), ...messages.map((msg, index) => (0, vue.h)(Alert_default, {
				key: index,
				severity: msg.type === "error" ? "error" : "info"
			}, () => (0, vue.h)(Typography_default, { variant: "body2" }, () => msg.message)))]), (0, vue.h)("div", { class: (0, __thunderid_browser.withVendorCSSClassPrefix)("signin__content") }, renderComponents())]);
		};
	}
});
...
* ```
*/
const SignIn$1 = (0, vue.defineComponent)({
	name: "SignIn",
	props: {
		className: {
			default: "",
	...
	setup(props, { slots, emit, attrs }) {
		...
		const additionalData = (0, vue.ref)({});
		const currentExecutionId = (0, vue.ref)(null);
		const isFlowInitialized = (0, vue.ref)(false);
		const flowError = (0, vue.ref)(null);
		const isSubmitting = (0, vue.ref)(false);
		const isTimeoutDisabled = (0, vue.ref)(false);
		const passkeyState = (0, vue.ref)({
			actionId: null,
			challenge: null,
		...
		const initializeFlow = async () => {
			...
			if (!urlParams.executionId && !effectiveApplicationId) {
				const err = new __thunderid_browser.ThunderIDRuntimeError("Either executionId or applicationId is required for authentication", "SIGN_IN_ERROR", "vue");
				setError(err);
				throw err;
			}
			try {
				...
				if (urlParams.executionId) response = await signIn({ executionId: urlParams.executionId });
					...
					flowType: __thunderid_browser.EmbeddedFlowType.Authentication
				});
		...
		(0, vue.watch)(() => [additionalData.value?.["stepTimeout"], isFlowInitialized.value], ([timeoutMs]) => {
			scheduleTimeout(Number(timeoutMs) || 0);
		});
		(0, vue.onUnmounted)(() => {
			if (timeoutHandle) clearTimeout(timeoutHandle);
		});
		(0, vue.watch)(() => passkeyState.value, async (state) => {
		...
		return () => {
			...
			if (slots["default"]) {
				...
				return (0, vue.h)("div", {}, slots["default"](renderProps));
			}
			return (0, vue.h)(BaseSignIn_default$2, {
				...attrs,
				additionalData: additionalData.value,
				class: props.className,
				components: components.value,
...
const SignIn = (0, vue.defineComponent)({
	...
	setup(props, { slots, emit, attrs }) {
		...
		return () => {
			if (platform === __thunderid_browser.Platform.ThunderID) return (0, vue.h)(SignIn_default$2, {
				...attrs,
				class: props.className,
				onError: (err) => emit("error", err),
			...
			return (0, vue.h)(SignIn_default$1, {
				...attrs,
				class: props.className,
				onError: (err) => emit("error", err),
				onSuccess: (data) => emit("success", data),
...
*/
const BaseSignIn = (0, vue.defineComponent)({
	name: "BaseSignIn",
	inheritAttrs: false,
	setup(_props, { attrs, slots }) {
		const { platform } = useThunderID_default();
		return () => {
			if (platform === __thunderid_browser.Platform.ThunderID) return (0, vue.h)(BaseSignIn_default$2, { ...attrs }, slots);
			return (0, vue.h)(BaseSignIn_default$1, { ...attrs }, slots);
		};
	}
});
...
const inferFieldType = (component) => {
	...
	if (variant === "EMAIL" || cfgType === "email") return __thunderid_browser.FieldType.Email;
	if (variant === "PASSWORD" || cfgType === "password") return __thunderid_browser.FieldType.Password;
	if (variant === "TELEPHONE" || cfgType === "tel") return __thunderid_browser.FieldType.Text;
	if (variant === "NUMBER" || cfgType === "number") return __thunderid_browser.FieldType.Number;
	if (variant === "DATE" || cfgType === "date") return __thunderid_browser.FieldType.Date;
	if (variant === "CHECKBOX" || cfgType === "checkbox") return __thunderid_browser.FieldType.Checkbox;
	return __thunderid_browser.FieldType.Text;
};
/**
...
const createSignUpComponent = (props) => {
	...
	const cfg = component.config || {};
	switch (component.type) {
		case __thunderid_browser.EmbeddedFlowComponentType.Typography: {
		...
		case __thunderid_browser.EmbeddedFlowComponentType.Button: {
			...
			if (matchesSocialProvider(component, "google")) return (0, vue.h)(GoogleButton_default, {
				class: buttonClassName,
				isLoading,
				onClick: handleClick
			});
			if (matchesSocialProvider(component, "github")) return (0, vue.h)(GitHubButton_default, {
				class: buttonClassName,
				isLoading,
				onClick: handleClick
			});
			if (matchesSocialProvider(component, "microsoft")) return (0, vue.h)(MicrosoftButton_default, {
				class: buttonClassName,
				isLoading,
				onClick: handleClick
			});
			if (matchesSocialProvider(component, "facebook")) return (0, vue.h)(FacebookButton_default, {
				class: buttonClassName,
				isLoading,
				onClick: handleClick
			});
		...
		case __thunderid_browser.EmbeddedFlowComponentType.Form: {
		...
		case __thunderid_browser.EmbeddedFlowComponentType.Divider: return (0, vue.h)("hr", {
			class: "thunderid-signup__divider",
			style: "margin:0.75rem 0;border:0;border-top:1px solid #e5e7eb"
		});
		case __thunderid_browser.EmbeddedFlowComponentType.Image: {
		...
		default:
			if (String(component.type).toUpperCase() === "RICH_TEXT") return (0, vue.h)("div", {
...
*/
const BaseSignUp$2 = (0, vue.defineComponent)({
	name: "BaseSignUpV1",
	props: {
		afterSignUpUrl: {
			default: void 0,
	...
	setup(props, { slots, emit }) {
		...
		*/
		const handleRedirectionIfNeeded = (response) => {
			if (response?.type !== __thunderid_browser.EmbeddedFlowResponseType.Redirection || !response?.data?.redirectURL) return false;
			...
			const continueWithCode = async (code, state) => {
				...
				try {
					...
					if (next.flowStatus === __thunderid_browser.EmbeddedFlowStatus.Complete) {
						props.onComplete?.(next);
						emit("complete", next);
					} else if (next.flowStatus === __thunderid_browser.EmbeddedFlowStatus.Incomplete) {
		...
		(0, vue.watch)(() => [props.isInitialized, isFlowInitialized.value], ([initialized, flowInit]) => {
		...
		return () => {
			const containerClass = [
				...
				(0, __thunderid_browser.withVendorCSSClassPrefix)(`signup--${props.size}`),
				(0, __thunderid_browser.withVendorCSSClassPrefix)(`signup--${props.variant}`),
				props.className
			].filter(Boolean).join(" ");
			if (slots["default"]) {
				const renderProps = {
				...
				return (0, vue.h)("div", { class: containerClass }, slots["default"](renderProps));
			}
			if (!isFlowInitialized.value && isLoading.value) return (0, vue.h)(Card_default, {
				class: containerClass,
				variant: props.variant
			}, () => (0, vue.h)("div", { style: "display:flex;justify-content:center;padding:2rem" }, (0, vue.h)(Spinner_default)));
			if (!currentFlow.value) return (0, vue.h)(Card_default, {
				class: containerClass,
				variant: props.variant
			}, () => (0, vue.h)(Alert_default, { variant: "error" }, () => t("errors.signup.flow.initialization.failure") || "Failed to initialize sign-up flow"));
			...
			const cardChildren = [];
			if (props.showLogo) cardChildren.push((0, vue.h)("div", { style: "display:flex;justify-content:center;margin-bottom:1rem" }, [(0, vue.h)(Logo_default)]));
			if (props.showTitle || props.showSubtitle) {
				const headerChildren = [];
				if (props.showTitle) headerChildren.push((0, vue.h)(Typography_default, { variant: "h2" }, { default: () => flowTitle.value || t("signup.heading") || "Sign Up" }));
				if (props.showSubtitle) headerChildren.push((0, vue.h)(Typography_default, { variant: "body1" }, { default: () => flowSubtitle.value || t("signup.subheading") || "Create your account" }));
				cardChildren.push((0, vue.h)("div", { style: "padding: 0 1rem 1rem" }, headerChildren));
			}
			if (flowMessages.value && flowMessages.value.length > 0) cardChildren.push((0, vue.h)("div", { style: "padding: 0 1rem" }, flowMessages.value.map((msg, i) => (0, vue.h)(Alert_default, {
				class: props.messageClassName,
				key: msg.id || i,
				variant: msg.type?.toLowerCase() === "error" ? "error" : "info"
			}, () => msg.message))));
			cardChildren.push((0, vue.h)("form", {
				class: (0, __thunderid_browser.withVendorCSSClassPrefix)("signup__form"),
				onSubmit: (e) => {
					e.preventDefault();
					handleSubmit({
						config: { type: "submit" },
			...
			}, rendered.length > 0 ? rendered : [(0, vue.h)(Alert_default, { variant: "warning" }, () => t("errors.signup.components.not.available") || "No components available")]));
			return (0, vue.h)(Card_default, {
				class: containerClass,
				variant: props.variant
			}, () => cardChildren);
...
* the V1 flow API.
*/
const SignUp$2 = (0, vue.defineComponent)({
	name: "SignUpV1",
	props: {
		afterSignUpUrl: {
			default: void 0,
	...
	setup(props, { slots }) {
		...
		const handleComplete = (response) => {
			...
			if (props.shouldRedirectAfterSignUp && response?.type !== __thunderid_browser.EmbeddedFlowResponseType.Redirection && props.afterSignUpUrl) {
				if (typeof window !== "undefined") window.location.href = props.afterSignUpUrl;
			}
		};
		return () => (0, vue.h)(BaseSignUp_default$1, {
...
const extractFormFields = (components) => {
	...
	const process = (comps) => {
		comps.forEach((c) => {
			if (c.type === __thunderid_browser.EmbeddedFlowComponentTypeV2.TextInput || c.type === __thunderid_browser.EmbeddedFlowComponentTypeV2.PasswordInput || c.type === __thunderid_browser.EmbeddedFlowComponentTypeV2.EmailInput || c.type === __thunderid_browser.EmbeddedFlowComponentTypeV2.Select) {
...
*/
const BaseSignUp$1 = (0, vue.defineComponent)({
	name: "BaseSignUp",
	props: {
		afterSignUpUrl: {
			default: void 0,
	...
	setup(props, { slots }) {
		...
		const touchedFields = (0, vue.ref)({});
		const formErrors = (0, vue.ref)({});
		const isFormValid = (0, vue.ref)(true);
		let initializationAttempted = false;
		let passkeyProcessed = false;
		const handleError = (error) => {
			const errorMessage = error?.failureReason || extractErrorMessage(error, t);
		...
		const computeFormErrors = () => {
			...
			fields.forEach((field) => {
				...
				if ((field.type === __thunderid_browser.EmbeddedFlowComponentTypeV2.EmailInput || field.type === "EMAIL") && value && !/^[^\s@]+@[^\s@]+\.[^\s@]+$/.test(value)) errors[field.name] = t("field.email.invalid") || "Invalid email address";
			});
			return errors;
		};
		const touchAllFields = () => {
		...
		const handleRedirectionIfNeeded = (response) => {
			...
			const processOAuthCode = async (code, state) => {
				...
				try {
					...
					if (continueResponse.flowStatus === __thunderid_browser.EmbeddedFlowStatus.Complete) props.onComplete?.(continueResponse);
		...
		(0, vue.watch)(() => passkeyState.value, async (state) => {
			...
			try {
				...
				if (processed.flowStatus === __thunderid_browser.EmbeddedFlowStatus.Complete) props.onComplete?.(processed);
				else {
		...
		return () => {
			...
			return (0, vue.h)(Card_default, {
				...
				props.showTitle || props.showSubtitle ? (0, vue.h)("div", { style: "padding: 1rem 1rem 0" }, [props.showTitle ? (0, vue.h)(Typography_default, { variant: "h5" }, () => title) : null, props.showSubtitle ? (0, vue.h)(Typography_default, {
					style: "margin-top: 0.25rem",
					variant: "body1"
				}, () => subtitle) : null]) : null,
				props.error ? (0, vue.h)("div", { style: "padding: 0 1rem" }, (0, vue.h)(Alert_default, { variant: "error" }, () => props.error.message)) : null,
				flowMessages.value.length > 0 ? (0, vue.h)("div", { style: "padding: 0 1rem" }, flowMessages.value.map((msg, i) => (0, vue.h)(Alert_default, {
					key: i,
					variant: msg.type === "error" ? "error" : "info"
				}, () => msg.message))) : null,
				(0, vue.h)("div", { style: "padding: 1rem" }, renderedComponents.length > 0 ? renderedComponents : [(0, vue.h)(Alert_default, { variant: "warning" }, () => t("errors.signup.components.not.available") || "No components available")])
			]);
		};
	}
});
...
*/
const SignUp$1 = (0, vue.defineComponent)({
	name: "SignUp",
	props: {
		afterSignUpUrl: {
			default: void 0,
	...
	setup(props, { slots }) {
		...
		const handleComplete = (response) => {
			...
			if (props.shouldRedirectAfterSignUp && response?.type !== __thunderid_browser.EmbeddedFlowResponseType.Redirection && props.afterSignUpUrl) window.location.href = props.afterSignUpUrl;
			if (props.shouldRedirectAfterSignUp && response?.type === __thunderid_browser.EmbeddedFlowResponseType.Redirection && response?.data?.redirectURL && !response.data.redirectURL.includes("oauth") && !response.data.redirectURL.includes("auth")) window.location.href = response.data.redirectURL;
		};
		return () => (0, vue.h)(BaseSignUp_default$2, {
			afterSignUpUrl: props.afterSignUpUrl,
			buttonClassName: props.buttonClassName,
			className: props.className,
			errorClassName: props.errorClassName,
...
const SignUp = (0, vue.defineComponent)({
	...
	setup(_props, { attrs, slots }) {
		const { platform } = useThunderID_default();
		return () => {
			if (platform === __thunderid_browser.Platform.ThunderID) return (0, vue.h)(SignUp_default$2, { ...attrs }, slots);
			return (0, vue.h)(SignUp_default$1, { ...attrs }, slots);
		};
	}
});
...
*/
const BaseSignUp = (0, vue.defineComponent)({
	name: "BaseSignUp",
	inheritAttrs: false,
	setup(_props, { attrs, slots }) {
		const { platform } = useThunderID_default();
		return () => {
			if (platform === __thunderid_browser.Platform.ThunderID) return (0, vue.h)(BaseSignUp_default$2, { ...attrs }, slots);
			return (0, vue.h)(BaseSignUp_default$1, { ...attrs }, slots);
		};
	}
});
	...
	setup(_props, { slots }) {
		...
		return () => {
			if (!isSignedIn.value) {
				...
				return fallbackContent ? (0, vue.h)(vue.Fragment, {}, fallbackContent) : null;
			}
			const defaultContent = slots.default?.();
			return defaultContent ? (0, vue.h)(vue.Fragment, {}, defaultContent) : null;
		};
	}
});
...
* ```
*/
const Loading = (0, vue.defineComponent)({
	name: "Loading",
	setup(_props, { slots }) {
...
* ```
*/
const User = (0, vue.defineComponent)({
	name: "User",
	setup(_props, { slots }) {
...
* ```
*/
const Organization = (0, vue.defineComponent)({
	name: "Organization",
	setup(_props, { slots }) {
...
function buildScimPatchValue(flatKey, rawValue, schemaId, multiValued) {
	if (flatKey === "phoneNumbers.mobile") return {
		...
		[__thunderid_browser.WellKnownSchemaIds.SystemUser]: { mobileNumbers: [rawValue] }
	};
	...
	if (schemaId && schemaId !== __thunderid_browser.WellKnownSchemaIds.User) return { [schemaId]: { [flatKey]: value } };
...
const BaseUserProfile = (0, vue.defineComponent)({
	...
	setup(props, { slots }) {
		const editingFields = (0, vue.ref)({});
		const editedValues = (0, vue.ref)({});
		const px = __thunderid_browser.withVendorCSSClassPrefix;
		...
		function renderInput(schema) {
			...
			switch (schema.type) {
				case "DATE_TIME": return (0, vue.h)(DatePicker_default, {
				...
				case "BOOLEAN": return (0, vue.h)(Checkbox_default, {
		...
		function renderSchemaFieldRow(schema) {
			...
			const editablePlaceholder = isEditable ? (0, vue.h)("span", {
				class: px("user-profile__field-placeholder"),
				onClick: () => startEditing(name, value)
			}, `Enter your ${label.toLowerCase()}`) : null;
			const displayValueNode = hasValue ? (0, vue.h)(Typography_default, {
			...
			return (0, vue.h)("div", {
				...
				key: name
			}, [(0, vue.h)("div", { class: px("user-profile__field-label-col") }, [(0, vue.h)(Typography_default, {
				class: px("user-profile__field-label"),
				variant: "body2"
			}, () => label)]), (0, vue.h)("div", { class: px("user-profile__field-value-col") }, [isEditing ? (0, vue.h)("div", { class: px("user-profile__field-edit") }, [renderInput(schema), (0, vue.h)("div", { class: px("user-profile__field-edit-actions") }, [(0, vue.h)(Button_default, {
				onClick: () => saveField(schema),
				size: "small",
				variant: "solid"
			}, () => "Save"), (0, vue.h)(Button_default, {
				onClick: () => cancelEditing(name),
				size: "small",
				variant: "text"
			}, () => "Cancel")])]) : (0, vue.h)("div", { class: px("user-profile__field-display") }, [displayValueNode, isEditable ? (0, vue.h)("button", {
				"aria-label": `Edit ${label}`,
				class: px("user-profile__field-edit-btn"),
				onClick: () => startEditing(name, value),
				type: "button"
			}, [(0, vue.h)(PencilIcon)]) : null])])]);
		}
		function renderProfileWithoutSchemas() {
			...
			}).sort(([a], [b]) => a.localeCompare(b)).map(([key, value]) => (0, vue.h)("div", {
				class: px("user-profile__field"),
				key
			}, [(0, vue.h)("div", { class: px("user-profile__field-label-col") }, [(0, vue.h)(Typography_default, {
				class: px("user-profile__field-label"),
				variant: "body2"
			}, () => formatLabel(key))]), (0, vue.h)("div", { class: px("user-profile__field-value-col") }, [(0, vue.h)(Typography_default, {
				class: px("user-profile__field-value"),
				variant: "body1"
		...
		function renderHero(currentUser) {
			...
			return (0, vue.h)("div", { class: px("user-profile__hero") }, [(0, vue.h)("div", { class: px("user-profile__avatar-wrapper") }, [(0, vue.h)("div", {
				class: [px("user-profile__avatar"), avatarSizeClass].join(" "),
				style: { background: avatarGradient }
			}, [(0, vue.h)("span", { class: px("user-profile__avatar-initials") }, initials)])]), (0, vue.h)("div", { class: px("user-profile__hero-info") }, [(0, vue.h)("span", { class: px("user-profile__hero-name") }, displayName), email ? (0, vue.h)("span", { class: px("user-profile__hero-subtitle") }, String(email)) : null])]);
		}
		return () => {
			...
			const children = [];
			children.push((0, vue.h)("div", { class: px("user-profile__header") }, [(0, vue.h)("span", { class: px("user-profile__title") }, props.title ?? "Profile")]));
			children.push((0, vue.h)(Divider_default, { class: px("user-profile__header-divider") }));
			if (props.showAvatar !== false && currentUser) children.push(renderHero(currentUser));
			if (props.error) children.push((0, vue.h)(Alert_default, {
				class: px("user-profile__error"),
				severity: "error"
			}, () => props.error));
			if (props.isLoading) children.push((0, vue.h)("div", { class: px("user-profile__loading") }, [(0, vue.h)(Spinner_default)]));
			else if (hasSchemas) {
				...
				children.push((0, vue.h)("div", { class: px("user-profile__fields") }, fieldRows));
			} else children.push((0, vue.h)("div", { class: px("user-profile__fields") }, renderProfileWithoutSchemas()));
			if (slots["footer"]) children.push((0, vue.h)("div", { class: px("user-profile__footer") }, slots["footer"]()));
			if (props.cardLayout) return (0, vue.h)(Card_default, {
				class: rootClasses,
				variant: props.cardVariant ?? "elevated"
			}, () => children);
			return (0, vue.h)("div", { class: rootClasses }, children);
		};
	}
});
...
const UserProfile = (0, vue.defineComponent)({
	name: "UserProfile",
	props: {
		avatarSize: {
			default: "lg",
	...
	setup(props, { slots }) {
		...
		return () => (0, vue.h)(BaseUserProfile_default, {
			avatarSize: props.avatarSize,
			cardLayout: props.cardLayout,
			cardVariant: props.cardVariant,
			class: (0, __thunderid_browser.withVendorCSSClassPrefix)("user-profile--styled"),
			className: props.className,
...
const BaseUserDropdown = (0, vue.defineComponent)({
	...
	setup(props, { slots }) {
		...
		return () => {
			...
			}, initials), props.showChevron ? (0, vue.h)("span", { class: px("user-dropdown__chevron") }, [(0, vue.h)(ChevronDownIcon, { size: 14 })]) : null]);
			let menu = null;
			if (isOpen.value) {
				...
				const menuChildren = [];
				menuChildren.push((0, vue.h)("div", { class: px("user-dropdown__menu-header") }, [(0, vue.h)("div", {
					class: px("user-dropdown__menu-header-avatar"),
					style: { background: gradient }
				}, initials), (0, vue.h)("div", { class: px("user-dropdown__menu-header-info") }, [(0, vue.h)("span", { class: px("user-dropdown__menu-header-name") }, displayName), subtitle ? (0, vue.h)("span", { class: px("user-dropdown__menu-header-subtitle") }, subtitle) : null])]));
				menuChildren.push((0, vue.h)("div", { class: px("user-dropdown__menu-divider") }));
				if (props.onProfileClick) menuChildren.push((0, vue.h)("button", {
					...
					type: "button"
				}, [(0, vue.h)(UserIcon, { size: 15 }), (0, vue.h)("span", null, "Profile")]));
				if (props.menuItems && props.menuItems.length > 0) props.menuItems.forEach((item, idx) => {
					if (item.separatorBefore) menuChildren.push((0, vue.h)("div", {
						class: px("user-dropdown__menu-divider"),
						key: `sep-${idx}`
					}));
					menuChildren.push((0, vue.h)("button", {
						...
						type: "button"
					}, [item.icon ?? null, (0, vue.h)("span", null, item.label)]));
				});
				...
				if (props.onSignOut) {
					...
					menuChildren.push((0, vue.h)("button", {
						...
						type: "button"
					}, [(0, vue.h)(LogOutIcon, { size: 15 }), (0, vue.h)("span", null, "Sign Out")]));
				}
				menu = (0, vue.h)("div", { class: menuClass }, menuChildren.filter(Boolean));
			}
			const container = (0, vue.h)("div", {
				class: [px("user-dropdown"), props.className].filter(Boolean).join(" "),
				ref: containerRef
			}, [trigger, menu]);
			if (props.isProfileModalOpen) return (0, vue.h)("div", [container, (0, vue.h)("div", {
			...
			}, [(0, vue.h)("div", { class: px("user-dropdown__modal-content") }, [(0, vue.h)("button", {
				"aria-label": "Close profile",
				class: px("user-dropdown__modal-close"),
				onClick: props.onProfileModalClose,
				type: "button"
			}, [(0, vue.h)(XIcon, { size: 18 })]), props.profileContent])])]);
			return container;
		};
	}
});
...
* ```
*/
const UserDropdown = (0, vue.defineComponent)({
	name: "UserDropdown",
	props: {
		className: {
			default: "",
	...
	setup(props, { slots, emit }) {
		...
		const isProfileModalOpen = (0, vue.ref)(false);
		return () => (0, vue.h)(BaseUserDropdown_default, {
			class: (0, __thunderid_browser.withVendorCSSClassPrefix)("user-dropdown--styled"),
			className: props.className,
			...
			profileContent: isProfileModalOpen.value ? (0, vue.h)(UserProfile_default, {
				cardLayout: false,
				compact: true,
				editable: true
			}) : null,
...
*/
const BaseAcceptInvite = (0, vue.defineComponent)({
	...
	setup(props, { slots }) {
		...
		const { t } = useI18n_default();
		const isLoading = (0, vue.ref)(false);
		const isValidatingToken = (0, vue.ref)(true);
		const isTokenInvalid = (0, vue.ref)(false);
		const isComplete = (0, vue.ref)(false);
		const currentFlow = (0, vue.ref)(null);
		const apiError = (0, vue.ref)(null);
		const completionTitle = (0, vue.ref)(void 0);
		const formValues = (0, vue.ref)({});
		const formErrors = (0, vue.ref)({});
		const touchedFields = (0, vue.ref)({});
		const isFormValid = (0, vue.ref)(true);
		...
		useOAuthCallback({
			currentFlowId: (0, vue.ref)(props.flowId ?? null),
			isInitialized: (0, vue.ref)(true),
			onComplete: () => {
		...
		(0, vue.watch)(() => [props.flowId, props.inviteToken], ([flowId, inviteToken]) => {
		...
		return () => {
			const containerClass = [(0, __thunderid_browser.withVendorCSSClassPrefix)("accept-invite"), props.className].filter(Boolean).join(" ");
			...
			if (isValidatingToken.value) return (0, vue.h)(Card_default, {
				class: containerClass,
				variant: props.variant
			}, () => (0, vue.h)("div", { style: "display:flex;flex-direction:column;align-items:center;gap:1rem;padding:2rem" }, [(0, vue.h)(Spinner_default), (0, vue.h)(Typography_default, { variant: "body1" }, () => "Validating your invite link...")]));
			if (isTokenInvalid.value) return (0, vue.h)(Card_default, {
				class: containerClass,
				variant: props.variant
			}, () => [(0, vue.h)("div", { style: "padding:1rem" }, [
				(0, vue.h)(Typography_default, { variant: "h5" }, () => "Invalid Invite Link"),
				(0, vue.h)(Alert_default, {
					style: "margin-top:1rem",
					variant: "error"
				}, () => apiError.value?.message || "This invite link is invalid or has expired. Please contact your administrator for a new invite."),
				props.onGoToSignIn ? (0, vue.h)("div", { style: "display:flex;justify-content:center;margin-top:1.5rem" }, [(0, vue.h)(Button_default, {
					onClick: props.onGoToSignIn,
					variant: "outline"
				}, () => "Go to Sign In")]) : null
			])]);
			if (isComplete.value) return (0, vue.h)(Card_default, {
				class: containerClass,
				variant: props.variant
			}, () => [(0, vue.h)("div", { style: "padding:1rem" }, [
				(0, vue.h)(Typography_default, { variant: "h5" }, () => "Account Setup Complete!"),
				(0, vue.h)(Alert_default, {
					style: "margin-top:1rem",
					variant: "success"
			...
			return (0, vue.h)(Card_default, {
				...
				(props.showTitle || props.showSubtitle) && (title || subtitle) ? (0, vue.h)("div", { style: "padding:1rem 1rem 0" }, [props.showTitle && title ? (0, vue.h)(Typography_default, { variant: "h5" }, () => title) : null, props.showSubtitle && subtitle ? (0, vue.h)(Typography_default, {
					style: "margin-top:0.25rem",
					variant: "body1"
				}, () => subtitle) : null]) : null,
				apiError.value ? (0, vue.h)("div", { style: "padding:0 1rem;margin-bottom:1rem" }, (0, vue.h)(Alert_default, { variant: "error" }, () => apiError.value.message)) : null,
				(0, vue.h)("div", { style: "padding:1rem" }, (() => {
					const formContent = [];
					if (renderedComponents.length > 0) formContent.push(renderedComponents);
					else if (!isLoading.value) formContent.push((0, vue.h)(Alert_default, { variant: "warning" }, () => "No form components available"));
					if (isLoading.value) formContent.push((0, vue.h)("div", { style: "display:flex;justify-content:center;padding:1rem" }, (0, vue.h)(Spinner_default)));
					return formContent;
				})()),
				props.onGoToSignIn ? (0, vue.h)("div", { style: "margin-top:1.5rem;text-align:center;padding:0 1rem 1rem" }, [(0, vue.h)(Typography_default, { variant: "body2" }, () => ["Already have an account? ", (0, vue.h)(Button_default, {
					onClick: props.onGoToSignIn,
...
*/
const AcceptInvite = (0, vue.defineComponent)({
	name: "AcceptInvite",
	props: {
		baseUrl: {
			default: void 0,
	...
	setup(props, { slots }) {
		...
		return () => (0, vue.h)(BaseAcceptInvite_default, {
			className: props.className,
			flowId,
			inviteToken,
...
*/
const BaseInviteUser = (0, vue.defineComponent)({
	name: "BaseInviteUser",
	props: {
		className: {
			default: "",
	...
	setup(props, { slots }) {
		...
		const touchedFields = (0, vue.ref)({});
		const isFormValid = (0, vue.ref)(true);
		const inviteLink = (0, vue.ref)(void 0);
		const inviteLinkCopied = (0, vue.ref)(false);
		const emailSent = (0, vue.ref)(false);
		let initializationAttempted = false;
		const handleError = (error) => {
		...
		const filterHeadings = (components) => components.filter((comp) => !(comp.type === "TEXT" && (comp.variant === "HEADING_1" || comp.variant === "HEADING_2")));
		return () => {
			const containerClass = [(0, __thunderid_browser.withVendorCSSClassPrefix)("invite-user"), props.className].filter(Boolean).join(" ");
			const components = currentFlow.value?.data?.components || currentFlow.value?.data?.meta?.components || [];
			const { title, subtitle } = extractHeadings(components);
			const componentsWithoutHeadings = filterHeadings(components);
			...
			if (!props.isInitialized || !isFlowInitialized.value && isLoading.value) return (0, vue.h)(Card_default, {
				class: containerClass,
				variant: props.variant
			}, () => (0, vue.h)("div", { style: "display:flex;justify-content:center;padding:2rem" }, (0, vue.h)(Spinner_default)));
			if (!currentFlow.value && apiError.value) return (0, vue.h)(Card_default, {
				class: containerClass,
				variant: props.variant
			}, () => (0, vue.h)(Alert_default, { variant: "error" }, () => apiError.value.message));
			if (isInviteGenerated && isEmailSent) return (0, vue.h)(Card_default, {
				class: containerClass,
				variant: props.variant
			}, () => [(0, vue.h)("div", { style: "padding:1rem" }, [
				(0, vue.h)(Typography_default, { variant: "h5" }, () => "Invite Email Sent!"),
				(0, vue.h)(Alert_default, {
					style: "margin-top:1rem",
					variant: "success"
				}, () => "An invitation email has been sent successfully. The user can complete their registration using the link in the email."),
				(0, vue.h)("div", { style: "display:flex;gap:0.5rem;margin-top:1.5rem" }, [(0, vue.h)(Button_default, {
					onClick: resetFlow,
					variant: "outline"
				}, () => "Invite Another User")])
			])]);
			if (isInviteGenerated && inviteLink.value) return (0, vue.h)(Card_default, {
				class: containerClass,
				variant: props.variant
			}, () => [(0, vue.h)("div", { style: "padding:1rem" }, [
				(0, vue.h)(Typography_default, { variant: "h5" }, () => "Invite Link Generated!"),
				(0, vue.h)(Alert_default, {
					style: "margin-top:1rem",
					variant: "success"
				}, () => "Share this link with the user to complete their registration."),
				(0, vue.h)("div", { style: "margin-top:1rem" }, [(0, vue.h)(Typography_default, {
					style: "margin-bottom:0.5rem",
					variant: "body2"
				}, () => "Invite Link"), (0, vue.h)("div", { style: "display:flex;align-items:center;gap:0.5rem;padding:0.75rem;background:var(--thunder-color-background-secondary,#f5f5f5);border-radius:4px;word-break:break-all" }, [(0, vue.h)(Typography_default, {
					style: "flex:1",
					variant: "body2"
				}, () => inviteLink.value), (0, vue.h)(Button_default, {
...
*/
const InviteUser = (0, vue.defineComponent)({
	name: "InviteUser",
	props: {
		className: {
			default: "",
	...
	setup(props, { slots }) {
		...
		return () => (0, vue.h)(BaseInviteUser_default, {
			className: props.className,
			isInitialized: isInitialized?.value ?? false,
			onError: props.onError,
			onFlowChange: props.onFlowChange,
...
*/
const BaseOrganizationList = (0, vue.defineComponent)({
	...
	setup(props, { slots }) {
		return () => {
			...
			const prefix = __thunderid_browser.withVendorCSSClassPrefix;
			const children = [];
			if (props.isLoading) children.push((0, vue.h)("div", { class: prefix("organization-list__loading") }, [(0, vue.h)(Spinner_default)]));
			else if (props.organizations.length === 0) children.push((0, vue.h)(Typography_default, {
				class: prefix("organization-list__empty"),
				variant: "body2"
			}, () => "No organizations found"));
			else props.organizations.forEach((org) => {
				children.push((0, vue.h)("button", {
					class: prefix("organization-list__item"),
					key: org.id,
					onClick: () => props.onSelect?.(org),
					type: "button"
				}, [(0, vue.h)(BuildingIcon, { size: 16 }), (0, vue.h)(Typography_default, { variant: "body1" }, () => org.name || org.id)]));
			});
			return (0, vue.h)("div", { class: [prefix("organization-list"), props.className].filter(Boolean).join(" ") }, children);
		};
	}
});
...
*/
const OrganizationList = (0, vue.defineComponent)({
	...
	setup(props, { slots, emit }) {
		...
		return () => (0, vue.h)(BaseOrganizationList_default, {
			class: (0, __thunderid_browser.withVendorCSSClassPrefix)("organization-list--styled"),
			className: props.className,
			isLoading: isLoading.value,
...
*/
const BaseOrganizationProfile = (0, vue.defineComponent)({
	...
	setup(props, { slots }) {
		const editingName = (0, vue.ref)(false);
		const editingDescription = (0, vue.ref)(false);
		const editedName = (0, vue.ref)("");
		const editedDescription = (0, vue.ref)("");
		return () => {
			...
			const children = [];
			children.push((0, vue.h)("div", { class: prefix("organization-profile__header") }, [(0, vue.h)(Typography_default, {
				class: prefix("organization-profile__title"),
				variant: "h5"
			}, () => props.title)]));
			children.push((0, vue.h)(Divider_default, { class: prefix("organization-profile__header-divider") }));
			children.push((0, vue.h)("div", { class: prefix("organization-profile__identity") }, [
				(0, vue.h)("div", {
					class: prefix("organization-profile__avatar"),
					style: { background: avatarGradient }
				}, [(0, vue.h)("span", { class: prefix("organization-profile__avatar-initials") }, initials)]),
				(0, vue.h)(Typography_default, {
					class: prefix("organization-profile__org-name"),
					variant: "h5"
				}, () => orgName),
				orgHandle ? (0, vue.h)(Typography_default, {
					class: prefix("organization-profile__org-handle"),
					variant: "body2"
				}, () => `@${orgHandle}`) : null
			]));
			children.push((0, vue.h)(Divider_default, { class: prefix("organization-profile__identity-divider") }));
			const fieldRows = [];
			fieldRows.push((0, vue.h)("div", {
				class: prefix("organization-profile__field"),
				key: "id"
			}, [(0, vue.h)("div", { class: prefix("organization-profile__field-label-col") }, [(0, vue.h)(Typography_default, {
				class: prefix("organization-profile__field-label"),
				variant: "body2"
			}, () => "Organization ID")]), (0, vue.h)("div", { class: prefix("organization-profile__field-value-col") }, [(0, vue.h)("div", { class: prefix("organization-profile__field-display") }, [orgId ? (0, vue.h)(Typography_default, {
				class: [prefix("organization-profile__field-value"), prefix("organization-profile__field-value--id")].join(" "),
				variant: "body1"
			}, () => orgId) : (0, vue.h)("span", { class: prefix("organization-profile__field-placeholder") }, "Not available")])])]));
			fieldRows.push((0, vue.h)("div", {
				class: prefix("organization-profile__field"),
				key: "name"
			}, [(0, vue.h)("div", { class: prefix("organization-profile__field-label-col") }, [(0, vue.h)(Typography_default, {
				class: prefix("organization-profile__field-label"),
				variant: "body2"
			}, () => "Organization Name")]), (0, vue.h)("div", { class: prefix("organization-profile__field-value-col") }, [editingName.value ? (0, vue.h)("div", { class: prefix("organization-profile__field-edit") }, [(0, vue.h)(TextField_default, {
				modelValue: editedName.value,
				"onUpdate:modelValue": (v) => {
					editedName.value = v;
				}
			}), (0, vue.h)("div", { class: prefix("organization-profile__field-edit-actions") }, [(0, vue.h)(Button_default, {
				onClick: async () => {
				...
				size: "small",
				variant: "text"
			}, () => "Cancel")])]) : (0, vue.h)("div", { class: prefix("organization-profile__field-display") }, [(0, vue.h)(Typography_default, {
				class: prefix("organization-profile__field-value"),
				variant: "body1"
			}, () => orgName), props.editable ? (0, vue.h)("button", {
			...
			fieldRows.push((0, vue.h)("div", {
				...
				class: prefix("organization-profile__field-label"),
				variant: "body2"
			}, () => "Organization Description")]), (0, vue.h)("div", { class: prefix("organization-profile__field-value-col") }, [editingDescription.value ? (0, vue.h)("div", { class: prefix("organization-profile__field-edit") }, [(0, vue.h)(TextField_default, {
				...
				size: "small",
				variant: "text"
			}, () => "Cancel")])]) : (0, vue.h)("div", { class: prefix("organization-profile__field-display") }, [orgDescription != null ? (0, vue.h)(Typography_default, {
				class: prefix("organization-profile__field-value"),
				variant: "body1"
			}, () => orgDescription) : (0, vue.h)("span", {
				class: prefix("organization-profile__field-placeholder"),
				onClick: props.editable ? () => {
					editedDescription.value = "";
					editingDescription.value = true;
				} : void 0
			}, "Enter organization description"), props.editable ? (0, vue.h)("button", {
			...
			fieldRows.push((0, vue.h)("div", {
				...
				class: prefix("organization-profile__field-label"),
				variant: "body2"
			}, () => "Created Date")]), (0, vue.h)("div", { class: prefix("organization-profile__field-value-col") }, [(0, vue.h)("div", { class: prefix("organization-profile__field-display") }, [createdDate ? (0, vue.h)(Typography_default, {
				class: prefix("organization-profile__field-value"),
				variant: "body1"
			}, () => createdDate) : (0, vue.h)("span", { class: prefix("organization-profile__field-placeholder") }, "Not available")])])]));
			fieldRows.push((0, vue.h)("div", {
				class: prefix("organization-profile__field"),
				key: "lastModified"
			}, [(0, vue.h)("div", { class: prefix("organization-profile__field-label-col") }, [(0, vue.h)(Typography_default, {
				class: prefix("organization-profile__field-label"),
				variant: "body2"
			}, () => "Last Modified Date")]), (0, vue.h)("div", { class: prefix("organization-profile__field-value-col") }, [(0, vue.h)("div", { class: prefix("organization-profile__field-display") }, [lastModifiedDate ? (0, vue.h)(Typography_default, {
				class: prefix("organization-profile__field-value"),
				variant: "body1"
			}, () => lastModifiedDate) : (0, vue.h)("span", { class: prefix("organization-profile__field-placeholder") }, "Not available")])])]));
			fieldRows.push((0, vue.h)("div", {
				class: prefix("organization-profile__field"),
				key: "orgHandle"
			}, [(0, vue.h)("div", { class: prefix("organization-profile__field-label-col") }, [(0, vue.h)(Typography_default, {
				class: prefix("organization-profile__field-label"),
				variant: "body2"
			}, () => "Organization Handle")]), (0, vue.h)("div", { class: prefix("organization-profile__field-value-col") }, [(0, vue.h)("div", { class: prefix("organization-profile__field-display") }, [orgHandle ? (0, vue.h)(Typography_default, {
				class: prefix("organization-profile__field-value"),
				variant: "body1"
			}, () => orgHandle) : (0, vue.h)("span", { class: prefix("organization-profile__field-placeholder") }, "Not available")])])]));
			children.push((0, vue.h)("div", { class: prefix("organization-profile__fields") }, fieldRows));
			return (0, vue.h)(Card_default, { class: [prefix("organization-profile"), props.className].filter(Boolean).join(" ") }, () => children);
		};
	}
});
...
*/
const OrganizationProfile = (0, vue.defineComponent)({
	...
	setup(props, { slots }) {
		const { currentOrganization } = useOrganization_default();
		return () => (0, vue.h)(BaseOrganizationProfile_default, {
			class: (0, __thunderid_browser.withVendorCSSClassPrefix)("organization-profile--styled"),
			className: props.className,
			editable: props.editable,
...
const cls$2 = (name) => (0, __thunderid_browser.withVendorCSSClassPrefix)(`organization-switcher${name}`);
/**
...
*/
const BaseOrganizationSwitcher = (0, vue.defineComponent)({
	...
	setup(props, { slots }) {
		...
		return () => {
			...
			const triggerButton = (0, vue.h)("button", {
				"aria-expanded": isOpen.value,
				...
				(0, vue.h)(BuildingIcon, { size: 16 }),
				(0, vue.h)(Typography_default, {
					class: cls$2("__trigger-label"),
					variant: "body2"
				}, () => currentName),
				(0, vue.h)(ChevronDownIcon, { size: 12 })
			]);
			const dropdownChildren = [];
			if (props.isLoading) dropdownChildren.push((0, vue.h)("div", { class: cls$2("__loading") }, [(0, vue.h)(Spinner_default, { size: "small" })]));
			else if (props.organizations.length === 0) dropdownChildren.push((0, vue.h)(Typography_default, {
				class: cls$2("__empty"),
				variant: "body2"
			}, () => "No organizations available"));
			else props.organizations.forEach((org) => {
				const isActive = org.id === props.currentOrganization?.id;
				dropdownChildren.push((0, vue.h)("button", {
					"aria-selected": isActive,
					class: [cls$2("__item"), isActive ? cls$2("__item--active") : ""],
					onClick: () => handleSelect(org),
					role: "option",
					type: "button"
				}, [(0, vue.h)(BuildingIcon, { size: 14 }), (0, vue.h)(Typography_default, { variant: "body2" }, () => org.name)]));
			});
			const dropdown = isOpen.value ? (0, vue.h)("div", {
				class: cls$2("__dropdown"),
				role: "listbox"
			}, dropdownChildren) : null;
			return (0, vue.h)(Card_default, { class: [cls$2(""), props.className].filter(Boolean).join(" ") }, () => [triggerButton, dropdown]);
		};
	}
});
...
const OrganizationSwitcher = (0, vue.defineComponent)({
	...
	setup(props, { slots }) {
		...
		return () => (0, vue.h)(BaseOrganizationSwitcher_default, {
			class: (0, __thunderid_browser.withVendorCSSClassPrefix)("organization-switcher--styled"),
			className: props.className,
...
const cls$1 = (name) => (0, __thunderid_browser.withVendorCSSClassPrefix)(`create-organization${name}`);
/**
* BaseCreateOrganization — unstyled sub-organisation creation form.
*
* Provides a form with an org name input and create button.
*/
const BaseCreateOrganization = (0, vue.defineComponent)({
	...
	setup(props, { slots }) {
		...
		return () => {
			...
			return (0, vue.h)(Card_default, { class: [cls$1(""), props.className].filter(Boolean).join(" ") }, () => [
				(0, vue.h)(Typography_default, {
					class: cls$1("__title"),
					variant: "h6"
				}, () => props.title),
				props.description ? (0, vue.h)(Typography_default, {
					class: cls$1("__description"),
					variant: "body2"
				}, () => props.description) : null,
				error.value ? (0, vue.h)(Alert_default, {
					class: cls$1("__error"),
					severity: "error"
				}, () => error.value) : null,
				(0, vue.h)(TextField_default, {
					class: cls$1("__input"),
...
*/
const CreateOrganization = (0, vue.defineComponent)({
	...
	setup(props, { slots }) {
		...
		return () => (0, vue.h)(BaseCreateOrganization_default, {
			class: (0, __thunderid_browser.withVendorCSSClassPrefix)("create-organization--styled"),
			className: props.className,
...
const cls = (name) => (0, __thunderid_browser.withVendorCSSClassPrefix)(`language-switcher${name}`);
/**
* BaseLanguageSwitcher — unstyled language selection component.
*
* Shows the current language and a dropdown to select another.
*/
const BaseLanguageSwitcher = (0, vue.defineComponent)({
		...
		return () => {
			...
			const dropdownItems = props.languages.map((lang) => {
				...
				return (0, vue.h)("button", {
					...
					role: "option",
					type: "button"
				}, [(0, vue.h)(Typography_default, { variant: "body2" }, () => lang.label)]);
			});
			const dropdown = isOpen.value ? (0, vue.h)("div", {
				class: cls("__dropdown"),
				role: "listbox"
			}, dropdownItems) : null;
			return (0, vue.h)(Card_default, { class: [cls(""), props.className].filter(Boolean).join(" ") }, () => [triggerButton, dropdown]);
		};
	}
});
...
*/
const LanguageSwitcher = (0, vue.defineComponent)({
	...
	setup(props, { slots }) {
		...
		return () => (0, vue.h)(BaseLanguageSwitcher_default, {
			class: (0, __thunderid_browser.withVendorCSSClassPrefix)("language-switcher--styled"),
			className: props.className,
...
const createThunderIDGuard = (options = {}) => {
	...
	return async (_to, _from, next) => {
		const ctx = (0, vue.inject)(THUNDERID_KEY);
		if (!ctx) {
...
const createCallbackRoute = (options = {}) => {
	...
	const CallbackWrapper = (0, vue.defineComponent)({
		name: "ThunderIDCallbackRoute",
		setup() {
			return () => (0, vue.h)(Callback_default, { ...onError && { onError } });
		}
	});
	return {
		...name && { name },
...
//#endregion
exports.AcceptInvite = AcceptInvite_default;
exports.Alert = Alert_default;
exports.ArrowLeftRightIcon = ArrowLeftRightIcon;
exports.BRANDING_KEY = BRANDING_KEY;
exports.BaseAcceptInvite = BaseAcceptInvite_default;
exports.BaseCreateOrganization = BaseCreateOrganization_default;
exports.BaseInviteUser = BaseInviteUser_default;
exports.BaseLanguageSwitcher = BaseLanguageSwitcher_default;
exports.BaseOrganizationList = BaseOrganizationList_default;
exports.BaseOrganizationProfile = BaseOrganizationProfile_default;
exports.BaseOrganizationSwitcher = BaseOrganizationSwitcher_default;
exports.BaseSignIn = BaseSignIn_default;
exports.BaseSignInButton = BaseSignInButton_default;
exports.BaseSignOutButton = BaseSignOutButton_default;
exports.BaseSignUp = BaseSignUp_default;
exports.BaseSignUpButton = BaseSignUpButton_default;
exports.BaseUserDropdown = BaseUserDropdown_default;
exports.BaseUserProfile = BaseUserProfile_default;
exports.BrandingProvider = BrandingProvider_default;
exports.BuildingIcon = BuildingIcon;
exports.Button = Button_default;
exports.Callback = Callback_default;
...
exports.FLOW_META_KEY = FLOW_META_KEY;
exports.FacebookButton = FacebookButton_default;
exports.FieldFactory = FieldFactory_default;
Object.defineProperty(exports, 'FieldType', {
  enumerable: true,
  get: function () {
    return __thunderid_browser.FieldType;
  }
});
exports.FlowMetaProvider = FlowMetaProvider_default;
exports.FlowProvider = FlowProvider_default;
exports.GitHubButton = GitHubButton_default;
exports.GlobeIcon = GlobeIcon;
exports.GoogleButton = GoogleButton_default;
exports.I18N_KEY = I18N_KEY;
exports.I18nProvider = I18nProvider_default;
exports.InfoIcon = InfoIcon;
exports.InviteUser = InviteUser_default;
exports.LanguageSwitcher = LanguageSwitcher_default;
exports.Loading = Loading_default;
exports.LogOutIcon = LogOutIcon;
exports.Logo = Logo_default;
exports.MicrosoftButton = MicrosoftButton_default;
exports.ORGANIZATION_KEY = ORGANIZATION_KEY;
exports.Organization = Organization_default;
exports.OrganizationList = OrganizationList_default;
exports.OrganizationProfile = OrganizationProfile_default;
exports.OrganizationProvider = OrganizationProvider_default;
exports.OrganizationSwitcher = OrganizationSwitcher_default;
exports.OtpField = OtpField_default;
exports.PasswordField = PasswordField_default;
...
exports.THUNDERID_KEY = THUNDERID_KEY;
exports.TextField = TextField_default;
exports.ThemeProvider = ThemeProvider_default;
exports.ThunderIDPlugin = ThunderIDPlugin_default;
exports.ThunderIDProvider = ThunderIDProvider_default;
...
exports.ThunderIDVueClient = ThunderIDVueClient_default;
...
exports.UserProvider = UserProvider_default;
exports.XIcon = XIcon;
exports.buildThemeConfigFromFlowMeta = buildThemeConfigFromFlowMeta_default;
exports.createCallbackRoute = createCallbackRoute;
Object.defineProperty(exports, 'createClassObserver', {
  enumerable: true,
  get: function () {
    return __thunderid_browser.createClassObserver;
  }
});
...
Object.defineProperty(exports, 'createMediaQueryListener', {
  enumerable: true,
  get: function () {
    return __thunderid_browser.createMediaQueryListener;
  }
});
exports.createThunderIDGuard = createThunderIDGuard;
Object.defineProperty(exports, 'detectThemeMode', {
  enumerable: true,
  get: function () {
    return __thunderid_browser.detectThemeMode;
  }
});
...
exports.getAuthComponentHeadings = getAuthComponentHeadings_default;
Object.defineProperty(exports, 'handleWebAuthnAuthentication', {
  enumerable: true,
  get: function () {
    return __thunderid_browser.handleWebAuthnAuthentication;
  }
});
Object.defineProperty(exports, 'hasAuthParamsInUrl', {
  enumerable: true,
  get: function () {
    return __thunderid_browser.hasAuthParamsInUrl;
  }
});
...
exports.useBranding = useBranding_default;
exports.useFlow = useFlow_default;
exports.useFlowMeta = useFlowMeta_default;
exports.useI18n = useI18n_default;
exports.useOAuthCallback = useOAuthCallback;
exports.useOAuthCallbackV2 = useOAuthCallback$1;
exports.useOrganization = useOrganization_default;
exports.useTheme = useTheme_default;
exports.useThunderID = useThunderID_default;
exports.useUser = useUser_default;

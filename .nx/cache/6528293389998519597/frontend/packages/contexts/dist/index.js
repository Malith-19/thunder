...
function ConfigProvider({ children }) {
	...
	return /* @__PURE__ */ jsx(ConfigContext_default.Provider, {
		value: contextValue,
		children
	});
}
...
*/
function useConfig() {
	const context = useContext(ConfigContext_default);
...
function ToastProvider({ children }) {
	...
	return /* @__PURE__ */ jsxs(ToastContext_default.Provider, {
		value: contextValue,
...
*/
function useToast() {
	const context = useContext(ToastContext_default);
	if (context === void 0) throw new Error("useToast must be used within a ToastProvider");
	return context;
}

//#endregion
export { ConfigContext_default as ConfigContext, ConfigProvider, ToastContext_default as ToastContext, ToastProvider, useConfig, useToast };
...
const translations = {
	...
	applications: {
		...
		"edit.advanced.oauth2Config.intro": "These OAuth 2.0 settings are read-only and were configured during application creation.",
		...
		"edit.advanced.grantTypes.hint": "OAuth 2.0 flows this application can use (e.g., authorization_code, client_credentials, refresh_token).",
		...
		"edit.advanced.publicClient.requiresAuthorizationCode": "Available only for apps using the authorization code flow.",

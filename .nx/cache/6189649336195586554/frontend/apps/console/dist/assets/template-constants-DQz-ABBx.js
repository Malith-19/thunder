import{Sn as e}from"./vendor-mui-DfBexhDa.js";import{At as t,RC as n,ac as r,cc as i,dp as a,os as o}from"./vendor-oxygen-DFNgTxPQ.js";var s={id:`backend`,displayName:`Backend`,description:`Machine-to-machine backend service`,creationFlow:{steps:[`STACK`,`NAME`,`ORGANIZATION_UNIT`,`COMPLETE`]},defaults:{name:`Backend Application`,inboundAuthConfig:[{type:`oauth2`,config:{grantTypes:[`client_credentials`],pkceRequired:!1,tokenEndpointAuthMethod:`client_secret_basic`,publicClient:!1}}]}},c={id:`browser`,displayName:`Browser`,description:`Web application running in browser`,defaults:{name:`Browser Application`,inboundAuthConfig:[{type:`oauth2`,config:{grantTypes:[`authorization_code`,`refresh_token`],responseTypes:[`code`],redirectUris:[],pkceRequired:!0,tokenEndpointAuthMethod:`none`,publicClient:!0}}],allowedUserTypes:[]},fieldConstraints:{oauth2:{publicClient:{readOnly:!0,value:!0},pkceRequired:{readOnly:!0,value:!0},tokenEndpointAuthMethod:{readOnly:!0,value:`none`}}}},l={id:`custom`,displayName:`Custom`,description:`Fully customizable application with all configuration options available`,creationFlow:{steps:[`NAME`,`ORGANIZATION_UNIT`,`COMPLETE`]},defaults:{name:`My Application`,inboundAuthConfig:[{type:`oauth2`,config:{grantTypes:[`client_credentials`],responseTypes:[],redirectUris:[],pkceRequired:!1,tokenEndpointAuthMethod:`client_secret_basic`,publicClient:!1}}],allowedUserTypes:[]}},u={id:`server`,displayName:`Full-Stack`,description:`Apps with both server and client code`,defaults:{name:`Full-Stack Application`,inboundAuthConfig:[{type:`oauth2`,config:{grantTypes:[`authorization_code`,`refresh_token`],responseTypes:[`code`],redirectUris:[],pkceRequired:!0,tokenEndpointAuthMethod:`client_secret_basic`,publicClient:!1}}],allowedUserTypes:[]}},d={id:`mobile`,displayName:`Mobile`,description:`Native mobile application`,defaults:{name:`Mobile Application`,inboundAuthConfig:[{type:`oauth2`,config:{grantTypes:[`authorization_code`,`refresh_token`],responseTypes:[`code`],redirectUris:[],pkceRequired:!0,tokenEndpointAuthMethod:`none`,publicClient:!0}}],allowedUserTypes:[]},fieldConstraints:{oauth2:{publicClient:{readOnly:!0,value:!0},pkceRequired:{readOnly:!0,value:!0},tokenEndpointAuthMethod:{readOnly:!0,value:`none`}}}},f={id:`wallet`,displayName:`Digital Wallet`,description:`OpenID4VCI wallet that requests verifiable credentials`,defaults:{name:`Digital Wallet`,inboundAuthConfig:[{type:`oauth2`,config:{grantTypes:[`authorization_code`,`refresh_token`],responseTypes:[`code`],redirectUris:[],pkceRequired:!0,tokenEndpointAuthMethod:`none`,publicClient:!0}}],allowedUserTypes:[]},fieldConstraints:{oauth2:{publicClient:{readOnly:!0,value:!0},pkceRequired:{readOnly:!0,value:!0},tokenEndpointAuthMethod:{readOnly:!0,value:`none`}}}},p={REACT:`REACT`,EXPRESS:`EXPRESS`,NEXTJS:`NEXTJS`,VANILLA_JS:`VANILLA_JS`,VUE:`VUE`,NUXT:`NUXT`,NODEJS:`NODEJS`,OTHER:`OTHER`},m={BACKEND:`BACKEND`,BROWSER:`BROWSER`,MOBILE:`MOBILE`,FULL_STACK:`FULL_STACK`,WALLET:`WALLET`,CUSTOM:`CUSTOM`},h=e(),g=[{value:m.BROWSER,icon:(0,h.jsx)(a,{size:32}),titleKey:`applications:onboarding.configure.stack.platform.browser.title`,descriptionKey:`applications:onboarding.configure.stack.platform.browser.description`,template:c,categories:[`web`]},{value:m.FULL_STACK,icon:(0,h.jsx)(i,{size:32}),titleKey:`applications:onboarding.configure.stack.platform.full_stack.title`,descriptionKey:`applications:onboarding.configure.stack.platform.full_stack.description`,template:u,categories:[`web`,`backend`]},{value:m.MOBILE,icon:(0,h.jsx)(o,{size:32}),titleKey:`applications:onboarding.configure.stack.platform.mobile.title`,descriptionKey:`applications:onboarding.configure.stack.platform.mobile.description`,template:d,categories:[`mobile`]},{value:m.BACKEND,icon:(0,h.jsx)(n,{size:32}),titleKey:`applications:onboarding.configure.stack.platform.backend.title`,descriptionKey:`applications:onboarding.configure.stack.platform.backend.description`,template:s,categories:[`backend`]},{value:m.WALLET,icon:(0,h.jsx)(t,{size:32}),titleKey:`applications:onboarding.configure.stack.platform.wallet.title`,descriptionKey:`applications:onboarding.configure.stack.platform.wallet.description`,template:f,categories:[`mobile`]},{value:m.CUSTOM,icon:(0,h.jsx)(r,{size:32}),titleKey:`applications:onboarding.configure.stack.platform.custom.title`,descriptionKey:`applications:onboarding.configure.stack.platform.custom.description`,template:l,categories:[`web`,`backend`,`mobile`]}],_={id:`express`,displayName:`Express`,description:`Server-side Node.js application built with Express`,defaults:{name:`Express Application`,inboundAuthConfig:[{type:`oauth2`,config:{grantTypes:[`authorization_code`,`refresh_token`],responseTypes:[`code`],redirectUris:[`http://localhost:3000/login`],pkceRequired:!1,tokenEndpointAuthMethod:`client_secret_basic`,publicClient:!1}}],allowedUserTypes:[]},fieldConstraints:{oauth2:{publicClient:{readOnly:!0,value:!1},tokenEndpointAuthMethod:{readOnly:!0,value:`client_secret_basic`}}},integrationGuides:{INBUILT:{llm_prompt:{id:`llm-prompt`,title:`Integrate with a Coding Agent Prompt`,description:`Use AI to generate integration code for your Express application`,type:`llm`,icon:`sparkles`,content:"# Integrate {{productName}} Authentication in an Express Application (Inbuilt Mode)\n\n## Context\nI have an Express application and I want to integrate {{productName}} authentication using the ThunderID Express SDK with {{productName}}-hosted sign-in pages.\n\n## Requirements\n- Use `@thunderid/express` in a Node.js + Express application\n- Use `cookie-parser` and `express.json()` middleware\n- Configure ThunderID middleware with `baseUrl`, `clientId`, `clientSecret`, `afterSignInUrl`, and `afterSignOutUrl`\n- Implement `/login` with `handleSignIn()` and `/logout` with `handleSignOut()`\n- Protect a route (`/protected`) using `protect((res) => res.redirect('/login'))`\n- Add a `/me` route that returns the authenticated user profile as JSON\n- Keep the code minimal, production-lean, and fully runnable\n\n## Configuration\n- **Client ID**: {{clientId}}\n- **Client Secret**: `<your-client-secret>`\n- **Base URL**: https://localhost:8090 (or your {{productName}} instance URL)\n- **App URL**: http://localhost:3000\n- **Login Callback Route**: `/login`\n- **Logout Callback Route**: `/logout`\n- **SDK**: @thunderid/express\n\n## Important Rules\n- Use CommonJS syntax (`require`) in `index.js`\n- Use these SDK imports exactly: `thunderID`, `handleSignIn`, `handleSignOut`, `protect`\n- Ensure redirect URL alignment: the app callback URL must be `http://localhost:3000/login`, and the post-logout redirect URL must be `http://localhost:3000/logout`\n- Do not invent unsupported SDK APIs or custom wrappers\n- Keep route names and behavior exactly as specified\n\n## Implementation Steps\n1. Create a new project and install `express` and `cookie-parser`\n2. Install `@thunderid/express`\n3. Add `index.js` with ThunderID middleware and auth routes\n4. Add `/protected` and `/me` routes with `protect()`\n5. Start the server with `node index.js`\n6. Validate the flow by opening `/protected`, then `/me`\n\nPlease provide:\n- The exact terminal commands\n- A complete `index.js` file\n- A short verification checklist for sign-in, sign-out, and protected route behavior"},manual_steps:[{step:1,title:`Create an Express app`,description:`Create your project and install the base dependencies:`,code:{language:`terminal`,content:`mkdir my-express-app
cd my-express-app
npm init -y
...
renderApp()`}},{step:6,title:`Run the app`,description:`Start your development server and test the authentication flow:`,code:{language:`terminal`,content:`npm run dev`}}]}}},categories:[`web`]},{value:p.VUE,icon:(0,h.jsxs)(`svg`,{xmlns:`http://www.w3.org/2000/svg`,width:`40`,height:`40`,viewBox:`0 0 261.76 226.69`,children:[(0,h.jsx)(`path`,{d:`M161.096.001l-30.225 52.351L100.647.001H0l130.871 226.688L261.742.001z`,fill:`#41b883`}),(0,h.jsx)(`path`,{d:`M161.096.001l-30.225 52.351L100.647.001H52.346l78.525 136.01L209.398.001z`,fill:`#34495e`})]}),titleKey:`applications:onboarding.configure.stack.technology.vue.title`,descriptionKey:`applications:onboarding.configure.stack.technology.vue.description`,template:{id:`vue`,displayName:`Vue`,description:`Single Page Application built with Vue 3`,defaults:{name:`Vue Application`,inboundAuthConfig:[{type:`oauth2`,config:{grantTypes:[`authorization_code`,`refresh_token`],responseTypes:[`code`],redirectUris:[`http://localhost:5173`],pkceRequired:!0,tokenEndpointAuthMethod:`none`,publicClient:!0}}],allowedUserTypes:[]},fieldConstraints:{oauth2:{publicClient:{readOnly:!0,value:!0},pkceRequired:{readOnly:!0,value:!0},tokenEndpointAuthMethod:{readOnly:!0,value:`none`}}},integrationGuides:{INBUILT:{llm_prompt:{id:`llm-prompt`,title:`Integrate with a Coding Agent Prompt`,description:`Use AI to generate integration code for your Vue 3 application`,type:`llm`,icon:`sparkles`,content:`# Integrate {{productName}} Authentication in Vue 3 Application

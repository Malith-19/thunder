...
| Setting | Description |
|---------|-------------|
| **Allowed User Types** | Restricts self-service registration to users of the selected types. If none are selected, all user types can register. This setting does not block existing users from signing in. |

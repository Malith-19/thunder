...
- Configure SMTP so that <ProductName /> can send recovery emails. See [Email Configuration](/docs/next/guides/getting-started/configuration#email-configuration).
:::

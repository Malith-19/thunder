...
This walkthrough configures <ProductName /> for sign-in, then points you at the SDK integration for your framework. By the end, a user who clicks your sign-in button is authenticated by <ProductName /> and lands back in your app with an access token.
...
Define the schema for your consumers. Navigate to **User Types** → **Create User Type** and add at minimum:
...
**4. Build a sign-in flow and attach it**

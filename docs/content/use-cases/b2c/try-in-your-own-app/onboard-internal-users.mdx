...
:::note Prerequisites
Configure SMTP so that <ProductName /> can send invitation emails. See [Email Configuration](/docs/next/guides/getting-started/configuration#email-configuration).
:::
